...
// Prototypes
void sub84(string stringParam1);
void sub83(string stringParam1);
void sub82(object objectParam1, int intParam2, object oTarget);
int sub81();
void sub80();
...
void sub82(object objectParam1, int intParam2, object oTarget) {
	sub83("");
	sub83(("GENERIC SHOUT DEBUG *************** Respond to Shout Started for " + sub3(OBJECT_SELF)));
	sub83(("GENERIC SHOUT DEBUG *************** Intruder Object = " + sub3(oTarget)));
	int int1;
	{
		...
		if (((((!sub6(intGLOB_101)) && (!sub6(intGLOB_102))) && (!sub6(intGLOB_103))) && (!GetUserActionsPending()))) {
			sub83("GENERIC SHOUT DEBUG *************** Check 1 Pass");
			if ((((intParam2 == 1) && GetIsFriend(objectParam1, OBJECT_SELF)) && (objectParam1 != OBJECT_SELF))) {
				if ((((IsObjectPartyMember(OBJECT_SELF) && IsObjectPartyMember(objectParam1)) && (GetSoloMode() == 0)) || (!IsObjectPartyMember(OBJECT_SELF)))) {
					sub83("GENERIC SHOUT DEBUG *************** Check 2 Pass");
					if ((((!GetIsObjectValid(GetAttemptedAttackTarget())) && (!GetIsObjectValid(GetAttemptedSpellTarget()))) && (!GetIsObjectValid(GetAttackTarget(OBJECT_SELF))))) {
						sub83("GENERIC SHOUT DEBUG *************** Check 3 Pass");
						if ((((GetPartyMemberByIndex(0) != OBJECT_SELF) && (nStyle != 2)) && (!GetPlayerRestrictMode(OBJECT_SELF)))) {
							...
							if (((IsObjectPartyMember(OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF))) || (!IsObjectPartyMember(OBJECT_SELF)))) {
								sub83("GENERIC SHOUT DEBUG *************** Check 5 Pass");
								sub83(("GENERIC SHOUT DEBUG *************** Intruder = " + sub3(oTarget)));
								if (GetObjectSeen(oTarget, OBJECT_SELF)) {
									sub83("GENERIC SHOUT DEBUG *************** Shout: Determine Combat Round");
									...
									if (GetIsObjectValid(oTarget)) {
										sub83("GENERIC SHOUT DEBUG *************** Shout: Move To Intruder");
										...
										if (IsObjectPartyMember(OBJECT_SELF)) {
											...
											sub83(("GENERIC SHOUT DEBUG *************** Attack Intruder = " + sub3(oTarget)));
											if (GetIsObjectValid(oTarget)) {
												sub1(oTarget);
											}
											else {
												oTarget = GetSpellTarget(objectParam1);
												sub83(("GENERIC SHOUT DEBUG *************** Spell Intruder = " + sub3(oTarget)));
												if (GetIsObjectValid(oTarget)) {
													sub1(oTarget);
												}
											}
...
int sub79(object objectParam1) {
	...
	if ((GetTag(OBJECT_SELF) == "DEBUG")) {
		sub3(OBJECT_SELF);
		sub78(("Attempted Attack Target = " + IntToString(GetIsObjectValid(object1))), 10, 20, 4.0);
		sub78(("Attempted Spell Target = " + IntToString(GetIsObjectValid(object3))), 10, 22, 4.0);
		sub78(("Attack Target = " + IntToString(GetIsObjectValid(oTarget))), 10, 24, 4.0);
		sub78(("Move Target = " + IntToString(GetIsObjectValid(object7))), 10, 26, 4.0);
	}
...
void main() {
	...
	switch (int1) {
		...
		case 1001:
			{
				...
				if ((!sub6(intGLOB_103))) {
				if ((sub6(intGLOB_46) || sub6(intGLOB_47))) {
					...
					if (((!GetIsObjectValid(GetObjectByTag(string1, 0))) && (nLocal <= 0))) {
						if ((GetCurrentAction(OBJECT_SELF) != 0)) {
							if (((!sub79(OBJECT_SELF)) && (!GetIsObjectValid(oNearest)))) {
								sub80();
							}
						}
					}
		...
		case 1002:
			{
				...
				if ((GetCommandable(OBJECT_SELF) && (!sub6(intGLOB_103)))) {
				if ((((!GetIsObjectValid(GetAttemptedAttackTarget())) && (!GetIsObjectValid(GetAttemptedSpellTarget()))) && (!GetIsObjectValid(GetAttackTarget(OBJECT_SELF))))) {
				...
				if ((sub6(intGLOB_74) && GetLastPerceptionSeen())) {
				...
				if ((((!GetIsObjectValid(oLastActor)) || GetIsDead(oLastActor)) || (!GetObjectSeen(oLastActor, oSpeaker)))) {
					if (GetCommandable(OBJECT_SELF)) {
						if ((int34 == (-1))) {
							ClearAllActions();
							if (sub6(intGLOB_90)) {
								ActionStartConversation(GetFirstPC(), "", 0, 1, 0, "", "", "", "", "", "", 0);
								return;
							}
							else {
		...
		case 1012:
			{
				...
				if ((((!sub6(intGLOB_101)) && (!sub6(intGLOB_102))) && (!sub6(intGLOB_103)))) {
		...
		case 2001:
			{
				...
				if (((!sub6(intGLOB_103)) && (!GetSoloMode()))) {
				if ((GetPartyMemberByIndex(0) != OBJECT_SELF)) {
					if ((((((IsObjectPartyMember(OBJECT_SELF) && (GetCurrentAction(OBJECT_SELF) != 0)) && (GetCurrentAction(OBJECT_SELF) != 38)) && (!GetIsConversationActive())) && (!sub6(intGLOB_102))) && GetCommandable(OBJECT_SELF))) {
						if (((!sub79(OBJECT_SELF)) && (!GetIsObjectValid(object65)))) {
							ClearAllActions();
							ActionFollowLeader();
						}
					}
							...
							if (GetLastPerceptionSeen()) {
								if (GetIsEnemy(GetLastPerceived(), OBJECT_SELF)) {
									...
									if (GetIsObjectValid(GetAttackTarget(oNPC))) {
										sub78("Perception Attack", 10, 12, 4.0);
										SpeakString("GEN_I_WAS_ATTACKED", 4);
										sub1(OBJECT_INVALID);
									}
									else {
										if ((GetIsObjectValid(GetSpellTarget(oNPC)) && GetIsEnemy(GetSpellTarget(oNPC), OBJECT_SELF))) {
											sub78("Perception Attack", 10, 12, 4.0);
											SpeakString("GEN_I_WAS_ATTACKED", 4);
											sub1(OBJECT_INVALID);
										}
		...
		case 2003:
			if ((!sub6(intGLOB_103))) {
				sub84(("GENERIC DEBUG *************** End of Combat Round: " + sub3(OBJECT_SELF)));
				SpeakString("GEN_I_WAS_ATTACKED", 3);
				sub1(OBJECT_INVALID);
			}
			if (sub6(intGLOB_79)) {
		...
		case 2004:
			{
				int int141 = GetListenPatternNumber();
				if ((!sub6(intGLOB_103))) {
				if (GetCommandable(OBJECT_SELF)) {
					object object90 = GetLastSpeaker();
					object object92;
					if ((int141 == (-1))) {
						ClearAllActions();
						BeginConversation("", OBJECT_INVALID);
						...
						sub82(object90, int141, GetLastHostileActor(object90));
					}
				}
				}
				if ((int141 == (-1))) {
						...
						if ((GetCurrentAction(OBJECT_SELF) != 38)) {
							if (((!GetIsObjectValid(GetAttemptedAttackTarget())) && (!GetIsObjectValid(GetAttemptedSpellTarget())))) {
								if (GetIsObjectValid(GetLastDamager())) {
									if ((((!GetIsObjectValid(GetAttemptedAttackTarget())) && (!GetIsObjectValid(GetAttemptedSpellTarget()))) && (!GetIsObjectValid(GetAttackTarget(OBJECT_SELF))))) {
										sub1(OBJECT_INVALID);
										if ((!sub79(OBJECT_SELF))) {
											object object111 = GetLastDamager();
											if (((!GetObjectSeen(object111, OBJECT_SELF)) && (GetArea(OBJECT_SELF) == GetArea(object111)))) {
												ActionMoveToLocation(GetLocation(object111), 1);
												ActionDoCommand(sub1(OBJECT_INVALID));
											}
										}
									}
								...
								if ((!GetIsObjectValid(GetAttemptedSpellTarget()))) {
									object object116 = GetAttackTarget(OBJECT_SELF);
									if ((!GetIsObjectValid(object116))) {
										object116 = GetAttemptedAttackTarget();
									}
									object object119 = GetLastHostileActor(OBJECT_SELF);
									if ((((GetIsObjectValid(object119) && (object116 != object119)) && GetIsEnemy(object119, OBJECT_SELF)) && ((GetTotalDamageDealt() > (GetMaxHitPoints(OBJECT_SELF) / 4)) || ((GetHitDice(object119) - 2) > GetHitDice(object116))))) {
										sub1(object119);
									}
								}
							}
		...
		case 2009:
			{
				object object121 = GetBlockingDoor();
				if ((!sub6(intGLOB_103))) {
				if ((GetAbilityScore(OBJECT_SELF, 3) >= 5)) {
					if ((GetIsDoorActionPossible(object121, 0) && (GetAbilityScore(OBJECT_SELF, 3) >= 7))) {
						DoDoorAction(object121, 0);
					}
					else {
						if (GetIsDoorActionPossible(object121, 2)) {
							DoDoorAction(object121, 2);
						}
					}
				}
				}
