...
void main() {
	...
	DestroyObject(GetNearestObjectByTag("sta_malak_drain", OBJECT_SELF, 1), 0.0, FALSE, 0.0);
	DestroyObject(GetNearestObjectByTag("sta_malak_trig", OBJECT_SELF, 1), 0.0, FALSE, 0.0);
	...
	AssignCommand(OBJECT_SELF, DelayCommand(0.1, DestroyObject(OBJECT_SELF)));
}
