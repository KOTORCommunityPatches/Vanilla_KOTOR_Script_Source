void main() {
	...
	object oCaptive = GetNearestObjectByTag("sta_plc_captive7", OBJECT_SELF, 1);
	...
	DelayCommand(1.0, AssignCommand(oCaptive, ActionPlayAnimation(ANIMATION_PLACEABLE_DEACTIVATE)));
