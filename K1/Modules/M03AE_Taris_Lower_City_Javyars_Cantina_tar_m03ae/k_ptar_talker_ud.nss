...
void main() {
	...
	switch (int1) {
		case 2000:
			...
			CancelCombat(oCalo031);
			sub2(oCalo031);
			AssignCommand(oCalo031, ClearAllActions());
			DelayCommand(3.0, AssignCommand(oCalo031, sub4(intGLOB_130, 0)));
			DelayCommand(3.5, AssignCommand(oCalo031, ActionMoveToObject(GetObjectByTag("p_exit", 0), 0, 1.0)));
			break;
	}
}