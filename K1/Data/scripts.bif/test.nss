...
// Prototypes
void sub76(string stringParam1, int intParam2, int intParam3, float floatParam4);
void sub75();
void sub74(string stringParam1);
int sub73(int intParam1, int intParam2);
void sub72();
int sub71(object objectParam1);
int sub70();
int sub69();
object sub68(object objectParam1);
int sub67(object objectParam1);
int sub66(object objectParam1);
int sub65();
talent sub64(object objectParam1, talent talentParam2);
int sub63(int intParam1);
int sub62(int intParam1);
int sub61();
int sub60();
int sub59();
int sub58();
...
int sub50();
int sub49();
talent sub48(int intParam1);
string sub47(int intParam1);
int sub46();
int sub45();
int sub44();
int sub43();
...
int sub35();
int sub34();
int sub33(int intParam1);
int sub32(int intParam1);
talent sub31(int intParam1);
object sub30();
int sub29(object objectParam1);
talent sub28(object objectParam1, talent talentParam2);
talent sub27(object objectParam1, talent talentParam2);
int sub26();
object sub25();
int sub24();
int sub23(object objectParam1);
talent sub22(int intParam1);
talent sub21(int intParam1);
talent sub20(int intParam1);
talent sub19(int intParam1, int intParam2);
int sub18(object objectParam1, float floatParam2);
int sub17(object objectParam1, float floatParam2);
object sub16();
int sub15();
object sub14(int intParam1);
int sub13(int intParam1, object objectParam2);
object sub12();
...
void sub75() {
	int nRandom = d8(1);
	if ((nRandom == 1)) {
		sub74("WALKWAYS DEBUG *************** Play Anim: Bored");
		ActionPlayAnimation(103, 1.0, 0.0);
	}
	else {
		if ((nRandom == 2)) {
			sub74("WALKWAYS DEBUG *************** Play Anim: Scratch");
			ActionPlayAnimation(102, 1.0, 0.0);
		}
		else {
			if ((nRandom == 3)) {
				sub74("WALKWAYS DEBUG *************** Play Anim: Pause 2");
				ActionPlayAnimation(1, 1.0, 3.0);
			}
			else {
				if ((((nRandom == 4) || (nRandom == 5)) && (GetRacialType(OBJECT_SELF) != 5))) {
					if ((GetGender(OBJECT_SELF) == 0)) {
						sub74("WALKWAYS DEBUG *************** Play Anim: Male Pause 3");
						sub9(intGLOB_72, 0);
						ActionPlayAnimation(24, 1.0, 20.4);
						ActionDoCommand(sub9(intGLOB_72, 1));
					}
					else {
						if ((GetGender(OBJECT_SELF) == 1)) {
							sub74("WALKWAYS DEBUG *************** Play Anim: Female Pause 3");
							sub9(intGLOB_72, 0);
					...
					if ((((nRandom == 6) || (nRandom == 4)) || (nRandom == 5))) {
						sub74("WALKWAYS DEBUG *************** Play Anim: Head Turn Left");
						ActionPlayAnimation(100, 1.0, 0.0);
					}
					else {
						if ((nRandom == 7)) {
							sub74("WALKWAYS DEBUG *************** Play Anim: Head Turn Right");
...
void sub72() {
	if ((!sub1(intGLOB_81))) {
		...
		string string2 = "WP_";
		string string3;
		int nLocal = GetLocalNumber(OBJECT_SELF, intGLOB_69);
		int int4 = GetLocalNumber(OBJECT_SELF, intGLOB_70);
		int int6 = GetLocalNumber(OBJECT_SELF, intGLOB_71);
		...
		if ((GetDistanceToObject2D(object3) <= 2.5)) {
			...
			if (sub1(intGLOB_78)) {
				...
				if (((nLocal < int4) && (!sub1(intGLOB_78)))) {
					int16 = sub73(int4, nLocal);
					nLocal = (nLocal + int16);
				}
				else {
					if ((nLocal == int4)) {
		...
		if (GetIsObjectValid(GetWaypointByTag(string9))) {
			...
			sub74("WALKWAYS DEBUG *************** Adding Action: Force Move");
			ActionForceMoveToObject(object3, sub1(intGLOB_79), 2.5, float3);
			if (sub1(intGLOB_72)) {
				sub74("WALKWAYS DEBUG *************** Adding Action: Animation");
				ActionDoCommand(sub75());
			}
			SetLocalNumber(OBJECT_SELF, intGLOB_69, nLocal);
			if ((string2 != "UNKNOWN")) {
				sub74("WALKWAYS DEBUG *************** Adding Action: Walkways Interate");
				ActionDoCommand(sub72());
			}
		}
	}
}
...
int sub71(object objectParam1) {
	...
	string string3 = IntToString(nLocal);
	string string5 = (("WP_" + string3) + "_01");
	object oWP = GetWaypointByTag(string1);
	object object3 = GetWaypointByTag(string5);
	if ((GetIsObjectValid(oWP) || GetIsObjectValid(object3))) {
		return 1;
	}
	return 0;
}
...
int sub69() {
	if ((sub1(intGLOB_127) && (!sub1(intGLOB_128)))) {
		int int3 = sub70();
		return 1;
	}
	else {
	...
	if (((!IsObjectPartyMember(OBJECT_SELF)) && (sub71(OBJECT_SELF) == 1))) {
		sub3("GENERIC DEBUG *************** Clear 1100");
		ClearAllActions();
		DelayCommand(1.0, sub72());
		return 1;
	}
	else {
		if (((GetPartyMemberByIndex(0) != OBJECT_SELF) && (!GetIsObjectValid(GetNearestCreature(3, 1, OBJECT_SELF, 1, 7, 7, 0xFFFFFFFF, 0xFFFFFFFF))))) {
			if ((!GetSoloMode())) {
				sub76("NO TARGET: FOLLOW LEADER", 10, 10, 4.0);
...
int sub67(object objectParam1) {
	...
	talent talent1;
	object object3;
	if (sub13(intGLOB_142, OBJECT_SELF)) {
		return 1;
	}
	if (GetIsObjectValid(object1)) {
		if (sub13(intGLOB_140, object1)) {
			return 1;
		}
	}
	object object4 = sub12();
	if (GetIsObjectValid(object4)) {
		if (sub13(intGLOB_141, object4)) {
			return 1;
		}
	}
	object3 = sub25();
	sub3(("GENERIC DEBUG *************** Jedi Support AI: AOE Target = " + sub8(GetIsObjectValid(object3))));
	if (GetIsObjectValid(object3)) {
		if ((GetRacialType(object3) == 5)) {
			talent1 = sub19(intGLOB_29, 1);
		}
		else {
			talent1 = sub19(intGLOB_29, 0);
		}
	}
	else {
		sub3("GENERIC DEBUG *************** Jedi Support AI: Inside the Party AI Section");
		object3 = sub68(OBJECT_INVALID);
		...
		if (GetIsObjectValid(object3)) {
			...
			if ((GetRacialType(object3) == 5)) {
				talent1 = sub19(intGLOB_30, 1);
			}
			else {
				talent1 = sub19(intGLOB_30, 0);
			}
		}
	}
	talent1 = sub27(object3, talent1);
	talent1 = sub28(object3, talent1);
...
int sub65() {
	object oInvItem;
	if (((((GetIsObjectValid(GetAttackTarget(OBJECT_SELF)) && (GetDistanceBetween(GetAttackTarget(OBJECT_SELF), OBJECT_SELF) <= 3.0)) && (sub23(OBJECT_SELF) != 1)) && (GetRacialType(OBJECT_SELF) == 6)) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		...
		if ((((((((sub23(OBJECT_SELF) != 2) && (GetLevelByClass(4, OBJECT_SELF) == 0)) && (GetLevelByClass(3, OBJECT_SELF) == 0)) && (GetLevelByClass(5, OBJECT_SELF) == 0)) && GetIsObjectValid(GetAttackTarget(OBJECT_SELF))) && (GetDistanceBetween(GetAttemptedAttackTarget(), OBJECT_SELF) > 3.0)) && (!IsObjectPartyMember(OBJECT_SELF)))) {
			oInvItem = GetFirstItemInInventory(OBJECT_SELF);
			while (GetIsObjectValid(oInvItem)) {
...
int sub63(int intParam1) {
	int int1;
	int nRandom = d4(1);
	if ((sub23(OBJECT_SELF) != 0)) {
		while ((int1 == 0)) {
			if ((sub23(OBJECT_SELF) == 1)) {
				if ((nRandom == 1)) {
					nRandom = intGLOB_44;
				}
				else {
...
talent sub48(int intParam1) {
	SetLocalBoolean(OBJECT_SELF, intGLOB_68, 0);
				...
				if ((intParam1 == intGLOB_46)) {
					...
					if ((intParam1 == intGLOB_47)) {
						...
						if ((intParam1 == intGLOB_48)) {
							...
							if ((intParam1 == intGLOB_49)) {
								talRandom = GetCreatureTalentRandom(63743, OBJECT_SELF, 0);
								if ((GetIsTalentValid(talRandom) && sub34())) {
									return 1;
								}
							}
							else {
								if ((intParam1 == intGLOB_50)) {
									talRandom = GetCreatureTalentRandom(63743, OBJECT_SELF, 0);
									talent2 = GetCreatureTalentRandom(62207, OBJECT_SELF, 0);
									if (((GetIsTalentValid(talRandom) && GetIsTalentValid(talent2)) && sub34())) {
										return 1;
									}
								}
								else {
									if ((intParam1 == intGLOB_51)) {
										...
										if ((intParam1 == intGLOB_52)) {
											...
											if ((intParam1 == intGLOB_53)) {
												talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
												if (((sub38() && sub39()) && GetIsTalentValid(talRandom))) {
													return 1;
												}
											}
											else {
												if ((intParam1 == intGLOB_54)) {
													...
													if ((intParam1 == intGLOB_55)) {
														...
														if ((intParam1 == intGLOB_56)) {
															talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
															if (((sub36() && sub42()) && GetIsTalentValid(talRandom))) {
																return 1;
															}
														}
														else {
															if ((intParam1 == intGLOB_57)) {
																if (((sub42() && sub35()) && sub43())) {
																	return 1;
																}
															}
															else {
																if ((intParam1 == intGLOB_58)) {
																	if (((sub40() && sub35()) && sub37())) {
																		return 1;
																	}
																}
																else {
																	if ((intParam1 == intGLOB_59)) {
																		if (((sub41() && sub35()) && sub37())) {
																			return 1;
																		}
																	}
																	else {
																		if ((intParam1 == intGLOB_59)) {
																			if (((sub36() && sub44()) && sub35())) {
																				return 1;
																			}
																		}
																		else {
																			if ((intParam1 == intGLOB_61)) {
																				...
																				if ((intParam1 == intGLOB_62)) {
																					...
																					if ((intParam1 == intGLOB_63)) {
																						talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
																						if ((sub35() && GetIsTalentValid(talRandom))) {
																							return 1;
																						}
																					}
																					else {
																						if ((intParam1 == intGLOB_64)) {
																							talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
																							if (((sub35() && sub42()) && GetIsTalentValid(talRandom))) {
																								return 1;
																							}
																						}
																						else {
	...
	if (((structGLOB_1.int13 == 4) || (structGLOB_1.int13 == 0))) {
		...
		if ((nRandom > 0)) {
			if ((((GetLevelByClass(4, OBJECT_SELF) > 0) || (GetLevelByClass(3, OBJECT_SELF) > 0)) || (GetLevelByClass(5, OBJECT_SELF) > 0))) {
				int2 = sub32(intParam1);
				sub3(("GENERIC DEBUG *************** Starting Jedi Combo " + sub47(int2)));
				...
				if (((GetLevelByClass(6, OBJECT_SELF) > 0) || (GetLevelByClass(7, OBJECT_SELF) > 0))) {
					int2 = sub62(intParam1);
					sub3(("GENERIC DEBUG *************** Starting Droid Combo " + sub47(int2)));
					SetLocalNumber(OBJECT_SELF, intGLOB_35, 1);
					SetLocalNumber(OBJECT_SELF, intGLOB_34, int2);
					return sub48(int2);
				}
				else {
					int2 = sub63(intParam1);
					sub3(("GENERIC DEBUG *************** Starting NPC Combo " + sub47(int2)));
					SetLocalNumber(OBJECT_SELF, intGLOB_35, 1);
					SetLocalNumber(OBJECT_SELF, intGLOB_34, int2);
					return sub48(int2);
				}
		...
		sub3(("GENERIC DEBUG *************** Continuing Combo " + sub47(structGLOB_1.int15)));
		return sub48(structGLOB_1.int15);
	}
	return talent1;
}
...
int sub29(object objectParam1) {
	...
	if (GetIsObjectValid(oNPC)) {
		if (sub13(intGLOB_140, oNPC)) {
			return 1;
		}
	}
	oNPC = sub12();
	if (GetIsObjectValid(oNPC)) {
		if (sub13(intGLOB_141, oNPC)) {
			return 1;
		}
	}
	talent1 = sub31(0);
	int nLocalBool = GetLocalBoolean(OBJECT_SELF, intGLOB_68);
	if ((nLocalBool == 1)) {
	...
	if ((GetRacialType(OBJECT_SELF) == 5)) {
		talent1 = sub64(oNPC, talent1);
	}
	talent1 = sub27(oNPC, talent1);
	talent1 = sub28(oNPC, talent1);
...
int sub26() {
	...
	sub3((("GENERIC DEBUG *************** Boss AI: Get the #" + sub8(nRandom)) + " target"));
	...
	while ((GetIsObjectValid(oNearest) && (int4 <= nRandom))) {
		sub3(((("GENERIC DEBUG *************** Boss AI: Valid oFind = " + sub4(oNearest)) + " nCnt = ") + sub8(int4)));
		if (GetIsObjectValid(oNearest)) {
	...
	if ((int7 == 1)) {
		if (GetIsTalentValid(talent1)) {
			if ((GetTypeFromTalent(talent1) == 1)) {
				sub3(("GENERIC DEBUG *************** Boss AI: Talent Feat = " + sub8(GetIdFromTalent(talent1))));
			}
			else {
				if ((GetTypeFromTalent(talent1) == 0)) {
					sub3(("GENERIC DEBUG *************** Boss AI: Talent Power = " + sub8(GetIdFromTalent(talent1))));
				}
			}
		}
	}
	if (GetIsObjectValid(object1)) {
		...
		talent1 = sub19(intGLOB_30, int1);
		talent1 = sub27(object1, talent1);
		talent1 = sub28(object1, talent1);
		sub3(("GENERIC DEBUG *************** Boss AI: Target = " + sub8(GetIsObjectValid(object1))));
		sub3(("GENERIC DEBUG *************** Boss AI: Talent = " + sub8(GetIsTalentValid(talent1))));
...
int sub24() {
	...
	talent talent1;
	object object1 = sub25();
	sub3(("GENERIC DEBUG *************** Boss AI: AOE Target = " + sub8(GetIsObjectValid(object1))));
	int int2;
	if (GetIsObjectValid(object1)) {
		if ((GetRacialType(object1) == 5)) {
			(int2 == 1);
		}
		talent1 = sub19(intGLOB_29, int2);
		if (GetIsTalentValid(talent1)) {
			ClearAllActions();
			ActionUseTalentOnObject(talent1, object1);
...
talent sub21(int intParam1) {
	...
	sub3(("GENERIC DEBUG *************** Last Force Power Used = " + sub8(nLastForce)));
	...
	sub3(("GENERIC DEBUG *************** Force Power Returned = " + sub8(GetIdFromTalent(talent1))));
	return talent1;
}
...
object sub16() {
	...
	while (GetIsObjectValid(oShapeObject)) {
		if ((GetObjectSeen(oShapeObject, OBJECT_SELF) && (!GetIsDead(oShapeObject)))) {
			int3 = sub17(oShapeObject, 4.0);
			int4 = sub18(oShapeObject, 4.0);
...
int sub15() {
	...
	talent talent1;
	object object1 = sub16();
	sub3(("GENERIC DEBUG *************** Boss AI: Grenade Target = " + sub8(GetIsObjectValid(object1))));
	int int2;
	if (GetIsObjectValid(object1)) {
		if ((GetRacialType(object1) == 5)) {
			(int2 == 1);
		}
		talent1 = sub19(intGLOB_28, int2);
		if (GetIsTalentValid(talent1)) {
			ClearAllActions();
			ActionUseTalentOnObject(talent1, object1);
			sub3("GENERIC DEBUG *************** Boss AI: AOE Success");
...
object sub14(int intParam1) {
	...
	sub3(("GENERIC DEBUG *************** Heal Drain Target = " + sub8(intParam1)));
...
int sub13(int intParam1, object objectParam2) {
	if (GetIsObjectValid(objectParam2)) {
		...
		int int3 = 0;
		int int4 = 0;
		if ((intParam1 == intGLOB_139)) {
			int2 = 61473;
		}
		else {
			if ((intParam1 == intGLOB_140)) {
		...
		if (((int3 == 1) && (int4 == 0))) {
			...
			sub3(("GENERIC DEBUG *************** Spells.2DA ID = " + sub8(nTalent)));
			ClearAllActions();
	...
	sub3(((((("GENERIC DEBUG *************** " + sub4(OBJECT_SELF)) + " VP = ") + sub8(GetCurrentHitPoints(OBJECT_SELF))) + "/") + sub8(GetMaxHitPoints(OBJECT_SELF))));
...
int sub11(object objectParam1) {
	...
	object object1 = sub12();
	if (GetIsObjectValid(object1)) {
		if (sub13(intGLOB_141, object1)) {
			return 1;
		}
	}
	if ((sub15() == 1)) {
...
int sub10() {
	int int1 = 0;
	if (((sub1(intGLOB_134) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
...
int sub7() {
	...
	sub3(((("GENERIC DEBUG *************** Shield Boolean (" + sub8(intGLOB_132)) + ") = ") + sub8(sub1(intGLOB_132))));
	if (((sub1(intGLOB_132) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		int int4;
		int int5;
		int int6 = 0;
		talent talSpell;
...
void sub2(object objectParam1) {
	...
	sub5();
	{
		...
		if (((((!sub1(intGLOB_127)) && (!sub1(intGLOB_128))) && (!sub1(intGLOB_129))) && (!GetUserActionsPending()))) {
		if (((GetPartyMemberByIndex(0) != OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF)))) {
			if (((IsObjectPartyMember(OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF))) || (!IsObjectPartyMember(OBJECT_SELF)))) {
				...
				if ((sub1(intGLOB_131) == 1)) {
					if ((sub11(objectParam1) == 1)) {
						return;
					}
				}
				if ((nNPCStyle == 0)) {
					if ((sub29(objectParam1) == 1)) {
						return;
					}
				}
				else {
					if ((nNPCStyle == 4)) {
						if ((sub66(objectParam1) == 1)) {
							return;
						}
					}
					else {
