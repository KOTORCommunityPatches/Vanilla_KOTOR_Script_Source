void main() {
	...
	switch (nParam1) {
		case 0:
			...
			break;
		case 1:
			SetGlobalFadeIn(0.8, 2.7, 0.0, 0.0, 0.0);
			ActionPauseConversation();
		...
		case 3:
			...
			DelayCommand(1.7, SoundObjectPlay(GetObjectByTag("choke", 0)));
			break;
		case 4:
		...
		case 5:
			ActionPauseConversation();
			AssignCommand(oVisasMarr, ActionMoveToObject(GetObjectByTag("sp_tobin", 0), 0, 1.0));
			...
			DelayCommand(12.2, StartNewModule(GetGlobalString("K_LAST_MODULE"), "K_LAST_LOCATION", "", "", "", "", "", ""));
			break;
		case 6:
