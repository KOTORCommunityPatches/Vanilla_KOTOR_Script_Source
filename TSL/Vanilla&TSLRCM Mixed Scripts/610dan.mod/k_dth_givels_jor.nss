...
void main() {
	...
	string3 = sub1(((GetGlobalNumber("G_PC_LEVEL") - 2) + Random(5)), 240);
	string4 = sub1(((GetGlobalNumber("G_PC_LEVEL") + 2) + Random(5)), 245);
	CreateItemOnObject(string2, oLeader, 1, 0);
	CreateItemOnObject(string3, oLeader, 1, 0);
	CreateItemOnObject(string4, oLeader, 1, 0);
}
