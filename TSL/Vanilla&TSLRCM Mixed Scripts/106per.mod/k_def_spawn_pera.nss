...
// Prototypes
void sub23();
void sub22(int intParam1, int intParam2);
int sub21(int intParam1, int intParam2);
int sub20(object objectParam1, int intParam2);
void sub19();
void sub18(object objectParam1, int intParam2, int intParam3);
			...
			if ((nRandom == 3)) {
				...
				if ((((nRandom == 4) || (nRandom == 5)) && (GetRacialType(OBJECT_SELF) != 5))) {
					if ((GetGender(OBJECT_SELF) == 0)) {
						...
						ActionDoCommand(sub22(intGLOB_52, 1));
					}
					else {
		...
		while ((int2 <= intParam2)) {
			{
				...
				if (sub12(int3, 0, 85)) {
					string1 = sub13(int6, intParam3);
				}
				else {
					if (sub12(int3, 86, 100)) {
						string1 = sub17(int6, intParam3);
					}
				}
				}
...
void sub5(object objectParam1, int intParam2, int intParam3) {
	int int1 = (Random(100) + GetGlobalNumber("000_RareItemChance"));
	if ((int1 > 90)) {
		sub6(objectParam1, intParam2, 200);
	}
	else {
		if ((int1 > 80)) {
			sub6(objectParam1, intParam2, 300);
		}
		else {
			IncrementGlobalNumber("000_RareItemChance", 3);
			sub18(objectParam1, intParam2, 900);
		}
	}
}
