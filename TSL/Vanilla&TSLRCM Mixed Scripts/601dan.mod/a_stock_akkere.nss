...
void sub1(string stringParam1) {
	...
	object object2;
	if ((stringParam1 != "")) {
		object2 = GetObjectByTag(stringParam1, 0);
	}
	else {
		object2 = OBJECT_SELF;
	}
...
void main() {
	if ((GetLocalBoolean(OBJECT_SELF, 58) == 0)) {
		...
		string string1;
		sub1("store_akkere");
		string1 = sub2((Random(15) + 1), 500);
		CreateItemOnObject(string1, GetObjectByTag("store_akkere", 0), int4, 0);
		string1 = sub2((Random(15) + 1), 500);
		CreateItemOnObject(string1, GetObjectByTag("store_akkere", 0), int4, 0);
		string1 = sub2((Random(15) + 1), 500);
		CreateItemOnObject(string1, GetObjectByTag("store_akkere", 0), int4, 0);
		...
		while ((int2 < 21)) {
			{
				string string6 = sub2(int2, 500);
				int4 = 1;
				if (int3 = (FindSubString(string6, "[") >= 0)) {
				int4 = StringToInt(GetSubString(string6, (int3 + 1), 4));
				string1 = GetSubString(string6, 0, int3);
				}
				else {
				string1 = string6;
				}
