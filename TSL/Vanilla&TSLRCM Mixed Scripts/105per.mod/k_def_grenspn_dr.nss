...
void sub17();
void sub16();
void sub15(int intParam1);
void sub14(object objectParam1, int intParam2, int intParam3);
...
void sub16() {
	...
	sub17();
	if ((sub18(intGLOB_122) || GetIsEncounterCreature(OBJECT_SELF))) {
		string string1;
		int int5 = 1;
		object object1;
		object object2;
...
void sub1(object objectParam1, int intParam2, int intParam3) {
	...
	if ((int1 > 90)) {
		sub2(objectParam1, intParam2, 200);
	}
	else {
		if ((int1 > 80)) {
			sub2(objectParam1, intParam2, 300);
		}
		else {
			IncrementGlobalNumber("000_RareItemChance", 3);
			sub14(objectParam1, intParam2, 900);
		}
	}
}
