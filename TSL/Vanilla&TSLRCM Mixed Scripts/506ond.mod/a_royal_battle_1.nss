...
void main() {
	...
	switch (nParam1) {
		case 0:
			...
			DelayCommand(0.5, AssignCommand(oTalia, CutsceneAttack(oVaklu, 94, 4, 0)));
			DelayCommand(1.0, AssignCommand(oTalia, CutsceneAttack(oVaklu, 95, 4, 0)));
			DelayCommand(1.5, AssignCommand(oVaklu, CutsceneAttack(oTalia, 94, 8, 0)));
			DelayCommand(2.0, AssignCommand(oVaklu, CutsceneAttack(oTalia, 94, 8, 0)));
			DelayCommand(2.5, AssignCommand(oTalia, CutsceneAttack(oVaklu, 95, 2, 24)));
			DelayCommand(3.0, AssignCommand(oVaklu, CutsceneAttack(oTalia, 94, 8, 0)));
			DelayCommand(3.5, AssignCommand(oTalia, CutsceneAttack(oVaklu, 95, 2, 24)));
			DelayCommand(4.0, AssignCommand(oVaklu, CutsceneAttack(oTalia, 94, 8, 0)));
			DelayCommand(4.5, AssignCommand(oTalia, CutsceneAttack(oVaklu, 95, 2, 24)));
			DelayCommand(5.0, AssignCommand(oVaklu, CutsceneAttack(oTalia, 95, 2, 24)));
			DelayCommand(5.5, AssignCommand(oVaklu, CutsceneAttack(oVaklu, 95, 2, 24)));
		...
		case 1:
			...
			ChangeToStandardFaction(oVaklu, 22);
			ChangeToStandardFaction(oTalia, 22);
			DelayCommand(1.5, AssignCommand(oTalia, CutsceneAttack(oVaklu, 94, 8, 0)));
			DelayCommand(2.0, AssignCommand(oVaklu, CutsceneAttack(oTalia, 94, 8, 0)));
			DelayCommand(2.5, AssignCommand(oTalia, CutsceneAttack(oVaklu, 95, 2, 24)));
			DelayCommand(3.0, AssignCommand(oVaklu, CutsceneAttack(oTalia, 94, 8, 0)));
			DelayCommand(3.5, AssignCommand(oTalia, CutsceneAttack(oVaklu, 95, 2, 24)));
			...
			break;
		case 2:
			ChangeToStandardFaction(oVaklu, 5);
			AssignCommand(oTalia, ClearAllActions());
			oWp_end_kavar = GetWaypointByTag("wp_rb_vaklu");
			AssignCommand(oVaklu, ActionMoveToObject(oWp_end_kavar, 1, 1.0));
			DelayCommand(2.0, AssignCommand(oVaklu, SetFacingPoint(GetPosition(oTalia))));
			break;
		case 3:
			oWp_end_kavar = GetWaypointByTag("wp_rb_pc");
			AssignCommand(oPC, ActionJumpToObject(oWp_end_kavar, 1));
			oWp_end_kavar = GetWaypointByTag("wp_end_kavar");
			AssignCommand(GetObjectByTag("kavar", 0), ClearAllActions());
			AssignCommand(GetObjectByTag("kavar", 0), ActionJumpToObject(oWp_end_kavar, 1));
			break;
		case 4:
			ActionPauseConversation();
			int1 = 0;
			while ((int1 <= 3)) {
				oV_troop = GetObjectByTag("v_troop", int1);
				ChangeToStandardFaction(oV_troop, 1);
				AssignCommand(oV_troop, ActionAttack(oPC, 0));
				float1 = ((IntToFloat(int1) * 0.2) + 0.5);
				DelayCommand(float1, AssignCommand(oV_troop, CutsceneAttack(oPC, 217, 9, 0)));
				(int1++);
			}
			DelayCommand(2.0, ActionResumeConversation());
			break;
		case 5:
			ChangeToStandardFaction(oVaklu, 1);
			ChangeToStandardFaction(oTalia, 2);
			break;
		case 6:
			ActionPauseConversation();
			SetMinOneHP(oTalia, 0);
			ChangeToStandardFaction(oTalia, 12);
			int1 = 0;
			while ((int1 <= 3)) {
				oV_troop = GetObjectByTag("v_troop", int1);
				ChangeToStandardFaction(oV_troop, 11);
				AssignCommand(oV_troop, ActionAttack(oTalia, 0));
				float1 = ((IntToFloat(int1) * 0.2) + 0.5);
				DelayCommand(float1, AssignCommand(oV_troop, CutsceneAttack(oTalia, 217, 1, 0)));
				(int1++);
			}
			DelayCommand(2.0, ApplyEffectToObject(0, EffectDeath(0, 1, 0), oTalia, 0.0));
			DelayCommand(2.0, ActionResumeConversation());
			break;
		case 7:
			SetMinOneHP(oTalia, 0);
			ChangeToStandardFaction(oVaklu, 2);
			ChangeToStandardFaction(oTalia, 1);
			break;
		case 8:
			SetCommandable(1, oTalia);
			SetLocalBoolean(oTalia, intGLOB_114, 0);
			ChangeToStandardFaction(oTalia, 1);
			AssignCommand(oTalia, sub1(GetFirstPC()));
			SetMinOneHP(oTalia, 0);
			break;
	}
}
