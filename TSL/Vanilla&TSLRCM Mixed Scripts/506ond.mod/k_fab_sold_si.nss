...
// Prototypes
void sub21();
void sub20(int intParam1, int intParam2);
int sub19(int intParam1, int intParam2);
int sub18(object objectParam1, int intParam2);
void sub17();
string sub16(int intParam1, int intParam2);
string sub15(int intParam1);
string sub14(string stringParam1);
string sub13(int intParam1, int intParam2);
string sub12(int intParam1, int intParam2);
int sub11(int intParam1, int intParam2, int intParam3);
string sub10(int intParam1);
string sub9(string stringParam1);
string sub8(string stringParam1);
string sub7(int intParam1, int intParam2);
string sub6(int intParam1, int intParam2);
			...
			if ((nRandom == 3)) {
				...
				if ((((nRandom == 4) || (nRandom == 5)) && (GetRacialType(OBJECT_SELF) != 5))) {
					if ((GetGender(OBJECT_SELF) == 0)) {
						...
						ActionDoCommand(sub20(intGLOB_52, 1));
					}
					else {
		...
		if (((nLocal < 10) && (nLocal > 0))) {
			...
			if ((nLocal == 0)) {
				if (sub4(intGLOB_58)) {
					...
					if (sub4(intGLOB_54)) {
						int int11 = sub18(OBJECT_SELF, int6);
						if (((int11 > 0) && (int11 < 10))) {
...
string sub16(int intParam1, int intParam2) {
	string string1 = sub7(intParam1, intParam2);
	return string1;
}
...
string sub12(int intParam1, int intParam2) {
	...
	if ((intParam2 == 0)) {
		int2 = (Random(0) + 9);
		string1 = sub12(intParam1, (int2 * 100));
	}
	else {
		if (((intParam2 % 100) == 0)) {
			...
			int2 = (Random(int1) + 1);
			string1 = sub12(intParam1, (intParam2 + (10 * int2)));
		}
		else {
			if (((intParam2 % 10) == 0)) {
				switch ((intParam2 / 10)) {
				...
				int2 = (Random(int1) + 1);
				string1 = sub13(intParam1, (intParam2 + int2));
			}
			else {
				string1 = sub13(intParam1, intParam2);
			}
		}
	}
	return string1;
...
string sub7(int intParam1, int intParam2) {
	...
	if ((intParam2 == 0)) {
		...
		string3 = sub7(intParam1, (int2 * 100));
	}
	else {
		if (((intParam2 % 100) == 0)) {
			switch ((intParam2 / 100)) {
			...
			int2 = (Random(int1) + 1);
			string3 = sub7(intParam1, (intParam2 + (10 * int2)));
		}
		else {
			if (((intParam2 % 10) == 0)) {
				switch ((intParam2 / 10)) {
				...
				int2 = (Random(int1) + 1);
				string3 = sub7(intParam1, (intParam2 + int2));
			}
			else {
				switch (intParam2) {
					case 141:
						string1 = sub8(string1);
						break;
					case 142:
						string1 = sub8(string1);
						break;
				...
				string3 = (sub10(intParam2) + string1);
			}
		}
	}
	return string3;
...
void sub5(object objectParam1, int intParam2, int intParam3) {
	...
	while ((int1 <= intParam2)) {
		int2 = (Random(95) + GetGlobalNumber("000_RareItemChance"));
		{
			...
			if ((int2 > 100)) {
			string1 = sub6(int5, intParam3);
				SetGlobalNumber("000_RareItemChance", 0);
			}
			else {
				IncrementGlobalNumber("000_RareItemChance", 3);
			if (sub11(int2, 0, 85)) {
				string1 = sub12(int5, intParam3);
			}
			else {
				if (sub11(int2, 86, 100)) {
					string1 = sub16(int5, intParam3);
				}
			}
			}
...
void main() {
	...
	SetLocalBoolean(OBJECT_SELF, 28, 1);
	sub5(OBJECT_SELF, Random(3), 0);
	sub17();
}
