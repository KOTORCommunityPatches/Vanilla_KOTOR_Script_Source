...
void main() {
	...
	switch (nParam1) {
		case 0:
			...
			break;
		case 1:
			DelayCommand(1.0, SetLightsaberPowered(GetObjectByTag("Atton", 0), 1, 1, 1));
			DelayCommand(1.0, SetLightsaberPowered(GetObjectByTag("KreiaEvil", 0), 1, 1, 1));
			break;
		case 2:
			ActionPauseConversation();
			{
		...
		case 4:
			...
			ActionPauseConversation();
			SpawnAvailableNPC(4, GetLocation(GetObjectByTag("wp_handmaiden", 0)));
			SpawnAvailableNPC(11, GetLocation(GetObjectByTag("wp_disciple", 0)));
			SpawnAvailableNPC(9, GetLocation(GetObjectByTag("wp_visas", 0)));
			SpawnAvailableNPC(7, GetLocation(GetObjectByTag("wp_mira", 0)));
			SpawnAvailableNPC(2, GetLocation(GetObjectByTag("wp_mandalore", 0)));
			SpawnAvailableNPC(3, GetLocation(GetObjectByTag("wp_goto", 0)));
			SpawnAvailableNPC(10, GetLocation(GetObjectByTag("wp_hanharr", 0)));
			SpawnAvailableNPC(5, GetLocation(GetObjectByTag("wp_hk47", 0)));
			DelayCommand(2.0, ActionResumeConversation());
			break;
		case 5:
		...
		case 7:
			...
			ChangeToStandardFaction(GetObjectByTag("G0T0", 0), 1);
			ChangeToStandardFaction(GetObjectByTag("HK47", 0), 1);
			ChangeToStandardFaction(GetObjectByTag("Hanharr", 0), 1);
			break;
		case 8:
			ChangeToStandardFaction(GetObjectByTag("KreiaEvil", 0), 1);
			ChangeToStandardFaction(GetObjectByTag("Atton", 0), 1);
