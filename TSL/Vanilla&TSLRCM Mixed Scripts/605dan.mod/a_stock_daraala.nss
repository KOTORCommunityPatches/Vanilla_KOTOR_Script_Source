		...
		while ((int2 < 21)) {
			{
				...
				if (int3 = (FindSubString(string9, "[") >= 0)) {
				int4 = StringToInt(GetSubString(string9, (int3 + 1), 4));
				string1 = GetSubString(string9, 0, int3);
				}
				else {
				string1 = string9;
				}
