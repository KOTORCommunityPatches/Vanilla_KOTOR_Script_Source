...
void main() {
	...
	if ((oEntering == GetFirstPC())) {
		...
		if ((((((!GetLocalBoolean(oTo_601, 44)) && (GetGlobalNumber("000_Disc_End_1") == 1)) && GetGlobalNumber("604DAN_Vrook_Status")) && (GetGlobalNumber("000_Disciple_Joined") != 1)) && ((GetGlobalNumber("601DAN_Battle_Mili") == 0) || (GetGlobalNumber("601DAN_Battle_Mili") == 4)))) {
			...
			if ((GetGlobalNumber("101PER_Revan_End") == 0)) {
				...
				CreateObject(1, "Rep_Gen", GetLocation(GetObjectByTag("sp_carth_holo", 0)), 0);
			}
