...
// Prototypes
void sub23(object objectParam1, string stringParam2);
void sub22(object objectParam1, string stringParam2);
void sub21(object objectParam1, string stringParam2);
void sub20(object objectParam1, string stringParam2);
void sub19(object objectParam1, string stringParam2);
void sub18(object objectParam1, string stringParam2);
void sub17(object objectParam1, string stringParam2);
void sub16(object objectParam1, string stringParam2);
void sub15(object objectParam1, string stringParam2);
void sub14();
int sub13(int intParam1, int intParam2);
int sub12(object objectParam1, int intParam2);
void sub11();
void sub10(object objectParam1, string stringParam2);
void sub9(object objectParam1, string stringParam2);
void sub8(object objectParam1, string stringParam2);
...
void sub23(object objectParam1, string stringParam2) {
	...
	if ((int1 && (GetGlobalBoolean("003_cutscene_mode") == 0))) {
		AssignCommand(objectParam1, sub7(intGLOB_58, 1));
		AssignCommand(objectParam1, sub7(intGLOB_54, 1));
		AssignCommand(objectParam1, sub7(intGLOB_62, 1));
		AssignCommand(objectParam1, sub7(intGLOB_68, 1));
		AssignCommand(objectParam1, SetLocalNumber(OBJECT_SELF, 29, 15));
		AssignCommand(objectParam1, sub7(intGLOB_93, 1));
		AssignCommand(objectParam1, sub7(intGLOB_118, 1));
		AssignCommand(objectParam1, sub7(intGLOB_61, 0));
		AssignCommand(objectParam1, sub11());
	}
	else {
		if (int2) {
			sub7(intGLOB_87, 1);
...
void sub22(object objectParam1, string stringParam2) {
	...
	if ((int1 && (GetGlobalBoolean("003_cutscene_mode") == 0))) {
		AssignCommand(objectParam1, sub7(intGLOB_118, 1));
		AssignCommand(objectParam1, ActionPlayAnimation(35, 1.0, (-1.0)));
	}
	else {
		if (int2) {
			sub7(intGLOB_87, 1);
...
void sub21(object objectParam1, string stringParam2) {
	...
	if ((int1 && (!GetGlobalBoolean("003_cutscene_mode")))) {
		AssignCommand(objectParam1, sub7(intGLOB_58, 1));
		AssignCommand(objectParam1, sub7(intGLOB_54, 1));
		AssignCommand(objectParam1, sub7(intGLOB_64, 1));
		AssignCommand(objectParam1, sub7(intGLOB_68, 1));
		AssignCommand(objectParam1, SetLocalNumber(OBJECT_SELF, 29, 25));
		AssignCommand(objectParam1, sub7(intGLOB_118, 1));
		AssignCommand(objectParam1, sub7(intGLOB_61, 0));
		AssignCommand(objectParam1, sub11());
	}
...
void sub19(object objectParam1, string stringParam2) {
	...
	if ((int1 && (GetGlobalBoolean("003_cutscene_mode") == 0))) {
		AssignCommand(objectParam1, sub7(intGLOB_118, 1));
		AssignCommand(objectParam1, ActionPlayAnimation(3, 1.0, (-1.0)));
	}
	else {
		if (int2) {
			sub7(intGLOB_87, 1);
...
void sub17(object objectParam1, string stringParam2) {
	...
	int1;
	if ((int1 && (GetGlobalBoolean("003_cutscene_mode") == 0))) {
		AssignCommand(objectParam1, sub7(intGLOB_56, 1));
		AssignCommand(objectParam1, sub7(intGLOB_54, 1));
		AssignCommand(objectParam1, sub7(intGLOB_62, 1));
		AssignCommand(objectParam1, sub7(intGLOB_68, 1));
		AssignCommand(objectParam1, SetLocalNumber(OBJECT_SELF, 29, 24));
		AssignCommand(objectParam1, sub7(intGLOB_118, 1));
		AssignCommand(objectParam1, sub7(intGLOB_61, 0));
		AssignCommand(objectParam1, sub11());
	}
...
void sub16(object objectParam1, string stringParam2) {
	...
	if ((int1 && (GetGlobalBoolean("003_cutscene_mode") == 0))) {
		...
		AssignCommand(objectParam1, sub7(intGLOB_93, 1));
		AssignCommand(objectParam1, sub7(intGLOB_87, 1));
		AssignCommand(objectParam1, sub7(intGLOB_90, 1));
		AssignCommand(objectParam1, sub7(intGLOB_118, 1));
	}
	else {
		if (int2) {
...
void sub15(object objectParam1, string stringParam2) {
	...
	if ((int1 && (GetGlobalBoolean("003_cutscene_mode") == 0))) {
		AssignCommand(objectParam1, sub7(intGLOB_58, 1));
		AssignCommand(objectParam1, sub7(intGLOB_54, 1));
		AssignCommand(objectParam1, sub7(intGLOB_63, 1));
		AssignCommand(objectParam1, sub7(intGLOB_68, 1));
		AssignCommand(objectParam1, SetLocalNumber(OBJECT_SELF, 29, 15));
		AssignCommand(objectParam1, sub7(intGLOB_118, 1));
		AssignCommand(objectParam1, sub7(intGLOB_61, 0));
			...
			if ((nRandom == 3)) {
				...
				if ((((nRandom == 4) || (nRandom == 5)) && (GetRacialType(OBJECT_SELF) != 5))) {
					if ((GetGender(OBJECT_SELF) == 0)) {
						...
						ActionDoCommand(sub7(intGLOB_52, 1));
					}
					else {
		...
		if (((nLocal < 10) && (nLocal > 0))) {
			...
			if ((nLocal == 0)) {
				if (sub3(intGLOB_58)) {
					...
					if (sub3(intGLOB_54)) {
						int int11 = sub12(OBJECT_SELF, int6);
						if (((int11 > 0) && (int11 < 10))) {
...
void sub5(object objectParam1) {
	AurPostString(("DoSpecialSpawnIn" + GetTag(objectParam1)), 18, 18, 3.0);
	if (GetIsObjectValid(objectParam1)) {
		string string2 = GetTag(objectParam1);
		string string4 = GetModuleName();
		if ((string2 == "atton")) {
			string4;
			objectParam1;
			sub6();
			...
			if ((string2 == "baodur")) {
				sub8(objectParam1, string4);
			}
			else {
				if ((string2 == "mand")) {
					sub9(objectParam1, string4);
				}
				else {
					if ((string2 == "disciple")) {
						sub10(objectParam1, string4);
					}
					else {
						if ((string2 == "g0t0")) {
							sub15(objectParam1, string4);
						}
						else {
							if ((string2 == "handmaiden")) {
								sub16(objectParam1, string4);
							}
							else {
								if ((string2 == "hanharr")) {
									sub17(objectParam1, string4);
								}
								else {
									if ((string2 == "hk47")) {
										sub18(objectParam1, string4);
									}
									else {
										if ((string2 == "kreia")) {
											sub19(objectParam1, string4);
										}
										else {
											if ((string2 == "mira")) {
												sub20(objectParam1, string4);
											}
											else {
												if ((string2 == "t3m4")) {
													sub21(objectParam1, string4);
												}
												else {
													if ((string2 == "visasmarr")) {
														sub22(objectParam1, string4);
													}
													else {
														if ((string2 == "remote")) {
															sub23(objectParam1, string4);
														}
														else {
...
void sub1() {
	...
	sub2();
	if ((sub3(intGLOB_122) || GetIsEncounterCreature(OBJECT_SELF))) {
		string string1;
		int int5 = 1;
		object object1;
		object object2;
