...
void main() {
	object oOm_scout1;
	object object2;
	oOm_scout1 = GetObjectByTag("om_scout1", 0);
	SetLockHeadFollowInDialog(GetObjectByTag("om_scout1", 0), 0);
	SetLockOrientationInDialog(GetObjectByTag("om_scout1", 0), 0);
	SetLockHeadFollowInDialog(GetObjectByTag("om_scout2", 0), 0);
	SetLockOrientationInDialog(GetObjectByTag("om_scout2", 0), 0);
	DelayCommand(0.2, ChangeToStandardFaction(GetObjectByTag("om_scout2", 0), 1));
	DelayCommand(0.2, AssignCommand(GetObjectByTag("om_scout2", 0), ActionAttack(GetFirstPC(), 0)));
