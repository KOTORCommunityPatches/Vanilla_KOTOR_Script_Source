...
int sub7(int intParam1, int intParam2, int intParam3);
string sub6(int intParam1);
string sub5(string stringParam1);
...
void sub17() {
	if ((!sub16(intGLOB_61))) {
		...
		if (GetIsObjectValid(GetWaypointByTag(string11))) {
			...
			ActionForceMoveToObject(object3, sub16(intGLOB_59), fPersonalSpace, float4);
			if (sub16(intGLOB_52)) {
...
void sub14() {
	...
	sub15();
	if ((sub16(intGLOB_122) || GetIsEncounterCreature(OBJECT_SELF))) {
		string string1;
		int int5 = 1;
		object object1;
		object object2;
...
string sub12(int intParam1, int intParam2) {
	string string1 = sub3(intParam1, intParam2);
	return string1;
}
...
string sub8(int intParam1, int intParam2) {
	...
	if ((intParam2 == 0)) {
		int2 = (Random(0) + 9);
		string1 = sub8(intParam1, (int2 * 100));
	}
	else {
		if (((intParam2 % 100) == 0)) {
			...
			int2 = (Random(int1) + 1);
			string1 = sub8(intParam1, (intParam2 + (10 * int2)));
		}
		else {
			if (((intParam2 % 10) == 0)) {
				switch ((intParam2 / 10)) {
				...
				int2 = (Random(int1) + 1);
				string1 = sub9(intParam1, (intParam2 + int2));
			}
			else {
				string1 = sub9(intParam1, intParam2);
			}
		}
	}
	return string1;
...
string sub3(int intParam1, int intParam2) {
	...
	if ((intParam2 == 0)) {
		...
		string3 = sub3(intParam1, (int2 * 100));
	}
	else {
		if (((intParam2 % 100) == 0)) {
			switch ((intParam2 / 100)) {
			...
			int2 = (Random(int1) + 1);
			string3 = sub3(intParam1, (intParam2 + (10 * int2)));
		}
		else {
			if (((intParam2 % 10) == 0)) {
				switch ((intParam2 / 10)) {
				...
				int2 = (Random(int1) + 1);
				string3 = sub3(intParam1, (intParam2 + int2));
			}
			else {
				switch (intParam2) {
					case 141:
				...
				string3 = (sub6(intParam2) + string1);
			}
		}
	}
	return string3;
...
void main() {
	sub1(OBJECT_SELF, (Random(4) - 2), 300);
	sub13(intGLOB_84);
	sub14();
	sub17();
}
