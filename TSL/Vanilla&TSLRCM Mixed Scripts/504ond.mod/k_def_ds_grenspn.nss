...
void sub18();
int sub17(int intParam1);
void sub16();
void sub15();
void sub14(int intParam1);
...
int sub8(int intParam1, int intParam2, int intParam3);
string sub7(int intParam1);
string sub6(string stringParam1);
...
void sub18() {
	if ((!sub17(intGLOB_61))) {
		...
		if (GetIsObjectValid(GetWaypointByTag(string11))) {
			...
			ActionForceMoveToObject(object3, sub17(intGLOB_59), fPersonalSpace, float4);
			if (sub17(intGLOB_52)) {
...
void sub15() {
	...
	sub16();
	if ((sub17(intGLOB_122) || GetIsEncounterCreature(OBJECT_SELF))) {
		string string1;
		int int5 = 1;
		object object1;
		object object2;
...
string sub9(int intParam1, int intParam2) {
	...
	if ((intParam2 == 0)) {
		int2 = (Random(0) + 9);
		string1 = sub9(intParam1, (int2 * 100));
	}
	else {
		if (((intParam2 % 100) == 0)) {
			...
			int2 = (Random(int1) + 1);
			string1 = sub9(intParam1, (intParam2 + (10 * int2)));
		}
		else {
			if (((intParam2 % 10) == 0)) {
				switch ((intParam2 / 10)) {
				...
				int2 = (Random(int1) + 1);
				string1 = sub10(intParam1, (intParam2 + int2));
			}
			else {
				string1 = sub10(intParam1, intParam2);
			}
		}
	}
	return string1;
	...
	if ((intParam2 == 0)) {
		...
		if (((intParam2 % 100) == 0)) {
			...
			if (((intParam2 % 10) == 0)) {
				...
				string3 = (sub7(intParam2) + string1);
			}
		}
	}
	return string3;
