...
// Prototypes
void sub19(object objectParam1, int intParam2, int intParam3);
...
void sub6(object objectParam1, int intParam2, int intParam3) {
	...
	if ((int1 > 90)) {
		sub7(objectParam1, intParam2, 200);
	}
	else {
		if ((int1 > 80)) {
			sub7(objectParam1, intParam2, 300);
		}
		else {
			IncrementGlobalNumber("000_RareItemChance", 3);
			sub19(objectParam1, intParam2, 900);
		}
	}
}
