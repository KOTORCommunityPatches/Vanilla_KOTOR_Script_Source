	...
	switch (nParam1) {
		...
		case 5:
			...
			SetFadeUntilScript();
			{
				...
				sub1(4);
				sub1(2);
				object object4 = SpawnAvailableNPC(5, GetLocation(GetObjectByTag("WP_move_mira", 0)));
			}
			break;
		case 6:
			{
				object object7 = SpawnAvailableNPC(8, GetLocation(GetObjectByTag("WP_spawn_sc21", 0)));
		...
		case 7:
			{
				object oC_drdastro003 = CreateObject(1, "c_drdastro003", GetLocation(GetObjectByTag("WP_spawn_sc21", 0)), 0);
				object object16 = CreateObject(1, "g_thug004", GetLocation(GetObjectByTag("WP_spawn_visquis", 0)), 0);
				SetGlobalFadeIn(0.5, 1.0, 0.0, 0.0, 0.0);
			}
			break;
		case 8:
			...
			AssignCommand(oAtton, SetFacingPoint(GetPositionFromLocation(GetLocation(oVisquis))));
		case 9:
			break;
		case 10:
			break;
		...
		case 13:
			{
				object object23 = GetObjectByTag("Visquis", 0);
				if (GetIsObjectValid(object23)) {
					DestroyObject(object23, 0.0, 0, 0.0, 0);
				}
