...
void main() {
	if ((GetLocalBoolean(OBJECT_SELF, 58) == 0)) {
		...
		int int3;
		int int4 = 1;
		string string1 = sub1((Random(5) + 5), 300);
		CreateItemOnObject(string1, GetObjectByTag("margar_store", 0), int4, 0);
		string1 = sub1((Random(5) + 10), 300);
		CreateItemOnObject(string1, GetObjectByTag("margar_store", 0), int4, 0);
		string1 = sub1((Random(24) + 1), 320);
		CreateItemOnObject(string1, GetObjectByTag("margar_store", 0), int4, 0);
		string1 = sub1((Random(5) + 15), 320);
		CreateItemOnObject(string1, GetObjectByTag("margar_store", 0), int4, 0);
		string1 = sub1((Random(5) + 15), 330);
		CreateItemOnObject(string1, GetObjectByTag("margar_store", 0), int4, 0);
		string1 = sub1((Random(10) + 10), 330);
		CreateItemOnObject(string1, GetObjectByTag("margar_store", 0), int4, 0);
		string1 = sub1((Random(10) + 10), 330);
		CreateItemOnObject(string1, GetObjectByTag("margar_store", 0), int4, 0);
		string1 = sub1((Random(15) + 1), 210);
		CreateItemOnObject(string1, GetObjectByTag("margar_store", 0), int4, 0);
		string1 = sub1((Random(15) + 1), 220);
		CreateItemOnObject(string1, GetObjectByTag("margar_store", 0), int4, 0);
		string1 = sub1((Random(15) + 1), 230);
		CreateItemOnObject(string1, GetObjectByTag("margar_store", 0), int4, 0);
		string1 = sub1((Random(15) + 1), 200);
		CreateItemOnObject(string1, GetObjectByTag("margar_store", 0), int4, 0);
		string1 = sub1((Random(15) + 1), 400);
		CreateItemOnObject(string1, GetObjectByTag("margar_store", 0), int4, 0);
		string1 = sub1((Random(15) + 1), 400);
		CreateItemOnObject(string1, GetObjectByTag("margar_store", 0), int4, 0);
		string1 = sub1((Random(15) + 1), 400);
		...
		while ((int2 < 25)) {
			{
				string string16 = sub1((int2 + Random(2)), 100);
				if ((int2 < 10)) {
				int4 = (Random(2) + 1);
				}
				else {
				...
				if (int3 = (FindSubString(string16, "[") >= 0)) {
				int4 = StringToInt(GetSubString(string16, (int3 + 1), 4));
				string1 = GetSubString(string16, 0, int3);
				}
				else {
				string1 = string16;
				}
