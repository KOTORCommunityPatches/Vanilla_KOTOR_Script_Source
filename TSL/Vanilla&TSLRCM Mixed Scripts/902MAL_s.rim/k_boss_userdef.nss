					...
					if ((int1 == 1005)) {
						...
						if ((int1 == 1006)) {
							...
							if ((int1 == 1007)) {
								...
								AssignCommand(o902boss, DelayCommand(4.0, ClearAllActions()));
								AssignCommand(o902boss, DelayCommand(4.0, ActionStartConversation(GetFirstPC(), "", 0, 0, 1, "", "", "", "", "", "", 0, 0xFFFFFFFF, 0xFFFFFFFF, 0)));
							}
							else {
								if ((int1 == 1008)) {
								}
