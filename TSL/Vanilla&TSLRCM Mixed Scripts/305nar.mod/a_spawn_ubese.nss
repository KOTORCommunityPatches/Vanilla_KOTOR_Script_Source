...
void main() {
	...
	if ((nParam1 == 1)) {
		...
		DelayCommand(1.0, AssignCommand(oUBH305Alarm4, ActionMoveToObject(GetObjectByTag("WP_UBH_ALARM_4_1", 0), 1, 1.0)));
		DelayCommand(2.0, AssignCommand(oUBH305Alarm5, ActionMoveToObject(GetObjectByTag("WP_UBH_ALARM_5_1", 0), 1, 1.0)));
	}
	if ((nParam1 == 2)) {
	...
	if ((nParam1 == 6)) {
		...
		SetLightsaberPowered(GetFirstPC(), 1, 1, 1);
	}
	if ((nParam1 == 7)) {
		object object76 = GetObjectByTag("UBH305Alarm1", 0);
		object object78 = GetObjectByTag("UBH305Alarm2", 0);
		object object80 = GetObjectByTag("UBH305Alarm3", 0);
		object object82 = GetObjectByTag("UBH305Alarm4", 0);
		object object84 = GetObjectByTag("UBH305Alarm5", 0);
		object object86 = GetObjectByTag("UBH305Alarm6", 0);
		AssignCommand(object76, ClearAllActions());
		AssignCommand(object78, ClearAllActions());
		AssignCommand(object80, ClearAllActions());
		AssignCommand(object82, ClearAllActions());
		AssignCommand(object84, ClearAllActions());
		AssignCommand(object86, ClearAllActions());
		DelayCommand(0.5, AssignCommand(object76, SetFacingPoint(GetPosition(GetObjectByTag("DoorRing", 0)))));
		DelayCommand(1.0, AssignCommand(object78, SetFacingPoint(GetPosition(GetObjectByTag("DoorRing", 0)))));
		DelayCommand(1.5, AssignCommand(object80, SetFacingPoint(GetPosition(GetObjectByTag("DoorRing", 0)))));
		DelayCommand(2.0, AssignCommand(object82, SetFacingPoint(GetPosition(GetObjectByTag("DoorRing", 0)))));
		DelayCommand(2.5, AssignCommand(object84, SetFacingPoint(GetPosition(GetObjectByTag("DoorRing", 0)))));
		DelayCommand(3.0, AssignCommand(object84, SetFacingPoint(GetPosition(GetObjectByTag("DoorRing", 0)))));
	}
}
