...
void main() {
	...
	switch (nParam1) {
		case 1:
			CreateObject(1, "c_stormbeast004", GetLocation(GetObjectByTag("SP_StormBeastGBoss", 0)), 0);
			break;
		case 2:
			{
				object oStormBeastGBoss = GetObjectByTag("StormBeastGBoss", 0);
				object oWP_StormBeastGBoss_CS = GetObjectByTag("WP_StormBeastGBoss_CS", 0);
				SetCommandable(1, oStormBeastGBoss);
				ChangeToStandardFaction(oStormBeastGBoss, 4);
				AssignCommand(oStormBeastGBoss, ClearAllActions());
				AssignCommand(oStormBeastGBoss, ActionMoveToObject(oWP_StormBeastGBoss_CS, 0, 1.0));
			}
			break;
		case 3:
			{
				object object7 = GetObjectByTag("StormBeastGBoss", 0);
				AssignCommand(object7, ClearAllActions());
				AssignCommand(object7, PlayAnimation(10279, 1.0, 0.0));
				SoundObjectPlay(GetObjectByTag("BossRoar", 0));
			}
			break;
		case 4:
			{
				object object10 = GetObjectByTag("StormBeastGBoss", 0);
				AssignCommand(object10, ActionDoCommand(ChangeToStandardFaction(object10, 1)));
				AssignCommand(object10, ActionMoveToObject(GetFirstPC(), 1, 1.0));
				AssignCommand(object10, ActionAttack(GetFirstPC(), 0));
				AssignCommand(object10, ActionDoCommand(sub1(OBJECT_INVALID)));
			}
	}
}
