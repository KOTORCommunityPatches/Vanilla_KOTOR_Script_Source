...
void sub13(int intParam1) {
	SetLocalNumber(OBJECT_SELF, intGLOB_12, intParam1);
}

void sub12(int intParam1) {
	SetLocalNumber(OBJECT_SELF, intGLOB_13, intParam1);
}

string sub11(int intParam1, int intParam2) {
	string string1 = sub5(intParam1, intParam2);
	return string1;
}
...
string sub4(int intParam1, int intParam2) {
	string string1 = sub5((intParam1 + 5), intParam2);
	return string1;
}
		...
		while ((int2 <= intParam2)) {
			{
				...
				if ((int3 > 100)) {
				string1 = sub4(int6, intParam3);
					SetGlobalNumber("000_RareItemChance", 0);
				}
				else {
					IncrementGlobalNumber("000_RareItemChance", 3);
				if (sub7(int3, 0, 85)) {
					string1 = sub8(int6, intParam3);
				}
				else {
					if (sub7(int3, 86, 100)) {
						string1 = sub11(int6, intParam3);
					}
				}
				}
...
void sub2(object objectParam1, int intParam2, int intParam3) {
	sub3(objectParam1, intParam2, 500);
}
...
void main() {
	...
	SetNPCAIStyle(OBJECT_SELF, 6);
	sub12(25);
	sub13(60);
	sub14(intGLOB_84);
	sub15();
	sub18();
	effect efSpeedInc = EffectMovementSpeedIncrease(600);
