...
void main() {
	...
	switch (nParam1) {
		case 0:
			DelayCommand(1.0, SetLightsaberPowered(oAtris, 1, 1, 1));
			DelayCommand(1.0, sub1(oAtris));
			break;
		case 1:
			{
				...
				DelayCommand(2.0, SetLightsaberPowered(GetObjectByTag("Atris", 0), 1, 0, 1));
		...
		case 2:
			...
			break;
		case 3:
			AssignCommand(GetObjectByTag("Atris", 0), ActionJumpToLocation(GetLocation(GetWaypointByTag("sp_traya"))));
			AssignCommand(GetFirstPC(), ActionJumpToLocation(GetLocation(GetWaypointByTag("WP_PC_Traya_Death"))));
			DelayCommand(1.0, AssignCommand(GetObjectByTag("Atris", 0), ActionPlayAnimation(30, 1.0, (-1.0))));
			break;
		case 4:
			SetGlobalFadeIn(0.5, 2.0, 0.0, 0.0, 0.0);
			DelayCommand(2.0, SetLightsaberPowered(GetFirstPC(), 1, 0, 1));
			AurPostString("Getting UP? Are wE?", 5, 5, 5.0);
			break;
		case 5:
			{
				object object14 = GetObjectByTag("MedChamber", 0);
				AssignCommand(object14, ActionCloseDoor(object14));
				SetLocked(object14, 1);
				SetGlobalFadeOut(0.0, 3.0, 0.0, 0.0, 0.0);
				object oPC = GetFirstPC();
				object object18 = GetNextPC();
				object object20 = GetNextPC();
				AssignCommand(oPC, ClearAllActions());
				AssignCommand(object18, ClearAllActions());
				AssignCommand(object20, ClearAllActions());
				DelayCommand(4.0, AssignCommand(oPC, ActionJumpToObject(GetWaypointByTag("wp_pc_end"), 1)));
				DelayCommand(4.0, AssignCommand(object18, ActionJumpToObject(GetWaypointByTag("wp_npc1_end"), 1)));
				DelayCommand(4.0, AssignCommand(object20, ActionJumpToObject(GetWaypointByTag("wp_npc2_end"), 1)));
		...
		case 6:
			{
				...
				int3 = 0;
				while ((int3 < 10)) {
					ApplyEffectToObject(1, efBeam, GetObjectByTag("Holocron", int3), 4.0);
					(int3++);
				}
				ApplyEffectToObject(1, efVisual, GetFirstPC(), 4.0);
			}
			break;
		case 7:
			SetGlobalFadeOut(1.0, 2.0, 0.0, 0.0, 0.0);
			{
				object object28 = GetFirstPC();
				object object30 = GetNextPC();
				object object32 = GetNextPC();
				AssignCommand(object28, ClearAllActions());
				AssignCommand(object30, ClearAllActions());
				AssignCommand(object32, ClearAllActions());
				DelayCommand(3.0, AssignCommand(object28, ActionJumpToObject(GetWaypointByTag("wp_pc_end"), 1)));
				DelayCommand(3.0, AssignCommand(object30, ActionJumpToObject(GetWaypointByTag("wp_npc1_end"), 1)));
				DelayCommand(3.0, AssignCommand(object32, ActionJumpToObject(GetWaypointByTag("wp_npc2_end"), 1)));
				DelayCommand(3.0, AssignCommand(object28, SetFacing(90.0)));
				object object37 = GetObjectByTag("MedChamber", 0);
				DelayCommand(5.0, AssignCommand(object37, ActionCloseDoor(object37)));
				SetLocked(object37, 1);
			}
			break;
		case 8:
			SetGlobalFadeIn(0.1, 2.0, 0.0, 0.0, 0.0);
			DelayCommand(0.1, AssignCommand(GetObjectByTag("Atris", 0), ActionStartConversation(GetObjectByTag("Kreia", 0), "Atrend4", 0, 0, 0, "", "", "", "", "", "", 0, 0xFFFFFFFF, 0xFFFFFFFF, 0)));
			break;
		case 9:
			SetGlobalFadeOut(0.1, 2.0, 0.0, 0.0, 0.0);
			DelayCommand(4.0, SetGlobalFadeIn(0.1, 0.1, 0.0, 0.0, 0.0));
			break;
		case 10:
			SetGlobalNumber("000_Jedi_Found", 4);
			DestroyObject(GetObjectByTag("Atris", 0), 0.0, 0, 0.0, 0);
