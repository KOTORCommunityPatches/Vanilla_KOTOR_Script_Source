...
// Prototypes
void sub22();
int sub21(int intParam1, int intParam2);
int sub20(object objectParam1, int intParam2);
void sub19();
string sub18(int intParam1, int intParam2);
string sub17(int intParam1);
string sub16(string stringParam1);
string sub15(int intParam1, int intParam2);
string sub14(int intParam1, int intParam2);
int sub13(int intParam1, int intParam2, int intParam3);
string sub12(int intParam1);
string sub11(string stringParam1);
string sub10(string stringParam1);
string sub9(int intParam1, int intParam2);
		...
		if (((nLocal < 10) && (nLocal > 0))) {
			...
			if ((nLocal == 0)) {
				if (sub6(intGLOB_58)) {
					...
					if (sub6(intGLOB_54)) {
						int int11 = sub20(OBJECT_SELF, int6);
						if (((int11 > 0) && (int11 < 10))) {
...
string sub18(int intParam1, int intParam2) {
	string string1 = sub9(intParam1, intParam2);
	return string1;
}
...
string sub14(int intParam1, int intParam2) {
	...
	if ((intParam2 == 0)) {
		int2 = (Random(0) + 9);
		string1 = sub14(intParam1, (int2 * 100));
	}
	else {
		if (((intParam2 % 100) == 0)) {
			...
			int2 = (Random(int1) + 1);
			string1 = sub14(intParam1, (intParam2 + (10 * int2)));
		}
		else {
			if (((intParam2 % 10) == 0)) {
				switch ((intParam2 / 10)) {
				...
				int2 = (Random(int1) + 1);
				string1 = sub15(intParam1, (intParam2 + int2));
			}
			else {
				string1 = sub15(intParam1, intParam2);
			}
		}
	}
	return string1;
...
string sub9(int intParam1, int intParam2) {
	...
	if ((intParam2 == 0)) {
		...
		string3 = sub9(intParam1, (int2 * 100));
	}
	else {
		if (((intParam2 % 100) == 0)) {
			switch ((intParam2 / 100)) {
			...
			int2 = (Random(int1) + 1);
			string3 = sub9(intParam1, (intParam2 + (10 * int2)));
		}
		else {
			if (((intParam2 % 10) == 0)) {
				switch ((intParam2 / 10)) {
				...
				int2 = (Random(int1) + 1);
				string3 = sub9(intParam1, (intParam2 + int2));
			}
			else {
				switch (intParam2) {
					case 141:
				...
				string3 = (sub12(intParam2) + string1);
			}
		}
	}
	return string3;
...
void sub7(object objectParam1, int intParam2, int intParam3) {
	...
	while ((int1 <= intParam2)) {
		int2 = (Random(95) + GetGlobalNumber("000_RareItemChance"));
		{
			...
			if ((int2 > 100)) {
			string1 = sub8(int5, intParam3);
				SetGlobalNumber("000_RareItemChance", 0);
			}
			else {
				IncrementGlobalNumber("000_RareItemChance", 3);
			if (sub13(int2, 0, 85)) {
				string1 = sub14(int5, intParam3);
			}
			else {
				if (sub13(int2, 86, 100)) {
					string1 = sub18(int5, intParam3);
				}
			}
			}
...
void sub4() {
	...
	sub5();
	if ((sub6(intGLOB_122) || GetIsEncounterCreature(OBJECT_SELF))) {
		string string1;
		int int5 = 1;
		object object1;
		object object2;
...
void main() {
	...
	SetLocalBoolean(OBJECT_SELF, 100, 1);
	SetLocalBoolean(OBJECT_SELF, 102, 1);
	SetLocalBoolean(OBJECT_SELF, 27, 1);
	SetLocalNumber(OBJECT_SELF, 2, 2);
	sub7(OBJECT_SELF, (Random(3) + 1), 0);
	sub19();
}
