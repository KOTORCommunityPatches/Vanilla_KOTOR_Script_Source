...
void SelectAndRunDLG() {
    ...
    // If Handmaiden is on Telos and they have escaped - end sequence.
    else if ( ( GetModuleName() == "262TEL" ) && ( GetGlobalNumber ("262TEL_Escape_Telos") == 1 ) ) {
        BeginConversation( "Handend" );
        return;
    }
