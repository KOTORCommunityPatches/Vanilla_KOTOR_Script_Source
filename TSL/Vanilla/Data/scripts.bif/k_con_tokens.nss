...
/*
    ...
    8.  Explode conduit in room (cost: 5 spikes).
    9.  Reveal a map (cost: 5 spikes).
...
*/
//:: Created By: Many Bioware Folks (edited by Ferret Baudoin 1/7)
...
int StartingConditional()
{
    ...
    int nToken32 = 5; //Fill security room with gas (32)
                      // OR reveal map (36) OR explode a conduit (37)
