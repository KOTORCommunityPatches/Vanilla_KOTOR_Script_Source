...
void main()
{
    ...
    //****** TREASURE PLACEMENT
    //PlaceTreasure(OBJECT_SELF, Random(4)-2);
    ...
    //RWT-OEI 07/16/04
    //Set the properties of the floating mine
    //AWD-OEI 07/19/04 Set damage of mine based on player's level
    int tPlayerLevel = GetGlobalNumber("G_PC_LEVEL");
    int tDamage = Random(tPlayerLevel * 4) + 1;
    GN_SetFloatingMineDamage( tDamage );
    GN_SetFloatingMineSeekRange( 7 );
}
