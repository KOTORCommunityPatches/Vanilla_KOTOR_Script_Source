						...
						if ((int1 == 1006)) {
							...
							if ((int1 == 1007)) {
								...
								if (GetIsObjectValid(object2)) {
									...
									effect efBeam = EffectBeam(2038, object2, 1, 0);
									effect efDamage;
									oNearest = GetNearestObject(1, object2, 1);
									int int5 = 1;
									int int6 = 20;
									float float2 = 0.3;
									...
									while ((GetIsObjectValid(oNearest) && (GetDistanceBetween(oNearest, object2) <= float1))) {
										if (((int3 == 1) || GetIsEnemy(oNearest, GetFirstPC()))) {
										...
										(int5++);
										oNearest = GetNearestObject(1, object2, int5);
									}
