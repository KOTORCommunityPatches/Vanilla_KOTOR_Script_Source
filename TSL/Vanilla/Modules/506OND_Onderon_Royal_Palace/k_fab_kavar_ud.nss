						...
						if ((int1 == 1006)) {
							...
							if (((GetCurrentHitPoints(OBJECT_SELF) < (GetMaxHitPoints(OBJECT_SELF) / 2)) && (!GetLocalBoolean(OBJECT_SELF, 41)))) {
								...
								if (((GetCurrentHitPoints(OBJECT_SELF) == 1) && GetLocalBoolean(OBJECT_SELF, 41))) {
									object object6 = GetObjectByTag("InvisoKreia", 0);
									if ((!GetIsObjectValid(object6))) {
										AurPostString("Could not find InvisoKreia.", 10, 10, 2.0);
									}
									else {
										SetLocalNumber(object6, 15, 1);
										SetLocalNumber(object6, 12, 1);
										sub1(intGLOB_114, 1);
										CancelCombat(OBJECT_SELF);
										CancelCombat(GetFirstPC());
										ClearAllEffects();
										...
										NoClicksFor(1.2);
										AssignCommand(object6, ActionStartConversation(GetFirstPC(), "lrn_form", 0, 0, 1, "", "", "", "", "", "", 0, 0xFFFFFFFF, 0xFFFFFFFF, 0));
									}
								}
							}
						}
