...
void main() {
	...
	if ((int1 == 1001)) {
		if ((GetLocalBoolean(GetObjectByTag("power_gen_backup", 0), 20) && (!GetLocalBoolean(OBJECT_SELF, 20)))) {
			SetLocalBoolean(OBJECT_SELF, 20, 1);
			ChangeToStandardFaction(OBJECT_SELF, 5);
			PlayAnimation(10270, 1.0, (-1.0));
		}
		if (((GetLocalBoolean(GetObjectByTag("sec_terminal", 0), 20) && (!GetLocalBoolean(OBJECT_SELF, 21))) && (!GetLocalBoolean(OBJECT_SELF, 20)))) {
