...
void main() {
	...
	ApplyEffectToObject(2, efVisual, OBJECT_SELF, 2.0);
	EnableRendering(OBJECT_SELF, 1);
	DelayCommand(2.0, RemoveEffectByID(OBJECT_SELF, 8000));
	effect effect3 = EffectVisualEffect(8001, 0);
	DelayCommand(2.0, ApplyEffectToObject(1, effect3, OBJECT_SELF, 5.0));
	sub2(intGLOB_84);
	sub3();
	DelayCommand(1.0, SoundObjectPlay(GetObjectByTag("SenSounds", 0)));
