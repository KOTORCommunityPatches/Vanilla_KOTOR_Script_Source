...
// Prototypes
void sub105(string stringParam1, int intParam2, int intParam3, float floatParam4);
void sub104();
int sub103(int intParam1, int intParam2);
int sub102(object objectParam1, int intParam2);
void sub101();
void sub100();
int sub99();
int sub98();
int sub97(object objectParam1);
int sub96(object objectParam1);
int sub95(float floatParam1);
int sub94(object objectParam1);
int sub93();
int sub92(object objectParam1);
int sub91(object objectParam1);
object sub90(object objectParam1);
int sub89();
int sub88();
int sub87(object objectParam1);
int sub86(float floatParam1);
int sub85(object objectParam1);
int sub84(object objectParam1);
void sub83(object objectParam1);
int sub82(object objectParam1);
talent sub81(object objectParam1, talent talentParam2);
int sub80(int intParam1);
int sub79(int intParam1);
int sub78(int intParam1);
string sub77(int intParam1);
int sub76();
int sub75();
int sub74();
int sub73();
...
void sub5(object objectParam1, float floatParam2);
			...
			if ((nRandom == 3)) {
				...
				if ((((nRandom == 4) || (nRandom == 5)) && (GetRacialType(OBJECT_SELF) != 5))) {
					if ((GetGender(OBJECT_SELF) == 0)) {
						...
						ActionDoCommand(sub4(intGLOB_52, 1));
					}
					else {
...
void sub101() {
	if ((!sub11(intGLOB_61))) {
		...
		if (((nLocal < 10) && (nLocal > 0))) {
			...
			if ((nLocal == 0)) {
				if (sub11(intGLOB_58)) {
					...
					if (sub11(intGLOB_54)) {
						int int11 = sub102(OBJECT_SELF, int6);
						if (((int11 > 0) && (int11 < 10))) {
		...
		if (GetIsObjectValid(GetWaypointByTag(string11))) {
			...
			ActionForceMoveToObject(object3, sub11(intGLOB_59), fPersonalSpace, float4);
			if (sub11(intGLOB_52)) {
				ActionDoCommand(sub104());
			}
...
int sub99() {
	...
	if (GetIsObjectValid(oNearest)) {
		...
		DelayCommand(0.2, ActionDoCommand(sub100()));
		return 1;
	}
	else {
...
int sub98() {
	...
	if ((sub11(intGLOB_112) && (!sub11(intGLOB_113)))) {
		if (sub99()) {
			return 1;
		}
	}
	else {
		if (sub11(intGLOB_113)) {
			sub7("GENERIC DEBUG *************** Clear 1000");
			ClearAllActions();
			return 1;
		}
	}
	if (((!IsObjectPartyMember(OBJECT_SELF)) && (sub11(intGLOB_61) == 1))) {
		sub7("GENERIC DEBUG *************** Clear 1100");
		ClearAllActions();
		DelayCommand(1.0, sub101());
		return 1;
	}
	else {
			...
			if ((!GetSoloMode())) {
				if ((((GetObjectType(oTarget) == 8) && (!GetIsOpen(oTarget))) && (!GetSoloMode()))) {
					...
					if ((((GetObjectType(oTarget) == 64) && (GetCurrentHitPoints(oTarget) > 0)) && (!GetSoloMode()))) {
						...
						sub105("NO TARGET: FOLLOW LEADER", 10, 10, 4.0);
	...
	if ((d100(1) < 20)) {
		if ((GetIsTalentValid(talRandom) && GetCreatureHasTalent(talRandom, OBJECT_SELF))) {
			if ((GetIsObjectValid(objectParam1) && GetIsEnemy(objectParam1, OBJECT_SELF))) {
				sub7("GENERIC DEBUG *************** Using Talent on Intruder Target");
				...
				object oNearest = GetNearestCreature(3, 1, OBJECT_SELF, 1, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF);
				if (GetIsObjectValid(oNearest)) {
					sub7("GENERIC DEBUG *************** Using Talent on Determined Target");
...
int sub93() {
	...
	if ((nLocal > 0)) {
		...
		if (GetIsObjectValid(object5)) {
			int11 = sub80(GetBaseItemType(object5));
		}
		if ((int11 != 2)) {
			object object7 = GetItemInSlot(18, OBJECT_SELF);
			int int15 = 0;
			if (GetIsObjectValid(object7)) {
				int15 = sub80(GetBaseItemType(object7));
			}
			if ((int15 == 2)) {
				ClearAllActions();
				ActionSwitchWeapons();
...
int sub87(object objectParam1) {
	...
	if ((sub88() != (-1))) {
		...
		if (int8) {
			...
			if (sub18(intGLOB_128, GetFirstPC())) {
				return 1;
			}
		}
	}
	if (GetIsObjectValid(object1)) {
		if (sub18(intGLOB_125, object1)) {
			return 1;
		}
	}
	object object9 = sub17();
	if (GetIsObjectValid(object9)) {
		if (sub18(intGLOB_126, object9)) {
			return 1;
		}
	}
	if (sub18(intGLOB_127, OBJECT_SELF)) {
		return 1;
	}
	object3 = sub32();
...
int sub85(object objectParam1) {
	...
	sub7("GENERIC DEBUG *************** Grenade AI Fall Through");
	return sub36(objectParam1);
}
	...
	if ((GetIsObjectValid(oTarget) && (!GetIsDead(oTarget)))) {
		...
		if ((fDistance < 3.5)) {
			...
			if (GetIsInCombat(OBJECT_SELF, 0)) {
				DelayCommand(3.0, sub6(objectParam1));
			}
		}
		else {
			int nAction = GetCurrentAction(OBJECT_SELF);
				...
				if ((intParam1 == intGLOB_23)) {
					...
					if ((intParam1 == intGLOB_24)) {
						...
						if ((intParam1 == intGLOB_25)) {
							...
							if ((intParam1 == intGLOB_26)) {
								talRandom = GetCreatureTalentRandom(63743, OBJECT_SELF, 0);
								if ((GetIsTalentValid(talRandom) && sub60())) {
									return 1;
								}
							}
							else {
								if ((intParam1 == intGLOB_27)) {
									talRandom = GetCreatureTalentRandom(63743, OBJECT_SELF, 0);
									talent2 = GetCreatureTalentRandom(62207, OBJECT_SELF, 0);
									if (((GetIsTalentValid(talRandom) && GetIsTalentValid(talent2)) && sub60())) {
										return 1;
									}
								}
								else {
									if ((intParam1 == intGLOB_28)) {
										...
										if ((intParam1 == intGLOB_29)) {
											...
											if ((intParam1 == intGLOB_30)) {
												talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
												if (((sub64() && sub65()) && GetIsTalentValid(talRandom))) {
													return 1;
												}
											}
											else {
												if ((intParam1 == intGLOB_31)) {
													...
													if ((intParam1 == intGLOB_32)) {
														...
														if ((intParam1 == intGLOB_33)) {
															talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
															if (((sub62() && sub68()) && GetIsTalentValid(talRandom))) {
																return 1;
															}
														}
														else {
															if ((intParam1 == intGLOB_34)) {
																if (((sub68() && sub61()) && sub69())) {
																	return 1;
																}
															}
															else {
																if ((intParam1 == intGLOB_35)) {
																	if (((sub66() && sub61()) && sub63())) {
																		return 1;
																	}
																}
																else {
																	if ((intParam1 == intGLOB_36)) {
																		if (((sub67() && sub61()) && sub63())) {
																			return 1;
																		}
																	}
																	else {
																		if ((intParam1 == intGLOB_36)) {
																			if (((sub62() && sub70()) && sub61())) {
																				return 1;
																			}
																		}
																		else {
																			if ((intParam1 == intGLOB_38)) {
																				talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
																				if ((sub70() && GetIsTalentValid(talRandom))) {
																					return 1;
																				}
																			}
																			else {
																				if ((intParam1 == intGLOB_39)) {
																					if (((sub70() && sub61()) && sub69())) {
																						return 1;
																					}
																				}
																				else {
																					if ((intParam1 == intGLOB_40)) {
																						talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
																						if (((sub61() && GetIsTalentValid(talRandom)) && GetHasSpell(177, OBJECT_SELF))) {
																							return 1;
																						}
																					}
																					else {
																						if ((intParam1 == intGLOB_41)) {
																							talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
																							if (((sub61() && sub68()) && GetIsTalentValid(talRandom))) {
																								return 1;
																							}
																						}
																						else {
																							if ((intParam1 == intGLOB_42)) {
																								...
																								if ((intParam1 == intGLOB_43)) {
																									...
																									if ((intParam1 == intGLOB_44)) {
																										talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
																										if ((sub75() && GetIsTalentValid(talRandom))) {
																											return 1;
																										}
																									}
																									else {
...
talent sub38(int intParam1) {
	...
	object oRWeapItem = GetItemInSlot(4, OBJECT_SELF);
	if (((((GetLevelByClass(6, OBJECT_SELF) > 0) || (GetLevelByClass(7, OBJECT_SELF) > 0)) && (!sub39(OBJECT_SELF))) && (!GetIsObjectValid(oRWeapItem)))) {
		object oLArmItem = GetItemInSlot(7, OBJECT_SELF);
		object oRArmItem = GetItemInSlot(8, OBJECT_SELF);
		int int9 = 1;
	...
	if (((structGLOB_1.int13 == 4) || (structGLOB_1.int13 == 0))) {
		...
		if ((nRandom > 0)) {
			if ((((((((((GetLevelByClass(4, OBJECT_SELF) > 0) || (GetLevelByClass(3, OBJECT_SELF) > 0)) || (GetLevelByClass(5, OBJECT_SELF) > 0)) || (GetLevelByClass(11, OBJECT_SELF) > 0)) || (GetLevelByClass(12, OBJECT_SELF) > 0)) || (GetLevelByClass(13, OBJECT_SELF) > 0)) || (GetLevelByClass(14, OBJECT_SELF) > 0)) || (GetLevelByClass(15, OBJECT_SELF) > 0)) || (GetLevelByClass(16, OBJECT_SELF) > 0))) {
				int2 = sub58(intParam1);
				sub7(("GENERIC DEBUG *************** Starting Jedi Combo " + sub77(int2)));
				...
				if (((GetLevelByClass(6, OBJECT_SELF) > 0) || (GetLevelByClass(7, OBJECT_SELF) > 0))) {
					int2 = sub78(intParam1);
					sub7(("GENERIC DEBUG *************** Starting Droid Combo " + sub77(int2)));
					SetLocalNumber(OBJECT_SELF, intGLOB_8, 1);
					SetLocalNumber(OBJECT_SELF, intGLOB_7, int2);
					return sub40(int2);
				}
				else {
					int2 = sub79(intParam1);
					sub7(("GENERIC DEBUG *************** Starting NPC Combo " + sub77(int2)));
					SetLocalNumber(OBJECT_SELF, intGLOB_8, 1);
					SetLocalNumber(OBJECT_SELF, intGLOB_7, int2);
					return sub40(int2);
				}
		...
		sub7(("GENERIC DEBUG *************** Continuing Combo " + sub77(structGLOB_1.int15)));
		return sub40(structGLOB_1.int15);
	}
	return talent1;
}
...
int sub36(object objectParam1) {
	...
	oNPC = sub37();
	if (GetIsObjectValid(oNPC)) {
		if (sub18(intGLOB_125, oNPC)) {
			return 1;
		}
	}
	oNPC = sub17();
	if (GetIsObjectValid(oNPC)) {
		if (sub18(intGLOB_126, oNPC)) {
			return 1;
		}
	}
	talent1 = sub38(0);
	...
	if ((nLocalBool == 1)) {
		...
		if ((GetNPCAIStyle(OBJECT_SELF) == 10)) {
			...
			object oRWeapItem = GetItemInSlot(4, OBJECT_SELF);
			if (GetIsObjectValid(oRWeapItem)) {
				int11 = sub80(GetBaseItemType(oRWeapItem));
			}
			if ((int11 == 2)) {
...
int sub18(int intParam1, object objectParam2) {
	if (GetIsObjectValid(objectParam2)) {
			...
			if ((intParam1 == intGLOB_125)) {
				...
				if ((intParam1 == intGLOB_126)) {
					...
					if (((GetCreatureHasTalent(talSpell, OBJECT_SELF) || GetCreatureHasTalent(talent2, OBJECT_SELF)) || GetCreatureHasTalent(talent3, OBJECT_SELF))) {
						sub7("GENERIC DEBUG *************** I have Heal, Improved Heal, or Master Heal");
						int3 = 1;
		...
		if (((int3 == 1) && (int4 == 0))) {
			...
			sub7(("GENERIC DEBUG *************** Spells.2DA ID = " + sub13(int56)));
			ClearAllActions();
...
int sub14() {
	int int1 = 0;
	if (((sub11(intGLOB_119) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		if (((GetHitDice(GetFirstPC()) >= 15) || sub11(intGLOB_116))) {
...
int sub12() {
	...
	sub7(((("GENERIC DEBUG *************** Shield Boolean (" + sub13(intGLOB_117)) + ") = ") + sub13(sub11(intGLOB_117))));
	if (((sub11(intGLOB_117) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		int int4;
		int int5;
		int int6 = 0;
		talent talSpell;
		...
		if (int6) {
			...
			sub7("GENERIC DEBUG *************** Forcefield Search Fallthrough");
			sub4(intGLOB_117, 1);
			return 0;
		}
	}
...
void sub6(object objectParam1) {
	...
	sub9();
	{
		...
		if (((((!sub11(intGLOB_112)) && (!sub11(intGLOB_113))) && (!sub11(intGLOB_114))) && (!GetUserActionsPending()))) {
		if (((GetPartyMemberByIndex(0) != OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF)))) {
			if (((IsObjectPartyMember(OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF))) || (!IsObjectPartyMember(OBJECT_SELF)))) {
				...
				if ((sub12() == 1)) {
					sub7("GENERIC DEBUG *************** Terminating AI from Shields");
					return;
				}
				if ((sub14() == 1)) {
					return;
				}
				if ((sub11(intGLOB_121) == 1)) {
					if ((sub15() == 1)) {
						return;
					}
				}
				if ((sub11(intGLOB_116) == 1)) {
...
object sub2(int intParam1) {
	...
	switch (nGlobal) {
		case 0:
			...
			if ((intParam1 != 0)) {
				ApplyEffectToObject(1, EffectModifyAttacks(1), oNpc_bralor, 60.0);
			}
			break;
		case 1:
		...
		case 4:
			...
			if ((intParam1 != 0)) {
				ApplyEffectToObject(1, EffectModifyAttacks(2), oNpc_bralor, 60.0);
			}
			break;
	}
	return oNpc_bralor;
...
void sub1() {
	object oCircleMandalorian;
	object object2;
	oCircleMandalorian = GetObjectByTag("CircleMandalorian", 0);
	object2 = GetObjectByTag("CircleMandalorian", 1);
	AssignCommand(oCircleMandalorian, ClearAllActions());
	AssignCommand(object2, ClearAllActions());
	AssignCommand(oCircleMandalorian, SurrenderToEnemies());
	AssignCommand(object2, SurrenderToEnemies());
	ChangeToStandardFaction(oCircleMandalorian, 5);
	ChangeToStandardFaction(object2, 5);
	AssignCommand(oCircleMandalorian, ActionJumpToObject(GetObjectByTag("wp_circle_fighter1a", 0), 1));
	AssignCommand(object2, ActionJumpToObject(GetObjectByTag("wp_circle_fighter2a", 0), 1));
	SetLocalBoolean(oCircleMandalorian, 55, 1);
}
...
void main() {
	...
	switch (nParam1) {
		case 0:
			...
			object3 = sub2(0);
			SetGlobalLocation("403DXN_Duel_Start", GetLocation(object3));
			SetGlobalNumber("403DXN_Battle_CNPCs", GetPartyMemberCount());
			int5 = 0;
			{
				...
				while ((int6 <= 12)) {
					if (IsNPCPartyMember(int6)) {
						...
						AssignCommand(object4, sub3());
						ChangeToStandardFaction(object4, 5);
						AssignCommand(object4, ClearAllActions());
						AssignCommand(object4, ActionJumpToObject(GetWaypointByTag(("wp_circle_cnpc" + IntToString((int5 + 1)))), 1));
				...
				SetLocalBoolean(object3, 45, 0);
				AssignCommand(object6, ActionJumpToObject(GetObjectByTag("wp_circle_pc", 0), 1));
				AssignCommand(object3, sub5(GetObjectByTag("wp_circle_enemy", 0), 0.0));
				SetMinOneHP(object6, 1);
				ApplyEffectToObject(0, EffectHeal((GetMaxHitPoints(GetFirstPC()) - GetCurrentHitPoints(GetFirstPC()))), GetFirstPC(), 0.0);
				ApplyEffectToObject(0, EffectHeal((GetMaxHitPoints(object3) - GetCurrentHitPoints(object3))), object3, 0.0);
			}
			break;
		case 1:
			object3 = sub2(1);
			DelayCommand(0.5, AssignCommand(object3, ActionAttack(oPC, 0)));
			DelayCommand(0.5, ChangeToStandardFaction(object3, 1));
			DelayCommand(0.6, sub6(OBJECT_INVALID));
			SetLocalBoolean(GetObjectByTag("npc_mandy_sarge", 0), 51, 0);
			break;
	}
}
