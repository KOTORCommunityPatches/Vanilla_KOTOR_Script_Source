...
// Prototypes
void sub103(string stringParam1);
					...
					if ((int1 == 1005)) {
						...
						if ((int1 == 1006)) {
							...
							if ((int1 == 1007)) {
								...
								object oShapeObject = GetFirstObjectInShape(4, 4.0, location1, 0, 1, [0.0,0.0,0.0]);
								while ((GetIsObjectValid(oShapeObject) && (int4 > 0))) {
									{
										int int8 = GetStandardFaction(oShapeObject);
										if (((oShapeObject != OBJECT_SELF) && (int8 != 5))) {
										int6 = int5;
										int6 = (int6 - sub102(oShapeObject));
										if ((!ReflexSave(oShapeObject, int6, 0, OBJECT_SELF))) {
											ApplyEffectToObject(0, EffectDamage(int4, 2, 0), oShapeObject, 0.0);
										}
										else {
											int int12;
											...
											ApplyEffectToObject(0, EffectDamage(int12, 2, 0), oShapeObject, 0.0);
										}
										}
