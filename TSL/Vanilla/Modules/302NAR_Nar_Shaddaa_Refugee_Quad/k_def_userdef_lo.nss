					...
					if ((int1 == 1005)) {
						...
						if ((int1 == 1006)) {
							...
							if ((int1 == 1007)) {
								...
								if (((GetGlobalNumber("000_Psychotic") == 0) && (GetIsObjectValid(oKreia) || ((GetPartyMemberCount() > 0) && (GetSoloMode() == 0))))) {
									SetGlobalNumber("000_Psychotic", 1);
									...
									AssignCommand(oNPC, ActionStartConversation(GetFirstPC(), "", 0, 0, 1, "", "", "", "", "", "", 0, 0xFFFFFFFF, 0xFFFFFFFF, 0));
								}
							}
							else {
								if ((int1 == 1008)) {
