...
void main() {
	...
	switch (nParam1) {
		case 0:
			ChangeToStandardFaction(GetObjectByTag("g_riiken", 0), 1);
			break;
		case 1:
			ClearAllActions();
			DelayCommand(0.3, sub1(1, 0, OBJECT_SELF));
			SetGlobalNumber("512OND_Riiken_Patrol", 2);
			break;
		case 2:
			ClearAllActions();
			DelayCommand(0.4, sub1(1, 2, OBJECT_SELF));
			SetGlobalNumber("512OND_Riiken_Patrol", 3);
			break;
		case 3:
			ClearAllActions();
			DelayCommand(0.3, sub1(0, 0, OBJECT_SELF));
			SetGlobalNumber("512OND_Riiken_Patrol", 2);
			break;
	}
}
