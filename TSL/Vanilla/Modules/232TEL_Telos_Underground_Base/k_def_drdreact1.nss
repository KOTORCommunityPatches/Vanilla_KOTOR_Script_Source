...
string sub12(int intParam1, int intParam2) {
	string string1 = sub6(intParam1, intParam2);
	return string1;
}
...
string sub6(int intParam1, int intParam2) {
	...
	if ((intParam2 == 0)) {
		...
		string3 = sub6(intParam1, (int2 * 100));
	}
	else {
		if (((intParam2 % 100) == 0)) {
			switch ((intParam2 / 100)) {
			...
			int2 = (Random(int1) + 1);
			string3 = sub6(intParam1, (intParam2 + (10 * int2)));
		}
		else {
			if (((intParam2 % 10) == 0)) {
				switch ((intParam2 / 10)) {
				...
				int2 = (Random(int1) + 1);
				string3 = sub6(intParam1, (intParam2 + int2));
			}
			else {
				switch (intParam2) {
					case 141:
...
string sub5(int intParam1, int intParam2) {
	string string1 = sub6((intParam1 + 5), intParam2);
	return string1;
}
...
void sub3(object objectParam1, int intParam2, int intParam3) {
	sub4(objectParam1, intParam2, 500);
}
