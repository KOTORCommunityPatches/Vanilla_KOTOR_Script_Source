void main() {
	...
	DelayCommand(0.5, AssignCommand(oSister1, ActionJumpToObject(oWP_Hand_Atris_1_1, 1)));
	DelayCommand(0.5, AssignCommand(oSister2, ActionJumpToObject(oWP_Hand_Atris_2_1, 1)));
	DelayCommand(0.5, AssignCommand(oHandmaiden, ActionJumpToObject(oWP_Hand_Atris_2_1, 1)));
	DelayCommand(1.5, AssignCommand(oSister1, ActionMoveToLocation(location5, 0)));
	DelayCommand(1.5, AssignCommand(oSister2, ActionMoveToLocation(location7, 0)));
	DelayCommand(1.5, AssignCommand(oHandmaiden, ActionMoveToLocation(location3, 0)));
}
