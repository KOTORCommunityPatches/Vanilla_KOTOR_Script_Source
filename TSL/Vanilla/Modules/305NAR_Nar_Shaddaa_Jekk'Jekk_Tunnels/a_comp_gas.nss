...
void main() {
	float float1 = 1.5;
	int int1;
	DelayCommand(float1, sub1("comp_gas_0", 5.0, 1));
	DelayCommand(float1, sub1("comp_gas_1", 5.0, 1));
	DelayCommand(float1, sub1("comp_gas_2", 5.0, 1));
	DelayCommand(float1, sub1("comp_gas_3", 5.0, 1));
	DelayCommand(float1, sub1("comp_gas_4", 5.0, 1));
