...
void main() {
	if ((GetLocalBoolean(OBJECT_SELF, 58) == 0)) {
		...
		int int4 = 1;
		string string1;
		CreateItemOnObject(sub1((Random(15) + 1), 100), GetObjectByTag("OondarStore", 0), int4, 0);
		CreateItemOnObject(sub1((Random(22) + 1), 100), GetObjectByTag("OondarStore", 0), int4, 0);
		CreateItemOnObject(sub1((Random(22) + 1), 100), GetObjectByTag("OondarStore", 0), int4, 0);
		CreateItemOnObject(sub1((Random(15) + 1), 200), GetObjectByTag("OondarStore", 0), int4, 0);
		CreateItemOnObject(sub1((Random(15) + 1), 300), GetObjectByTag("OondarStore", 0), int4, 0);
		CreateItemOnObject(sub1((Random(15) + 1), 400), GetObjectByTag("OondarStore", 0), int4, 0);
		int2;
		while ((int2 < 25)) {
			{
				string string8 = sub1(int2, 0);
				if ((int2 < 10)) {
				int4 = (Random(2) + 1);
				}
				else {
				...
				if ((int3 = FindSubString(string8, "[") >= 0)) {
				int4 = StringToInt(GetSubString(string8, (int3 + 1), 4));
				string1 = GetSubString(string8, 0, int3);
				}
				else {
				string1 = string8;
				}
				CreateItemOnObject(string1, GetObjectByTag("OondarStore", 0), int4, 0);
			}
			int2 = (int2 + 2);
		}
	}
