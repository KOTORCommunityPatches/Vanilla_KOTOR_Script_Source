		...
		case 3:
			{
				...
				AssignCommand(object25, ActionMoveToObject(GetObjectByTag("WP_ROBO1_LEAVE", 0), 0, 1.0));
				AssignCommand(object27, ActionMoveToObject(GetObjectByTag("WP_ROBO2_LEAVE", 0), 0, 1.0));
				AssignCommand(object29, ActionMoveToObject(GetObjectByTag("WP_ROBO3_LEAVE", 0), 0, 1.0));
			}
			break;
		case 4:
