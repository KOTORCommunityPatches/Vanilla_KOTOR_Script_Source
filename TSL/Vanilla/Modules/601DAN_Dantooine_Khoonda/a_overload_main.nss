...
void main() {
	...
	ActionWait(IntToFloat(nParam1));
	ActionDoCommand(sub1("comp_main", 8.0, 1));
	ActionWait(1.0);
	ActionDoCommand(sub1("cond1_1", 8.0, 1));
	ActionWait(0.5);
	ActionDoCommand(sub1("cond1_2", 8.0, 1));
	ActionWait(0.5);
	ActionDoCommand(sub1("cond2_1", 8.0, 1));
	ActionWait(0.5);
	ActionDoCommand(sub1("cond2_2", 8.0, 1));
	ActionWait(1.0);
	ActionDoCommand(sub1("cond3_1", 8.0, 1));
	ActionDoCommand(sub1("cond3_2", 8.0, 1));
	ActionWait(1.0);
	ActionDoCommand(sub1("cond4_1", 8.0, 1));
	ActionWait(0.5);
	ActionDoCommand(sub1("cond4_2", 8.0, 1));
	ActionWait(0.5);
	ActionDoCommand(sub1("cond5_1", 8.0, 1));
	ActionDoCommand(sub1("cond5_2", 8.0, 1));
	ActionWait(1.0);
	ActionDoCommand(sub1("cond6_1", 10.0, 1));
	ActionDoCommand(sub1("cond6_2", 10.0, 1));
	ActionWait(0.5);
	ActionDoCommand(sub1("cond7_2", 10.0, 1));
	ActionWait(0.5);
