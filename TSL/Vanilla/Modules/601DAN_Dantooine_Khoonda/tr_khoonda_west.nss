void main() {
	...
	if ((GetGlobalNumber("601DAN_Battle_Mili") != 1)) {
		...
		SetFadeUntilScript();
		object oWP_WEST_DOOR_1 = GetObjectByTag("WP_WEST_DOOR_1", 0);
		object oWP_WEST_DOOR_2 = GetObjectByTag("WP_WEST_DOOR_2", 0);
		object oWP_WEST_DOOR_3 = GetObjectByTag("WP_WEST_DOOR_3", 0);
		object oNPC = GetPartyMemberByIndex(0);
		object object11 = GetPartyMemberByIndex(1);
		object object13 = GetPartyMemberByIndex(2);
		if (GetIsObjectValid(oNPC)) {
			AssignCommand(oNPC, ClearAllActions());
			AssignCommand(oNPC, ActionJumpToLocation(GetLocation(oWP_WEST_DOOR_1)));
		}
		if (GetIsObjectValid(object11)) {
			AssignCommand(object11, ClearAllActions());
			AssignCommand(object11, ActionJumpToLocation(GetLocation(oWP_WEST_DOOR_2)));
		}
		if (GetIsObjectValid(object13)) {
			AssignCommand(object13, ClearAllActions());
			AssignCommand(object13, ActionJumpToLocation(GetLocation(oWP_WEST_DOOR_3)));
		}
