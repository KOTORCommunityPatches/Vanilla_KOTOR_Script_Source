...
void main() {
	if ((GetLocalBoolean(OBJECT_SELF, 58) == 0)) {
		...
		int int3;
		int int4 = 1;
		string string1 = sub1((Random(15) + 1), 110);
		CreateItemOnObject(string1, GetObjectByTag("store_adum", 0), int4, 0);
		string1 = sub1((Random(15) + 1), 120);
		CreateItemOnObject(string1, GetObjectByTag("store_adum", 0), int4, 0);
		string1 = sub1((Random(15) + 1), 130);
		CreateItemOnObject(string1, GetObjectByTag("store_adum", 0), int4, 0);
		string1 = sub1((Random(15) + 1), 200);
		CreateItemOnObject(string1, GetObjectByTag("store_adum", 0), int4, 0);
		string1 = sub1((Random(15) + 1), 200);
		CreateItemOnObject(string1, GetObjectByTag("store_adum", 0), int4, 0);
		string1 = sub1((Random(20) + 1), 310);
		CreateItemOnObject(string1, GetObjectByTag("store_adum", 0), int4, 0);
		string1 = sub1((Random(20) + 1), 320);
		CreateItemOnObject(string1, GetObjectByTag("store_adum", 0), int4, 0);
		string1 = sub1((Random(20) + 1), 330);
		CreateItemOnObject(string1, GetObjectByTag("store_adum", 0), int4, 0);
		string1 = sub1((Random(20) + 1), 300);
		CreateItemOnObject(string1, GetObjectByTag("store_adum", 0), int4, 0);
		string1 = sub1((Random(20) + 1), 300);
		CreateItemOnObject(string1, GetObjectByTag("store_adum", 0), int4, 0);
		string1 = sub1((Random(20) + 1), 300);
		...
		while ((int2 < 21)) {
			{
				...
				if ((int3 = FindSubString(string15, "[") >= 0)) {
				int4 = StringToInt(GetSubString(string15, (int3 + 1), 4));
				string1 = GetSubString(string15, 0, int3);
				}
				else {
				string1 = string15;
				}
