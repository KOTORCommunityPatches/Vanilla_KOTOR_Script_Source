				...
				if ((int1 == 1004)) {
					...
					if ((int1 == 1005)) {
						...
						if ((int1 == 1006)) {
							...
							if ((nCurHP < 10)) {
								if ((GetLocalNumber(OBJECT_SELF, 13) != 4)) {
									sub1(intGLOB_114, 1);
									...
									DelayCommand(1.0, ActionStartConversation(GetFirstPC(), "", 0, 0, 0, "", "", "", "", "", "", 0, 0xFFFFFFFF, 0xFFFFFFFF, 0));
									DelayCommand(1.0, SetLocalBoolean(OBJECT_SELF, 50, 0));
								}
							}
						}
						else {
