...
void main() {
	...
	AurPostString("overloading comp_cond", 5, 5, 5.0);
	ActionWait(1.0);
	ActionDoCommand(sub1("conductor1", 10.0, 1));
	ActionWait(0.5);
	ActionDoCommand(sub1("conductor2", 10.0, 1));
	ActionWait(0.5);
	ActionDoCommand(sub1("conductor3", 10.0, 1));
	object oDoor_conductor2 = GetObjectByTag("door_conductor2", 0);
	DelayCommand((IntToFloat(nParam1) + 2.0), AssignCommand(oDoor_conductor2, ActionUnlockObject(oDoor_conductor2)));
	DelayCommand((IntToFloat(nParam1) + 2.0), AssignCommand(oDoor_conductor2, ActionOpenDoor(oDoor_conductor2)));
	ActionDoCommand(sub1("comp_cond", 10.0, 1));
