...
void main() {
	...
	IncrementGlobalNumber("203TEL_Bounty_Hunters", 1);
	if ((GetGlobalNumber("203TEL_Bounty_Hunters") == 2)) {
		...
		AddJournalQuestEntry("exch_meeting", 30, 0);
		SetGlobalNumber("200TEL_CzerkaM_Exch", 7);
