...
int sub14(int intParam1, int intParam2, int intParam3);
string sub13(int intParam1);
string sub12(int intParam1, int intParam2);
string sub11(int intParam1, int intParam2);
void sub10(object objectParam1, int intParam2, int intParam3);
void sub9();
int sub8(int intParam1, int intParam2);
...
string sub18(int intParam1, int intParam2) {
	string string1 = sub12(intParam1, intParam2);
	return string1;
}
...
string sub15(int intParam1, int intParam2) {
	...
	if ((intParam2 == 0)) {
		int2 = (Random(0) + 9);
		string1 = sub15(intParam1, (int2 * 100));
	}
	else {
		if (((intParam2 % 100) == 0)) {
			...
			int2 = (Random(int1) + 1);
			string1 = sub15(intParam1, (intParam2 + (10 * int2)));
		}
		else {
			if (((intParam2 % 10) == 0)) {
				switch ((intParam2 / 10)) {
				...
				int2 = (Random(int1) + 1);
				string1 = sub16(intParam1, (intParam2 + int2));
			}
			else {
				string1 = sub16(intParam1, intParam2);
			}
		}
	}
	return string1;
...
string sub12(int intParam1, int intParam2) {
	...
	if ((intParam2 == 0)) {
		...
		string3 = sub12(intParam1, (int2 * 100));
	}
	else {
		if (((intParam2 % 100) == 0)) {
			switch ((intParam2 / 100)) {
			...
			int2 = (Random(int1) + 1);
			string3 = sub12(intParam1, (intParam2 + (10 * int2)));
		}
		else {
			if (((intParam2 % 10) == 0)) {
				switch ((intParam2 / 10)) {
				...
				int2 = (Random(int1) + 1);
				string3 = sub12(intParam1, (intParam2 + int2));
			}
			else {
				switch (intParam2) {
					case 141:
				...
				string3 = (sub13(intParam2) + string1);
			}
		}
	}
	return string3;
...
string sub11(int intParam1, int intParam2) {
	string string1 = sub12((intParam1 + 5), intParam2);
	return string1;
}
		...
		if (((nLocal < 10) && (nLocal > 0))) {
			...
			if ((nLocal == 0)) {
				if (sub5(intGLOB_58)) {
					...
					if (sub5(intGLOB_54)) {
						int int11 = sub7(OBJECT_SELF, int6);
						if (((int11 > 0) && (int11 < 10))) {
...
void main() {
	...
	SetLocalBoolean(OBJECT_SELF, 38, 1);
	...
	if ((!GetLocalBoolean(oTo_504, 42))) {
		if (GetLocalBoolean(oTo_504, 40)) {
			...
			sub10(OBJECT_SELF, (Random(4) - 2), 0);
		}
	}
	else {
