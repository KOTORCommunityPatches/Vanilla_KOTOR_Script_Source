...
void main() {
	if ((GetLocalBoolean(OBJECT_SELF, 58) == 0)) {
		...
		int int3;
		int int4 = 1;
		string string1 = sub1((Random(15) + 1), 100);
		CreateItemOnObject(string1, GetObjectByTag("m_202_001", 0), int4, 0);
		string1 = sub1((Random(15) + 1), 245);
		CreateItemOnObject(string1, GetObjectByTag("m_202_001", 0), int4, 0);
		string1 = sub1((Random(15) + 1), 100);
		CreateItemOnObject(string1, GetObjectByTag("m_202_001", 0), int4, 0);
		string1 = sub1((Random(15) + 1), 200);
		CreateItemOnObject(string1, GetObjectByTag("m_202_001", 0), int4, 0);
		string1 = sub1((Random(15) + 1), 200);
		CreateItemOnObject(string1, GetObjectByTag("m_202_001", 0), int4, 0);
		string1 = sub1((Random(15) + 1), 300);
		CreateItemOnObject(string1, GetObjectByTag("m_202_001", 0), int4, 0);
		string1 = sub1((Random(15) + 1), 300);
		CreateItemOnObject(string1, GetObjectByTag("m_202_001", 0), int4, 0);
		...
		while ((int2 < 25)) {
			{
				...
				if ((int3 = FindSubString(string11, "[") >= 0)) {
				int4 = StringToInt(GetSubString(string11, (int3 + 1), 4));
				string1 = GetSubString(string11, 0, int3);
				}
				else {
				string1 = string11;
				}
