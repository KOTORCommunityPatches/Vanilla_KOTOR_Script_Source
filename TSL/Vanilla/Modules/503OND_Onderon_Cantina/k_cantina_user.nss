...
void main() {
	...
	if ((int1 == 1001)) {
		if (((GetGlobalNumber("503OND_Tobin_Battle") == 1) && (!GetLocalBoolean(OBJECT_SELF, 20)))) {
			SetLocalBoolean(OBJECT_SELF, 20, 1);
			PlayAnimation(10074, 1.0, (-1.0));
		}
		else {
			if (((GetGlobalNumber("503OND_Tobin_Battle") == 2) && GetLocalBoolean(OBJECT_SELF, 20))) {
