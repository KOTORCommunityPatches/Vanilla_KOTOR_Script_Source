...
void main() {
	...
	switch (nParam1) {
		case 1:
			AurPostString("a_twinsfight: LOCKING THE CANTINADOOR", 6, 6, 7.0);
			{
				object oCantinaDoor = GetObjectByTag("CantinaDoor", 0);
				AssignCommand(oCantinaDoor, ActionCloseDoor(oCantinaDoor));
				SetLocked(oCantinaDoor, 1);
				...
				object object13 = GetItemPossessedBy(oTwinSun1, "w_melee_x02");
				object object15 = GetItemPossessedBy(oTwinSun1, "w_melee_01");
				object object17 = GetItemPossessedBy(oTwinSun2, "w_melee_x03");
				object object19 = GetItemPossessedBy(oTwinSun2, "w_melee_01");
				AssignCommand(oTwinSun1, ActionEquipItem(object13, 4, 1));
				AssignCommand(oTwinSun1, ActionEquipItem(object15, 5, 1));
				AssignCommand(oTwinSun2, ActionEquipItem(object17, 4, 1));
				AssignCommand(oTwinSun2, ActionEquipItem(object19, 5, 1));
			...
			break;
		case 2:
			ChangeToStandardFaction(oTwinSun1, 1);
			ChangeToStandardFaction(oTwinSun2, 1);
