...
void main() {
	...
	if ((oEntering == GetFirstPC())) {
		...
		if ((!GetGlobalBoolean("203_FIRST_ENTER"))) {
			...
			object object12 = GetObjectByTag("hidden_turret", 1);
			if ((GetIsObjectValid(oHidden_turret) && GetIsObjectValid(object12))) {
				DelayCommand(0.1, AssignCommand(oHidden_turret, ActionPlayAnimation(43, 1.0, (-1.0))));
				DelayCommand(0.1, AssignCommand(object12, ActionPlayAnimation(43, 1.0, (-1.0))));
			}
		}
	}
}
