...
void main() {
	...
	ChangeToStandardFaction(oMaalraas_Scene, 3);
	int int2;
	object oCannok_Scene;
	int2 = 0;
	while ((int2 <= 3)) {
		oCannok_Scene = GetObjectByTag("Cannok_Scene", int2);
		ChangeToStandardFaction(oCannok_Scene, 1);
		AssignCommand(oCannok_Scene, ActionAttack(oMaalraas_Scene, 0));
		sub1(oCannok_Scene);
		(int2++);
	}
}
