					...
					if ((int1 == 1005)) {
						...
						if ((int1 == 1006)) {
							...
							if ((int1 == 1007)) {
								sub1(GetFirstPC());
								int int3;
								object oG_kin_assassin;
								int3 = 0;
								while ((int3 <= 1)) {
									oG_kin_assassin = GetObjectByTag("g_kin_assassin", int3);
									if (GetIsObjectValid(oG_kin_assassin)) {
										AssignCommand(oG_kin_assassin, sub3(intGLOB_114, 0));
										ChangeToStandardFaction(oG_kin_assassin, 1);
									}
									(int3++);
								}
							}
