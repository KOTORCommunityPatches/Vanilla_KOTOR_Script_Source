...
void sub1(object objectParam1) {
	...
	AssignCommand(objectParam1, sub2(GetFirstPC()));
}
...
void main() {
	...
	switch (nParam1) {
		case 0:
			...
			break;
		case 1:
			DelayCommand(1.0, AssignCommand(oAtris, ActionMoveToObject(GetWaypointByTag("wp_atris_atrend1"), 0, 1.0)));
			break;
		case 2:
			{
				object oCouncilRoom = GetObjectByTag("MedChamber", 0);
				AssignCommand(oCouncilRoom, ActionCloseDoor(oCouncilRoom));
				SetLocked(oCouncilRoom, 1);
