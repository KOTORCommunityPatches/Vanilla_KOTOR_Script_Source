...
void main() {
	object oG_salvager_tae2 = GetObjectByTag("g_salvager_tae", 0);
	DelayCommand(0.2, ChangeToStandardFaction(oG_salvager_tae2, 1));
	DelayCommand(0.2, AssignCommand(oG_salvager_tae2, ActionAttack(GetFirstPC(), 0)));
	oG_salvager_tae2 = GetObjectByTag("g_salvager_tae2", 0);
	DelayCommand(0.2, ChangeToStandardFaction(oG_salvager_tae2, 1));
	DelayCommand(0.2, AssignCommand(oG_salvager_tae2, ActionAttack(GetFirstPC(), 0)));
	oG_salvager_tae2 = GetObjectByTag("g_salvager_tae2", 1);
	DelayCommand(0.2, ChangeToStandardFaction(oG_salvager_tae2, 1));
	DelayCommand(0.2, AssignCommand(oG_salvager_tae2, ActionAttack(GetFirstPC(), 0)));
