...
void main() {
	object oRitual_leader = GetObjectByTag("ritual_follower", 0);
	DelayCommand(0.2, ChangeToStandardFaction(oRitual_leader, 1));
	DelayCommand(0.2, AssignCommand(oRitual_leader, ActionAttack(GetFirstPC(), 0)));
	DelayCommand(0.3, SetFakeCombatState(oRitual_leader, 1));
	DelayCommand(0.4, AssignCommand(oRitual_leader, ActionPlayAnimation(115, 1.0, 0.0)));
	DelayCommand(0.4, SetFakeCombatState(oRitual_leader, 1));
	oRitual_leader = GetObjectByTag("ritual_follower", 1);
	DelayCommand(0.2, ChangeToStandardFaction(oRitual_leader, 1));
	DelayCommand(0.2, AssignCommand(oRitual_leader, ActionAttack(GetFirstPC(), 0)));
	DelayCommand(0.3, SetFakeCombatState(oRitual_leader, 1));
	DelayCommand(0.4, AssignCommand(oRitual_leader, ActionPlayAnimation(115, 1.0, 0.0)));
	DelayCommand(0.4, SetFakeCombatState(oRitual_leader, 1));
	oRitual_leader = GetObjectByTag("ritual_leader", 0);
	DelayCommand(0.2, ChangeToStandardFaction(oRitual_leader, 1));
	DelayCommand(0.2, AssignCommand(oRitual_leader, ActionAttack(GetFirstPC(), 0)));
	DelayCommand(0.3, SetFakeCombatState(oRitual_leader, 1));
