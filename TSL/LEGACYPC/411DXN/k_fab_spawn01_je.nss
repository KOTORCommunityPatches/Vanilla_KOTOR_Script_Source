...
string sub11(int intParam1, invalid invalidParam2);
...
string sub5(int intParam1, int intParam2);
string sub4(int intParam1, invalid invalidParam2);
...
void sub16() {
	if ((!sub15(intGLOB_61))) {
		...
		if (((nLocal < 10) && (nLocal > 0))) {
			...
			if ((nLocal == 0)) {
				if (sub15(intGLOB_58)) {
					...
					if (sub15(intGLOB_54)) {
						int int11 = sub17(OBJECT_SELF, int6);
						if (((int11 > 0) && (int11 < 10))) {
		...
		if (GetIsObjectValid(GetWaypointByTag(string11))) {
			...
			ActionForceMoveToObject(object3, sub15(intGLOB_59), fPersonalSpace, float4);
			if (sub15(intGLOB_52)) {
...
void sub13() {
	...
	sub14();
	if ((sub15(intGLOB_122) || GetIsEncounterCreature(OBJECT_SELF))) {
		string string1;
		int int5 = 1;
		object object1;
		object object2;
...
string sub11(int intParam1, invalid invalidParam2) {
	string string1 = sub5(intParam1, invalidParam2);
	return string1;
}
...
string sub5(int intParam1, int intParam2) {
	...
	if ((intParam2 == 0)) {
		...
		string3 = sub5(intParam1, (int2 * 100));
	}
	else {
		if (((intParam2 % 100) == 0)) {
			switch ((intParam2 / 100)) {
			...
			int2 = (Random(int1) + 1);
			string3 = sub5(intParam1, (intParam2 + (10 * int2)));
		}
		else {
			if (((intParam2 % 10) == 0)) {
				switch ((intParam2 / 10)) {
				...
				int2 = (Random(int1) + 1);
				string3 = sub5(intParam1, (intParam2 + int2));
			}
			else {
				switch (intParam2) {
					case 141:
...
string sub4(int intParam1, invalid invalidParam2) {
	string string1 = sub5((intParam1 + 5), invalidParam2);
	return string1;
}
