...
void sub1() {
	...
	SetCreatureAILevel(oDrexl_boss, 3);
	DelayCommand(2.5, ClearAllActions());
	DelayCommand(2.5, AssignCommand(oDrexl_boss, ActionDoCommand(SetFacing(270.0))));
	DelayCommand(2.6, AssignCommand(oDrexl_boss, ActionMoveToObject(GetWaypointByTag("wp_entry_tgone"), 0, 1.0)));
	DelayCommand(4.0, ChangeToStandardFaction(oDrexl_boss, 1));
	DelayCommand(4.0, AssignCommand(oDrexl_boss, ActionUseTalentOnObject(TalentSpell(257), oDrexl_boss)));
	DelayCommand(4.0, SetNPCAIStyle(oDrexl_boss, 7));
	DelayCommand(5.0, AssignCommand(oDrexl_boss, ActionAttack(GetFirstPC(), 0)));
	DelayCommand(5.0, AssignCommand(oDrexl_boss, sub2(OBJECT_INVALID)));
}
...
void main() {
	...
	int int5;
	object oDs_v_troop_tob;
	object oSith_drexl = GetObjectByTag("sith_drexl", 0);
	object oDrexl_boss = GetObjectByTag("drexl_boss", 0);
	object oTobin = GetObjectByTag("tobin", 0);
	switch (nParam1) {
		case 0:
			SetLocalBoolean(OBJECT_SELF, 59, 1);
			{
				object oDrexlHit = GetObjectByTag("DrexlHit", 0);
				object oDrexlZapped = GetObjectByTag("DrexlZapped", 0);
				object oDrexlHurt = GetObjectByTag("DrexlHurt", 0);
				AssignCommand(oSith_drexl, PlayAnimation(10459, 1.0, 0.0));
				DelayCommand(1.0, SoundObjectPlay(oDrexlHit));
				AssignCommand(oDrexl_boss, DelayCommand(1.0, PlayAnimation(10282, 1.0, 0.0)));
				effect efVisual = EffectVisualEffect(1021, 0);
				DelayCommand(1.5, SoundObjectPlay(oDrexlZapped));
				DelayCommand(1.6, ApplyEffectToObject(0, efVisual, oDrexl_boss, 2.0));
				AssignCommand(oDrexl_boss, DelayCommand(1.6, PlayAnimation(10268, 1.0, 2.0)));
				DelayCommand(2.1, SoundObjectPlay(oDrexlHurt));
				DelayCommand(5.0, AssignCommand(oDrexl_boss, PlayAnimation(10283, 1.0, 0.0)));
				if ((!nParam2)) {
					DelayCommand(5.0, SetLocalBoolean(oDrexl_boss, 60, 0));
				}
			}
			break;
		case 1:
			{
				object oFf_inner = GetObjectByTag("ff_inner", 0);
				AssignCommand(oFf_inner, ActionUnlockObject(oFf_inner));
				AssignCommand(oFf_inner, ActionOpenDoor(oFf_inner));
				DelayCommand(1.0, AssignCommand(oDrexl_boss, PlayAnimation(10286, 1.0, 0.0)));
				DelayCommand(1.0, AssignCommand(oSith_drexl, PlayAnimation(10459, 1.0, 0.0)));
				DelayCommand(2.0, AssignCommand(oDrexl_boss, PlayAnimation(10287, 1.0, 0.0)));
				DelayCommand(3.0, AssignCommand(oSith_drexl, PlayAnimation(10253, 1.0, 0.0)));
				DelayCommand(3.0, AssignCommand(oDrexl_boss, PlayAnimation(10259, 1.0, 0.0)));
				DelayCommand(4.0, AssignCommand(oDrexl_boss, PlayAnimation(10258, 1.0, 0.0)));
				DelayCommand(6.0, AssignCommand(oDrexl_boss, ActionForceMoveToObject(GetObjectByTag("wp_drexl_sith", 0), 0, 1.0, 30.0)));
				DelayCommand(7.0, AssignCommand(oSith_drexl, PlayAnimation(10074, 1.0, 0.0)));
				DelayCommand(7.0, AssignCommand(oDrexl_boss, PlayAnimation(10283, 1.0, 0.0)));
			}
			break;
		case 2:
			DelayCommand(0.5, AssignCommand(oDrexl_boss, PlayAnimation(10284, 1.0, 0.0)));
			DelayCommand(1.0, AssignCommand(oDrexl_boss, PlayAnimation(10282, 1.0, 0.0)));
			{
				effect efPush = EffectForcePushTargeted(GetLocation(oDrexl_boss), 0);
				DelayCommand(2.0, ApplyEffectToObject(0, efPush, oSith_drexl, 0.0));
				DelayCommand(3.0, AssignCommand(oSith_drexl, SetIsDestroyable(0, 0, 0)));
				DelayCommand(4.0, ApplyEffectToObject(2, EffectDeath(0, 1, 0), oSith_drexl, 0.0));
				DelayCommand(3.0, AssignCommand(oDrexl_boss, PlayAnimation(10283, 1.0, 0.0)));
			}
			break;
		case 3:
			if ((GetGlobalNumber("500OND_DarkSide_Iziz") == 0)) {
				int5 = 0;
				while ((int5 < 4)) {
					oDs_v_troop_tob = GetObjectByTag("v_troop", int5);
					DelayCommand(IntToFloat(int5), AssignCommand(oDs_v_troop_tob, ActionForceMoveToObject(GetObjectByTag(("wp_thronestorm" + IntToString((int5 + 1))), 0), 1, 1.0, 30.0)));
					SetCommandable(1, oDs_v_troop_tob);
					SetLocalBoolean(oDs_v_troop_tob, intGLOB_114, 1);
					DestroyObject(oDs_v_troop_tob, 10.0, 0, 0.0, 0);
					(int5++);
				}
				DelayCommand(1.0, AssignCommand(oDrexl_boss, PlayAnimation(10259, 1.0, 0.0)));
				DelayCommand(2.0, AssignCommand(oDrexl_boss, PlayAnimation(10258, 1.0, 0.0)));
				DelayCommand(3.5, AssignCommand(oDrexl_boss, PlayAnimation(10282, 1.0, 0.0)));
				effect effect6 = EffectForcePushTargeted(GetLocation(oDrexl_boss), 0);
				DelayCommand(4.5, ApplyEffectToObject(0, effect6, oDs_v_troop_tob, 0.0));
				DelayCommand(5.0, ApplyEffectToObject(2, EffectDeath(0, 1, 0), oDs_v_troop_tob, 0.0));
				DelayCommand(4.0, AssignCommand(oDrexl_boss, PlayAnimation(10283, 1.0, 0.0)));
			}
			else {
				int5 = 0;
				while ((int5 < 4)) {
					oDs_v_troop_tob = GetObjectByTag("ds_v_troop_tob", int5);
					DelayCommand(IntToFloat(int5), AssignCommand(oDs_v_troop_tob, ActionForceMoveToObject(GetObjectByTag(("wp_thronestorm" + IntToString((int5 + 1))), 0), 1, 1.0, 30.0)));
					SetCommandable(1, oDs_v_troop_tob);
					SetLocalBoolean(oDs_v_troop_tob, intGLOB_114, 1);
					DestroyObject(oDs_v_troop_tob, 15.0, 0, 0.0, 0);
					(int5++);
				}
				DelayCommand(4.0, AssignCommand(oTobin, ActionJumpToObject(GetObjectByTag("sp_ds_tobin_drexl", 0), 1)));
				DelayCommand(6.0, AssignCommand(oTobin, ActionMoveToObject(GetObjectByTag("wp_tobin_drexl", 0), 0, 1.0)));
				DelayCommand(1.0, AssignCommand(oDrexl_boss, PlayAnimation(10259, 1.0, 0.0)));
				DelayCommand(2.0, AssignCommand(oDrexl_boss, PlayAnimation(10258, 1.0, 0.0)));
				DelayCommand(4.8, AssignCommand(oDrexl_boss, PlayAnimation(10282, 1.0, 0.0)));
				effect effect9 = EffectForcePushTargeted(GetLocation(oDrexl_boss), 0);
				DelayCommand(5.5, ApplyEffectToObject(1, effect9, oDs_v_troop_tob, 1.0));
				DelayCommand(6.0, ApplyEffectToObject(2, EffectDeath(0, 1, 0), oDs_v_troop_tob, 0.0));
				DelayCommand(6.0, AssignCommand(oDrexl_boss, PlayAnimation(10283, 1.0, 0.0)));
			}
			break;
		case 4:
			ChangeToStandardFaction(oDrexl_boss, 2);
			ChangeToStandardFaction(oTobin, 4);
			AssignCommand(oTobin, ActionAttack(oDrexl_boss, 0));
			DelayCommand(1.2, AssignCommand(oDrexl_boss, PlayAnimation(10282, 1.0, 0.0)));
			{
				effect effect12 = EffectForcePushTargeted(GetLocation(oDrexl_boss), 0);
				DelayCommand(1.2, ApplyEffectToObject(1, effect12, oTobin, 1.0));
				DelayCommand(2.4, AssignCommand(oTobin, SetIsDestroyable(0, 1, 0)));
				DelayCommand(2.5, ApplyEffectToObject(2, EffectDeath(0, 1, 0), oTobin, 0.0));
				AssignCommand(oDrexl_boss, sub1());
			}
			break;
		case 5:
			DelayCommand(1.0, AssignCommand(oDrexl_boss, PlayAnimation(10282, 1.0, 0.0)));
			{
				effect effect15 = EffectForcePushTargeted(GetLocation(oDrexl_boss), 0);
				DelayCommand(2.0, ApplyEffectToObject(1, effect15, oTobin, 1.0));
				AssignCommand(oDrexl_boss, sub1());
			}
			break;
		case 6:
			...
			while ((int5 < 4)) {
				oDs_v_troop_tob = GetObjectByTag("ds_v_troop_tob", int5);
				AssignCommand(oDs_v_troop_tob, ActionJumpToObject(GetObjectByTag((("sp_ds_sentry" + IntToString((int5 + 1))) + "_drexl"), 0), 1));
				SetCommandable(1, oDs_v_troop_tob);
				SetLocalBoolean(oDs_v_troop_tob, intGLOB_114, 1);
				(int5++);
			}
