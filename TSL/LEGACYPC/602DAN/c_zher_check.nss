int StartingConditional() {
	...
	switch (nParam1) {
		case 0:
			...
			break;
		case 1:
			if (((GetGlobalNumber("605DAN_Daraala_Ghosts") > 0) && (GetJournalEntry("ghostrest") < 90))) {
				return 1;
			}
			break;
		case 2:
		...
		case 3:
			...
			break;
		case 4:
			if ((GetJournalEntry("cavecrawl") == 20)) {
				return 1;
			}
			break;
		case 5:
			...
			break;
		case 6:
			if (((GetJournalEntry("ghostrest") == 40) || (GetJournalEntry("ghostrest") == 41))) {
				return 1;
			}
			break;
		case 7:
		...
		case 8:
			...
			break;
		case 9:
			if ((((GetGlobalNumber("605DAN_Daraala_Ghosts") == 0) && (GetJournalEntry("ghostrest") < 90)) && (GetJournalEntry("ghostrest") >= 40))) {
				return 1;
			}
			break;
	}
