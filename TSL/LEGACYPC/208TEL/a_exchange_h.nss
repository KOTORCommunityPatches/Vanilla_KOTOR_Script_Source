...
void sub103(int intParam1) {
	...
	object object7 = GetObjectByTag("hidden_turret", 1);
	if ((intParam1 == 1)) {
		SetMinOneHP(o203_Slusk, 0);
		DelayCommand(0.1, ChangeToStandardFaction(o203_Slusk, 1));
		DelayCommand(0.1, ChangeToStandardFaction(oHidden_turret, 1));
		DelayCommand(0.1, ChangeToStandardFaction(object7, 1));
		DelayCommand(0.1, AssignCommand(oHidden_turret, sub2(OBJECT_INVALID)));
		DelayCommand(0.1, AssignCommand(object7, sub2(OBJECT_INVALID)));
	}
	else {
		if ((intParam1 == 2)) {
			SetMinOneHP(o203_Slusk, 1);
			DelayCommand(0.1, ChangeToStandardFaction(o203_Slusk, 2));
...
void sub1(int intParam1) {
	...
	if ((intParam1 == 1)) {
		...
		DelayCommand(0.1, AssignCommand(oGamGuardLuxB, sub2(OBJECT_INVALID)));
		AssignCommand(oGamGuardLux, ClearAllActions());
		ChangeToStandardFaction(oGamGuardLux, 1);
		DelayCommand(0.1, AssignCommand(oGamGuardLux, sub2(OBJECT_INVALID)));
		AssignCommand(object5, ClearAllActions());
		ChangeToStandardFaction(object5, 1);
		DelayCommand(0.1, AssignCommand(object5, sub2(OBJECT_INVALID)));
		SetMinOneHP(o203_Luxa, 0);
		ChangeToStandardFaction(o203_Luxa, 1);
		DelayCommand(0.1, AssignCommand(o203_Luxa, sub2(OBJECT_INVALID)));
	}
	else {
		if ((intParam1 == 2)) {
			object o203_Slusk = GetObjectByTag("203_Slusk", 0);
