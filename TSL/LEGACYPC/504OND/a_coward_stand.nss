...
// Prototypes
void sub103(object objectParam1, int intParam2);
void sub102(object objectParam1);
...
void sub103(object objectParam1, int intParam2) {
	...
	int int3;
	if ((((intParam2 == intGLOB_150) || (intParam2 == intGLOB_151)) || (intParam2 == intGLOB_152))) {
		int3 = 3;
	}
	else {
		int3 = 2;
	...
	if (((int5 == 1) && (intParam2 == intGLOB_153))) {
		int4 = 1;
	}
	else {
		if (((int5 == 5) && (intParam2 == intGLOB_152))) {
			int4 = 1;
		}
	}
...
void sub102(object objectParam1) {
	sub103(objectParam1, intGLOB_151);
}
...
void main() {
	...
	int int1 = 0;
	while ((int1 <= 8)) {
		oVa_troop_coward = GetObjectByTag("va_troop_coward", int1);
		if (GetIsObjectValid(oVa_troop_coward)) {
			DelayCommand(0.2, ChangeToStandardFaction(oVa_troop_coward, 1));
			DelayCommand(0.2, AssignCommand(oVa_troop_coward, ActionAttack(GetFirstPC(), 0)));
		}
		(int1++);
	}
	DelayCommand(0.2, ChangeToStandardFaction(oVaklu_sergeant3, 1));
	DelayCommand(0.3, sub1(OBJECT_INVALID));
	sub102(GetPCSpeaker());
	ChangeToStandardFaction(GetObjectByTag("G_DARKJEDI04", 0), 1);
