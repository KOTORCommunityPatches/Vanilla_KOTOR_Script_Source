...
void sub13();
void sub12();
void sub11(int intParam1);
string sub10(int intParam1, invalid invalidParam2);
...
string sub3(int intParam1, invalid invalidParam2);
...
void sub15() {
	if ((!sub14(intGLOB_61))) {
		...
		if (GetIsObjectValid(GetWaypointByTag(string11))) {
			...
			ActionForceMoveToObject(object3, sub14(intGLOB_59), fPersonalSpace, float4);
			if (sub14(intGLOB_52)) {
...
void sub12() {
	...
	sub13();
	if ((sub14(intGLOB_122) || GetIsEncounterCreature(OBJECT_SELF))) {
		string string1;
		int int5 = 1;
		object object1;
		object object2;
...
string sub10(int intParam1, invalid invalidParam2) {
	string string1 = sub4(intParam1, invalidParam2);
	return string1;
}
...
string sub3(int intParam1, invalid invalidParam2) {
	string string1 = sub4((intParam1 + 5), invalidParam2);
	return string1;
}
