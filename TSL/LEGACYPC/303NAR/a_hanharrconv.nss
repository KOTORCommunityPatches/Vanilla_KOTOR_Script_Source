...
void main() {
	...
	object oWP_HANHARR = GetObjectByTag("WP_HANHARR", 0);
	CreateObject(1, "p_hanharr", GetLocation(oWP_HANHARR), 0);
	object oHanharr = GetObjectByTag("Hanharr", 0);
	object oTr_hanharrconv = GetObjectByTag("tr_hanharrconv", 0);
