...
void sub2() {
	...
	if ((GetFirstPC() == OBJECT_SELF)) {
		...
		if ((GetGlobalNumber("000_Psychotic") == 1)) {
			...
			if (((GetModuleName() == "650DAN") && (GetGlobalNumber("650DAN_Revelation") == 1))) {
				BeginConversation("krealone", OBJECT_INVALID);
			}
			else {
				if ((GetModuleName() == "262TEL")) {
					BeginConversation("262Kreia", OBJECT_INVALID);
				}
				else {
					if (((GetModuleName() == "003EBO") && (GetGlobalNumber("262TEL_Escape_Telos") == 0))) {
						BeginConversation("003Kreia", OBJECT_INVALID);
					}
					else {
						if (((GetModuleName() == "101PER") && (GetGlobalNumber("101PER_Kreia_Joined") == 0))) {
							BeginConversation("101Kreia", OBJECT_INVALID);
						}
						else {
							BeginConversation("", OBJECT_INVALID);
						}
