...
int sub16(object objectParam1, int intParam2);
void sub15();
string sub14(int intParam1, invalid invalidParam2);
string sub13(int intParam1);
string sub12(int intParam1, int intParam2);
string sub11(int intParam1, int intParam2);
int sub10(int intParam1, int intParam2, int intParam3);
			...
			if ((nRandom == 3)) {
				...
				if ((((nRandom == 4) || (nRandom == 5)) && (GetRacialType(OBJECT_SELF) != 5))) {
					if ((GetGender(OBJECT_SELF) == 0)) {
						...
						ActionDoCommand(sub18(intGLOB_52, 1));
					}
					else {
		...
		if (((nLocal < 10) && (nLocal > 0))) {
			...
			if ((nLocal == 0)) {
				if (sub4(intGLOB_58)) {
					...
					if (sub4(intGLOB_54)) {
						int int11 = sub16(OBJECT_SELF, int6);
						if (((int11 > 0) && (int11 < 10))) {
...
string sub11(int intParam1, int intParam2) {
	...
	if ((intParam2 == 0)) {
		int2 = (Random(0) + 9);
		string1 = sub11(intParam1, (int2 * 100));
	}
	else {
		if (((intParam2 % 100) == 0)) {
			...
			int2 = (Random(int1) + 1);
			string1 = sub11(intParam1, (intParam2 + (10 * int2)));
		}
		else {
			if (((intParam2 % 10) == 0)) {
				switch ((intParam2 / 10)) {
				...
				int2 = (Random(int1) + 1);
				string1 = sub12(intParam1, (intParam2 + int2));
			}
			else {
				string1 = sub12(intParam1, intParam2);
			}
		}
	}
	return string1;
	...
	if ((intParam2 == 0)) {
		...
		if (((intParam2 % 100) == 0)) {
			...
			if (((intParam2 % 10) == 0)) {
				...
				string3 = (sub9(intParam2) + string1);
			}
		}
	}
	return string3;
...
string sub7(int intParam1, invalid invalidParam2) {
	string string1 = sub8((intParam1 + 5), invalidParam2);
	return string1;
}
