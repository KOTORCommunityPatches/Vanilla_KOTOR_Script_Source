...
// Globals
	...
	int intGLOB_127 = 4;
	int intGLOB_128 = 5;
	int intGLOB_129 = 1001;
	int intGLOB_130 = 1002;
	int intGLOB_131 = 1003;
	int intGLOB_132 = 1004;
	int intGLOB_133 = 1005;
	int intGLOB_134 = 1006;
	int intGLOB_135 = 1007;
	int intGLOB_136 = 1008;
	int intGLOB_137 = 1009;
	int intGLOB_138 = 1010;
	int intGLOB_139 = 1011;
	int intGLOB_140 = 1012;
	int intGLOB_141 = 2001;
	int intGLOB_142 = 2002;
	int intGLOB_143 = 2003;
	int intGLOB_144 = 2004;
	int intGLOB_145 = 2005;
	int intGLOB_146 = 2006;
	int intGLOB_147 = 2007;
	int intGLOB_148 = 2008;
	int intGLOB_149 = 2009;
	int intGLOB_150 = 2010;
	int intGLOB_151 = 2011;
	int intGLOB_152 = 2012;
	int intGLOB_153 = 2013;
	int intGLOB_154 = 2014;
	int intGLOB_155 = 3001;
	int intGLOB_156 = 3002;
	int intGLOB_157 = 3003;
	int intGLOB_158 = 4001;
	int intGLOB_159 = 0;
	int intGLOB_160 = 1;
	int intGLOB_161 = 2;
	int intGLOB_162 = 3;
...
// Prototypes
void sub107(string stringParam1);
void sub106(string stringParam1);
void sub105(object objectParam1, int intParam2, object oTarget);
int sub104();
void sub103();
int sub102(object objectParam1);
...
void sub105(object objectParam1, int intParam2, object oTarget) {
	sub106("");
	sub106(("GENERIC SHOUT DEBUG *************** Respond to Shout Started for " + sub3(OBJECT_SELF)));
	sub106(("GENERIC SHOUT DEBUG *************** Intruder Object = " + sub3(oTarget)));
	...
	int int2;
	{
		...
		if (((((!sub6(intGLOB_112)) && (!sub6(intGLOB_113))) && (!sub6(intGLOB_114))) && (!GetUserActionsPending()))) {
			sub106("GENERIC SHOUT DEBUG *************** Check 1 Pass");
			if ((((intParam2 == 1) && GetIsFriend(objectParam1, OBJECT_SELF)) && (objectParam1 != OBJECT_SELF))) {
				if ((((IsObjectPartyMember(OBJECT_SELF) && IsObjectPartyMember(objectParam1)) && (GetSoloMode() == 0)) || (!IsObjectPartyMember(OBJECT_SELF)))) {
					sub106("GENERIC SHOUT DEBUG *************** Check 2 Pass");
					if ((((!GetIsObjectValid(GetAttemptedAttackTarget())) && (!GetIsObjectValid(GetAttemptedSpellTarget()))) && (!GetIsObjectValid(GetAttackTarget(OBJECT_SELF))))) {
						sub106("GENERIC SHOUT DEBUG *************** Check 3 Pass");
						if ((((GetPartyMemberByIndex(0) != OBJECT_SELF) && (nStyle != 2)) && (!GetPlayerRestrictMode(OBJECT_SELF)))) {
							...
							if (((IsObjectPartyMember(OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF))) || (!IsObjectPartyMember(OBJECT_SELF)))) {
								sub106("GENERIC SHOUT DEBUG *************** Check 5 Pass");
								sub106(("GENERIC SHOUT DEBUG *************** Intruder = " + sub3(oTarget)));
								if (GetObjectSeen(oTarget, OBJECT_SELF)) {
									sub106("GENERIC SHOUT DEBUG *************** Shout: Determine Combat Round");
									...
									if (GetIsObjectValid(oTarget)) {
										sub106("GENERIC SHOUT DEBUG *************** Shout: Move To Intruder");
										...
										if (IsObjectPartyMember(OBJECT_SELF)) {
											...
											sub106(("GENERIC SHOUT DEBUG *************** Attack Intruder = " + sub3(oTarget)));
											if (GetIsObjectValid(oTarget)) {
												sub1(oTarget);
											}
											else {
												oTarget = GetSpellTarget(objectParam1);
												sub106(("GENERIC SHOUT DEBUG *************** Spell Intruder = " + sub3(oTarget)));
												if (GetIsObjectValid(oTarget)) {
													sub1(oTarget);
												}
											}
...
void sub103() {
	if ((!GetIsInConversation(OBJECT_SELF))) {
		...
		int int7 = GetHitDice(oNearest);
		if (((!sub104()) || (!sub6(intGLOB_112)))) {
			if (sub6(intGLOB_52)) {
...
int sub102(object objectParam1) {
	...
	if ((GetTag(OBJECT_SELF) == "DEBUG")) {
		sub3(OBJECT_SELF);
		sub101(("Attempted Attack Target = " + IntToString(GetIsObjectValid(object1))), 10, 20, 4.0);
		sub101(("Attempted Spell Target = " + IntToString(GetIsObjectValid(object3))), 10, 22, 4.0);
		sub101(("Attack Target = " + IntToString(GetIsObjectValid(oTarget))), 10, 24, 4.0);
		sub101(("Move Target = " + IntToString(GetIsObjectValid(object7))), 10, 26, 4.0);
	}
	...
	if ((int2 == 1)) {
		...
		if (((GetHasSpellEffect(8, oPC) || GetHasSpellEffect(34, oPC)) || GetHasSpellEffect(37, oPC))) {
			...
			if ((fDistance > 10.0)) {
				...
				if ((int10 != (-1))) {
					talent talent3 = TalentSpell(int10);
...
void main() {
	...
	switch (int1) {
		...
		case 1001:
			{
				...
				if ((!sub6(intGLOB_114))) {
				if ((sub6(intGLOB_52) || sub6(intGLOB_53))) {
					string string1 = (("WP_" + GetTag(OBJECT_SELF)) + "_01");
					int nLocal = GetLocalNumber(OBJECT_SELF, intGLOB_51);
					if (((!GetIsObjectValid(GetObjectByTag(string1, 0))) && (nLocal <= 0))) {
						if ((GetCurrentAction(OBJECT_SELF) != 0)) {
							if (((!sub102(OBJECT_SELF)) && (!GetIsObjectValid(oNearest)))) {
								sub103();
							}
						}
					}
		...
		case 1002:
			{
				...
				if ((GetCommandable(OBJECT_SELF) && (!sub6(intGLOB_114)))) {
				if ((((!GetIsObjectValid(GetAttemptedAttackTarget())) && (!GetIsObjectValid(GetAttemptedSpellTarget()))) && (!GetIsObjectValid(GetAttackTarget(OBJECT_SELF))))) {
					if (GetLastPerceptionSeen()) {
						if (GetIsEnemy(oPerceived, OBJECT_SELF)) {
							float fDistance = GetDistanceBetween(OBJECT_SELF, oPerceived);
							fDistance = (fDistance / 10.0);
							DelayCommand((fDistance / 2.0), SetFacingPoint(GetPosition(oPerceived)));
							if ((sub6(intGLOB_120) == 1)) {
								fDistance = 0.0;
							}
							SpeakString("GEN_I_WAS_ATTACKED", 3);
							sub2("GENERIC DEBUG *************** Determine Combat Round from On Perception 2");
							DelayCommand(fDistance, sub1(OBJECT_INVALID));
							if ((fDistance > 0.0)) {
								sub9(intGLOB_120, 1);
							}
						}
					...
					if ((GetLastPerceptionVanished() && GetIsEnemy(oPerceived, OBJECT_SELF))) {
						if ((((GetAttemptedAttackTarget() == oPerceived) || (GetAttemptedSpellTarget() == oPerceived)) || (GetAttackTarget(OBJECT_SELF) == oPerceived))) {
							ClearAllActions();
							sub1(OBJECT_INVALID);
							if ((((!GetIsObjectValid(GetAttemptedAttackTarget())) && (!GetIsObjectValid(GetAttemptedSpellTarget()))) && (!GetIsObjectValid(GetAttackTarget(OBJECT_SELF))))) {
								ClearAllActions();
								ActionMoveToObject(oPerceived, 1, 1.0);
								ActionAttack(oPerceived, 0);
							}
						}
					}
					else {
						if ((GetCurrentAction(OBJECT_SELF) != 65534)) {
							if (GetLastPerceptionSeen()) {
								if (GetIsEnemy(GetLastPerceived(), OBJECT_SELF)) {
									float float3 = GetDistanceBetween(OBJECT_SELF, oPerceived);
									float3 = (float3 / 10.0);
									DelayCommand((float3 / 2.0), SetFacingPoint(GetPosition(oPerceived)));
									SpeakString("GEN_I_WAS_ATTACKED", 3);
									sub2("GENERIC DEBUG *************** Determine Combat Round from On Perception 2");
									DelayCommand(float3, sub1(OBJECT_INVALID));
								}
							}
						}
					}
				...
				if ((sub6(intGLOB_85) && GetLastPerceptionSeen())) {
		...
		case 1003:
			if ((!sub6(intGLOB_114))) {
				if (GetCommandable(OBJECT_SELF)) {
					SpeakString("GEN_COMBAT_ACTIVE", 3);
					sub1(OBJECT_INVALID);
				}
			}
			if (sub6(intGLOB_90)) {
		...
		case 1004:
			{
				int int34 = GetListenPatternNumber();
				if (sub6(intGLOB_123)) {
				if ((int34 == (-1))) {
					ResetDialogState();
				}
				...
				if (((((!GetIsObjectValid(oLastActor)) || GetIsDead(oLastActor)) || (!GetObjectSeen(oLastActor, oSpeaker))) || (!GetIsEnemy(oLastActor, oSpeaker)))) {
					if (GetCommandable(OBJECT_SELF)) {
						if ((int34 == (-1))) {
							ClearAllActions();
							if (sub6(intGLOB_101)) {
								ActionStartConversation(GetFirstPC(), "", 0, 1, 0, "", "", "", "", "", "", 0, 0xFFFFFFFF, 0xFFFFFFFF, 0);
								return;
							}
							else {
							...
							if (((((int34 != (-1)) && GetIsObjectValid(oSpeaker)) && (!GetIsPC(oSpeaker))) && GetIsFriend(oSpeaker, OBJECT_SELF))) {
								if ((int34 >= 1)) {
									object20 = GetLastHostileActor(oSpeaker);
									if ((!GetIsObjectValid(object20))) {
										object20 = GetAttemptedAttackTarget();
										if ((!GetIsObjectValid(object20))) {
											object20 = GetAttemptedSpellTarget();
											if ((!GetIsObjectValid(object20))) {
												object20 = GetNearestCreature(3, 1, OBJECT_SELF, 1, 7, 7, 0xFFFFFFFF, 0xFFFFFFFF);
												if ((!GetIsObjectValid(object20))) {
													sub2("GENERIC DEBUG *************** No Intruder Object For Shout");
													object20 = OBJECT_INVALID;
												}
											}
										}
									}
								}
								sub105(oSpeaker, int34, object20);
							}
						}
					}
				}
		...
		case 1005:
			...
			if ((GetCommandable(OBJECT_SELF) && (!sub6(intGLOB_114)))) {
				if ((((!GetIsObjectValid(GetAttemptedAttackTarget())) && (!GetIsObjectValid(GetAttemptedSpellTarget()))) && (!GetIsObjectValid(GetAttackTarget(OBJECT_SELF))))) {
					sub2("GENERIC DEBUG *************** Determine Combat Round from On Attacked");
					sub1(OBJECT_INVALID);
					SpeakString("GEN_I_WAS_ATTACKED", 3);
				}
				else {
			...
			if ((GetCommandable(OBJECT_SELF) && (!sub6(intGLOB_114)))) {
				if (((!GetIsObjectValid(GetAttemptedAttackTarget())) && (!GetIsObjectValid(GetAttemptedSpellTarget())))) {
					if (GetIsObjectValid(GetLastDamager())) {
						if (GetIsEnemy(GetLastDamager(), OBJECT_SELF)) {
							if ((((!GetIsObjectValid(GetAttemptedAttackTarget())) && (!GetIsObjectValid(GetAttemptedSpellTarget()))) && (!GetIsObjectValid(GetAttackTarget(OBJECT_SELF))))) {
								sub1(OBJECT_INVALID);
								if ((((!GetIsObjectValid(GetAttemptedAttackTarget())) && (!GetIsObjectValid(GetAttemptedSpellTarget()))) && (!GetIsObjectValid(GetAttackTarget(OBJECT_SELF))))) {
									object object41 = GetLastDamager();
									if (((!GetObjectSeen(object41, OBJECT_SELF)) && (GetArea(OBJECT_SELF) == GetArea(object41)))) {
										effect effect1 = EffectBlind();
										RemoveEffect(OBJECT_SELF, effect1);
										if (((GetDistanceBetween(OBJECT_SELF, object41) < 20.0) && (!GetObjectSeen(object41, OBJECT_SELF)))) {
											ActionMoveToObject(object41, 1, 2.0);
										}
										else {
											if ((sub18(OBJECT_SELF) == 1)) {
												ActionMoveToObject(object41, 1, 4.0);
											}
											else {
												ActionMoveToObject(object41, 1, 15.0);
											}
										}
										sub2("GENERIC DEBUG *************** Determine Combat Round from On Damaged");
										ActionDoCommand(sub1(OBJECT_INVALID));
									}
								}
							}
						}
					...
					if ((!GetIsObjectValid(GetAttemptedSpellTarget()))) {
						...
						object object49 = GetLastHostileActor(OBJECT_SELF);
						if ((((GetIsObjectValid(object49) && (oTarget != object49)) && GetIsEnemy(object49, OBJECT_SELF)) && ((GetTotalDamageDealt() > (GetMaxHitPoints(OBJECT_SELF) / 4)) || ((GetHitDice(object49) - 2) > GetHitDice(oTarget))))) {
							sub2("GENERIC DEBUG *************** Determine Combat Round from On Attacked 2");
							sub1(object49);
						}
					}
				}
		...
		case 1009:
			{
				object object51 = GetBlockingDoor();
				if ((!sub6(intGLOB_114))) {
				if (GetIsObjectValid(object51)) {
					if (GetIsDoorActionPossible(object51, 0)) {
						DoDoorAction(object51, 0);
					}
					else {
						if (GetIsDoorActionPossible(object51, 2)) {
							DoDoorAction(object51, 2);
						}
					}
				}
				}
		...
		case 1010:
			{
				...
				if (GetLastSpellHarmful()) {
					if ((((((!GetIsObjectValid(GetAttackTarget(OBJECT_SELF))) && (!GetIsObjectValid(GetAttemptedSpellTarget()))) && (!GetIsObjectValid(GetAttemptedAttackTarget()))) && GetIsObjectValid(oCaster)) && GetCommandable(OBJECT_SELF))) {
						sub2("GENERIC DEBUG *************** Determine Combat Round from On Spell Cast At");
						sub1(oCaster);
						SpeakString("GEN_I_WAS_ATTACKED", 3);
					}
				}
			...
			break;
		case 1011:
			sub2(("GENERIC DEBUG *************** Starting Post Dialogue Event for " + sub3(OBJECT_SELF)));
			if ((GetIsEnemy(GetFirstPC(), OBJECT_SELF) && (GetCommandable(OBJECT_SELF) == 0))) {
				SetCommandable(1, OBJECT_SELF);
			}
			if (GetIsObjectValid(GetNearestCreature(3, 1, OBJECT_SELF, 1, 7, 7, 0xFFFFFFFF, 0xFFFFFFFF))) {
				if ((!IsObjectPartyMember(OBJECT_SELF))) {
					DelayCommand(0.2, sub1(OBJECT_INVALID));
				}
			}
			else {
				if ((sub6(intGLOB_114) == 0)) {
					if (sub94()) {
						sub2("GENERIC DEBUG *************** End Coversation Successful Fall through");
					}
				}
			}
			if (sub6(intGLOB_118)) {
		...
		case 1012:
			{
				object object60 = GetBlockingCreature(OBJECT_SELF);
				object object62 = GetFoundEnemyCreature(OBJECT_SELF);
				AurPostString(sub3(object60), 0, 15, 2.0);
				AurPostString(sub3(object62), 0, 16, 2.0);
				if (((GetIsObjectValid(object62) && GetCommandable(OBJECT_SELF)) && (object62 != GetAttemptedAttackTarget()))) {
				if ((((!sub6(intGLOB_112)) && (!sub6(intGLOB_113))) && (!sub6(intGLOB_114)))) {
					sub2(("GENERIC DEBUG *************** Combat Blocked " + sub3(object62)));
					sub2("GENERIC DEBUG *************** Combat Blocked Clear (PICK an Number preston)");
					ClearAllActions();
					sub1(object62);
				}
				}
				if (((!GetIsObjectValid(object62)) && GetCommandable(OBJECT_SELF))) {
				}
			}
			break;
		case 2001:
			{
				object object65 = GetNearestCreature(7, 7, OBJECT_SELF, 1, 3, 1, 0xFFFFFFFF, 0xFFFFFFFF);
				if (((!sub6(intGLOB_114)) && (!GetSoloMode()))) {
				if ((GetPartyMemberByIndex(0) != OBJECT_SELF)) {
					if (((((((IsObjectPartyMember(OBJECT_SELF) && (GetCurrentAction(OBJECT_SELF) != 0)) && (GetCurrentAction(OBJECT_SELF) != 38)) && (!GetIsConversationActive())) && (!sub6(intGLOB_113))) && GetCommandable(OBJECT_SELF)) && ((!IsMeditating(OBJECT_SELF)) || (IsMeditating(OBJECT_SELF) && (GetDistanceBetween(OBJECT_SELF, GetPartyMemberByIndex(0)) > 15.0))))) {
						if (((!sub102(OBJECT_SELF)) && (!GetIsObjectValid(object65)))) {
							ClearAllActions();
							ActionFollowLeader();
						}
					}
			...
			break;
		case 2002:
			sub101("Firing Perception", 10, 10, 4.0);
			if ((!sub6(intGLOB_114))) {
				if (((GetPartyMemberByIndex(0) != OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF)))) {
					if ((GetLastPerceptionVanished() && GetIsEnemy(GetLastPerceived(), OBJECT_SELF))) {
						object object71 = GetLastPerceived();
						if (((((GetAttemptedAttackTarget() == GetLastPerceived()) || (GetAttemptedSpellTarget() == GetLastPerceived())) || (GetAttackTarget(OBJECT_SELF) == GetLastPerceived())) && (GetArea(GetLastPerceived()) != GetArea(OBJECT_SELF)))) {
							ClearAllActions();
							sub1(OBJECT_INVALID);
						}
					}
						...
						if ((((!GetIsObjectValid(GetAttemptedAttackTarget())) && (!GetIsObjectValid(GetAttemptedSpellTarget()))) && (!GetIsObjectValid(GetAttackTarget(OBJECT_SELF))))) {
							if (GetLastPerceptionSeen()) {
								if (GetIsEnemy(GetLastPerceived(), OBJECT_SELF)) {
									object oNPC = GetPartyMemberByIndex(0);
									if (GetIsObjectValid(GetAttackTarget(oNPC))) {
										sub101("Perception Attack", 10, 12, 4.0);
										SpeakString("GEN_I_WAS_ATTACKED", 4);
										sub1(OBJECT_INVALID);
									}
								}
							}
		...
		case 2003:
			if ((!sub6(intGLOB_114))) {
				sub107(("GENERIC DEBUG *************** End of Combat Round: " + sub3(OBJECT_SELF)));
				SpeakString("GEN_I_WAS_ATTACKED", 3);
				sub1(OBJECT_INVALID);
			}
			if (sub6(intGLOB_90)) {
		...
		case 2004:
			{
				int int142 = GetListenPatternNumber();
				if ((!sub6(intGLOB_114))) {
				if (GetCommandable(OBJECT_SELF)) {
					object object89 = GetLastSpeaker();
					object object91;
					if ((int142 == (-1))) {
						ClearAllActions();
						BeginConversation("", OBJECT_INVALID);
						...
						sub105(object89, int142, GetLastHostileActor(object89));
					}
				}
				}
				if ((int142 == (-1))) {
		...
		case 2005:
			SpeakString("GEN_I_WAS_ATTACKED", 4);
			{
				...
				object oRWeapItem = GetItemInSlot(4, oAttacker);
				int int148 = 0;
				if (GetIsObjectValid(oRWeapItem)) {
				int148 = sub76(GetBaseItemType(oRWeapItem));
				}
				if (((int148 == 1) || (int148 == 0))) {
					SetLocalNumber(OBJECT_SELF, intGLOB_12, 2);
				}
				if ((!sub6(intGLOB_114))) {
				if ((GetPartyMemberByIndex(0) == OBJECT_SELF)) {
					SpeakString("GEN_I_WAS_ATTACKED", 3);
				...
				if (((GetPartyMemberByIndex(0) != OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF)))) {
					if ((((!GetIsObjectValid(GetAttemptedAttackTarget())) && (!GetIsObjectValid(GetAttemptedSpellTarget()))) && (!GetIsObjectValid(GetAttackTarget(OBJECT_SELF))))) {
						if (GetIsObjectValid(GetLastAttacker(OBJECT_SELF))) {
							if ((GetArea(GetLastAttacker(OBJECT_SELF)) == GetArea(OBJECT_SELF))) {
								if ((!GetIsInCombat(OBJECT_SELF, 0))) {
									sub1(OBJECT_INVALID);
								}
							}
		...
		case 2006:
			if ((!sub6(intGLOB_114))) {
				if ((((GetFirstPC() == OBJECT_SELF) && GetGlobalBoolean("END_BRIDGE_COMBAT")) && (GetGlobalBoolean("END_HURT_WARN") == 0))) {
					SetGlobalBoolean("END_HURT_WARN", 1);
					BarkString(OBJECT_INVALID, 10242, 0xFFFFFFFF, 0xFFFFFFFF);
					PauseGame(1);
				}
				else {
					if (((GetPartyMemberByIndex(0) != OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF)))) {
						if ((GetCurrentAction(OBJECT_SELF) != 38)) {
							if (((!GetIsObjectValid(GetAttemptedAttackTarget())) && (!GetIsObjectValid(GetAttemptedSpellTarget())))) {
								if (GetIsObjectValid(GetLastDamager())) {
									if ((((!GetIsObjectValid(GetAttemptedAttackTarget())) && (!GetIsObjectValid(GetAttemptedSpellTarget()))) && (!GetIsObjectValid(GetAttackTarget(OBJECT_SELF))))) {
										sub1(OBJECT_INVALID);
										if ((!sub102(OBJECT_SELF))) {
											object object114 = GetLastDamager();
											if (((!GetObjectSeen(object114, OBJECT_SELF)) && (GetArea(OBJECT_SELF) == GetArea(object114)))) {
												ActionMoveToLocation(GetLocation(object114), 1);
												ActionDoCommand(sub1(OBJECT_INVALID));
											}
										}
									}
								...
								if ((!GetIsObjectValid(GetAttemptedSpellTarget()))) {
									object object119 = GetAttackTarget(OBJECT_SELF);
									if ((!GetIsObjectValid(object119))) {
										object119 = GetAttemptedAttackTarget();
									}
									object object122 = GetLastHostileActor(OBJECT_SELF);
									if ((((GetIsObjectValid(object122) && (object119 != object122)) && GetIsEnemy(object122, OBJECT_SELF)) && ((GetTotalDamageDealt() > (GetMaxHitPoints(OBJECT_SELF) / 4)) || ((GetHitDice(object122) - 2) > GetHitDice(object119))))) {
										sub1(object122);
									}
								}
							}
		...
		case 2009:
			{
				object object124 = GetBlockingDoor();
				if ((!sub6(intGLOB_114))) {
				if ((GetAbilityScore(OBJECT_SELF, 3) >= 5)) {
					if ((GetIsDoorActionPossible(object124, 0) && (GetAbilityScore(OBJECT_SELF, 3) >= 7))) {
						DoDoorAction(object124, 0);
					}
					else {
						if (GetIsDoorActionPossible(object124, 2)) {
							DoDoorAction(object124, 2);
						}
					}
				}
				}
