...
// Prototypes
void sub104(string stringParam1, int intParam2, int intParam3, float floatParam4);
void sub103();
int sub102(int intParam1, int intParam2);
int sub101(object objectParam1, int intParam2);
void sub100();
void sub99();
int sub98();
int sub97();
int sub96(int intParam1);
int sub95(int intParam1);
int sub94(float floatParam1);
int sub93(object objectParam1);
int sub92();
int sub91(int intParam1);
int sub90(int intParam1);
object sub89(object objectParam1);
int sub88();
int sub87();
int sub86(int intParam1);
int sub85(float floatParam1);
int sub84(int intParam1);
int sub83(int intParam1);
void sub82(object objectParam1);
int sub81(int intParam1);
talent sub80(object objectParam1, talent talentParam2);
int sub79(int intParam1);
int sub78(int intParam1);
int sub77(int intParam1);
string sub76(int intParam1);
int sub75();
int sub74();
int sub73();
int sub72();
			...
			if ((nRandom == 3)) {
				...
				if ((((nRandom == 4) || (nRandom == 5)) && (GetRacialType(OBJECT_SELF) != 5))) {
					if ((GetGender(OBJECT_SELF) == 0)) {
						...
						ActionDoCommand(sub12(intGLOB_52, 1));
					}
					else {
...
void sub100() {
	if ((!sub1(intGLOB_61))) {
		...
		if (((nLocal < 10) && (nLocal > 0))) {
			...
			if ((nLocal == 0)) {
				if (sub1(intGLOB_58)) {
					...
					if (sub1(intGLOB_54)) {
						int int11 = sub101(OBJECT_SELF, int6);
						if (((int11 > 0) && (int11 < 10))) {
		...
		if (GetIsObjectValid(GetWaypointByTag(string11))) {
			...
			ActionForceMoveToObject(object3, sub1(intGLOB_59), fPersonalSpace, float4);
			if (sub1(intGLOB_52)) {
				ActionDoCommand(sub103());
			}
...
int sub98() {
	...
	if (GetIsObjectValid(oNearest)) {
		...
		DelayCommand(0.2, ActionDoCommand(sub99()));
		return 1;
	}
	else {
		if (GetIsObjectValid(object3)) {
			sub6(("GENERIC DEBUG *************** Object Flee = " + sub5(object3)));
...
int sub97() {
	sub6(("GENERIC DEBUG *************** Post DCR Checks for " + sub5(OBJECT_SELF)));
	if ((sub1(intGLOB_112) && (!sub1(intGLOB_113)))) {
		if (sub98()) {
			return 1;
		}
	}
	...
	if (((!IsObjectPartyMember(OBJECT_SELF)) && (sub1(intGLOB_61) == 1))) {
		sub6("GENERIC DEBUG *************** Clear 1100");
		ClearAllActions();
		DelayCommand(1.0, sub100());
		return 1;
	}
	else {
			...
			if ((!GetSoloMode())) {
				if ((((GetObjectType(oTarget) == 8) && (!GetIsOpen(oTarget))) && (!GetSoloMode()))) {
					...
					if ((((GetObjectType(oTarget) == 64) && (GetCurrentHitPoints(oTarget) > 0)) && (!GetSoloMode()))) {
						...
						sub104("NO TARGET: FOLLOW LEADER", 10, 10, 4.0);
	...
	if ((d100(1) < 20)) {
		if ((GetIsTalentValid(talRandom) && GetCreatureHasTalent(talRandom, OBJECT_SELF))) {
			if ((GetIsObjectValid(intParam1) && GetIsEnemy(intParam1, OBJECT_SELF))) {
				sub6("GENERIC DEBUG *************** Using Talent on Intruder Target");
				...
				object oNearest = GetNearestCreature(3, 1, OBJECT_SELF, 1, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF);
				if (GetIsObjectValid(oNearest)) {
					sub6("GENERIC DEBUG *************** Using Talent on Determined Target");
...
int sub92() {
	...
	if ((nLocal > 0)) {
		...
		if (GetIsObjectValid(object5)) {
			int11 = sub79(GetBaseItemType(object5));
		}
		if ((int11 != 2)) {
			object object7 = GetItemInSlot(18, OBJECT_SELF);
			int int15 = 0;
			if (GetIsObjectValid(object7)) {
				int15 = sub79(GetBaseItemType(object7));
			}
			if ((int15 == 2)) {
				ClearAllActions();
				ActionSwitchWeapons();
...
object sub89(object objectParam1) {
	...
	if (GetIsObjectValid(object1)) {
		sub6(("GENERIC DEBUG *************** Attack Target From Determine Attack Target = " + sub5(object1)));
		return object1;
	}
...
int sub86(int intParam1) {
	...
	if ((sub87() != (-1))) {
		...
		if (int8) {
			...
			if (sub17(intGLOB_128, GetFirstPC())) {
				return 1;
			}
		}
	}
	if (GetIsObjectValid(object1)) {
		if (sub17(intGLOB_125, object1)) {
			return 1;
		}
	}
	object object9 = sub16();
	if (GetIsObjectValid(object9)) {
		if (sub17(intGLOB_126, object9)) {
			return 1;
		}
	}
	if (sub17(intGLOB_127, OBJECT_SELF)) {
		return 1;
	}
	object3 = sub31();
	sub6(("GENERIC DEBUG *************** Jedi Support AI: AOE Target = " + sub11(GetIsObjectValid(object3))));
	if (GetIsObjectValid(object3)) {
		if ((GetRacialType(object3) == 5)) {
			talent1 = sub26(intGLOB_2, 1);
		}
		else {
			talent1 = sub26(intGLOB_2, 0);
		}
	}
	else {
		sub6("GENERIC DEBUG *************** Jedi Support AI: Inside the Party AI Section");
		object3 = sub89(OBJECT_INVALID);
		sub6(("GENERIC DEBUG *************** Boss AI: Initial oFind Search = " + sub5(object3)));
		if (GetIsObjectValid(object3)) {
			sub6(("GENERIC DEBUG *************** Jedi Support AI: Valid oTarget Set As = " + sub5(object3)));
			if ((GetRacialType(object3) == 5)) {
				talent1 = sub26(intGLOB_3, 1);
			}
			else {
				talent1 = sub26(intGLOB_3, 0);
			}
		}
	}
...
int sub84(int intParam1) {
	if ((IsObjectPartyMember(OBJECT_SELF) || (d100(1) > 50))) {
		...
		return sub35(intParam1);
	}
	sub6("GENERIC DEBUG *************** Grenade AI Fall Through");
	return sub35(intParam1);
}
	...
	if ((GetIsObjectValid(oTarget) && (!GetIsDead(oTarget)))) {
		...
		if ((fDistance < 3.5)) {
			...
			if (GetIsInCombat(OBJECT_SELF, 0)) {
				DelayCommand(3.0, sub7(intParam1));
			}
		}
		else {
			int nAction = GetCurrentAction(OBJECT_SELF);
				...
				if ((intParam1 == intGLOB_23)) {
					...
					if ((intParam1 == intGLOB_24)) {
						...
						if ((intParam1 == intGLOB_25)) {
							...
							if ((intParam1 == intGLOB_26)) {
								talRandom = GetCreatureTalentRandom(63743, OBJECT_SELF, 0);
								if ((GetIsTalentValid(talRandom) && sub59())) {
									return 1;
								}
							}
							else {
								if ((intParam1 == intGLOB_27)) {
									talRandom = GetCreatureTalentRandom(63743, OBJECT_SELF, 0);
									talent2 = GetCreatureTalentRandom(62207, OBJECT_SELF, 0);
									if (((GetIsTalentValid(talRandom) && GetIsTalentValid(talent2)) && sub59())) {
										return 1;
									}
								}
								else {
									if ((intParam1 == intGLOB_28)) {
										...
										if ((intParam1 == intGLOB_29)) {
											...
											if ((intParam1 == intGLOB_30)) {
												talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
												if (((sub63() && sub64()) && GetIsTalentValid(talRandom))) {
													return 1;
												}
											}
											else {
												if ((intParam1 == intGLOB_31)) {
													...
													if ((intParam1 == intGLOB_32)) {
														...
														if ((intParam1 == intGLOB_33)) {
															talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
															if (((sub61() && sub67()) && GetIsTalentValid(talRandom))) {
																return 1;
															}
														}
														else {
															if ((intParam1 == intGLOB_34)) {
																if (((sub67() && sub60()) && sub68())) {
																	return 1;
																}
															}
															else {
																if ((intParam1 == intGLOB_35)) {
																	if (((sub65() && sub60()) && sub62())) {
																		return 1;
																	}
																}
																else {
																	if ((intParam1 == intGLOB_36)) {
																		if (((sub66() && sub60()) && sub62())) {
																			return 1;
																		}
																	}
																	else {
																		if ((intParam1 == intGLOB_36)) {
																			if (((sub61() && sub69()) && sub60())) {
																				return 1;
																			}
																		}
																		else {
																			if ((intParam1 == intGLOB_38)) {
																				...
																				if ((intParam1 == intGLOB_39)) {
																					...
																					if ((intParam1 == intGLOB_40)) {
																						talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
																						if (((sub60() && GetIsTalentValid(talRandom)) && GetHasSpell(177, OBJECT_SELF))) {
																							return 1;
																						}
																					}
																					else {
																						if ((intParam1 == intGLOB_41)) {
																							talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
																							if (((sub60() && sub67()) && GetIsTalentValid(talRandom))) {
																								return 1;
																							}
																						}
																						else {
																							if ((intParam1 == intGLOB_42)) {
																								...
																								if ((intParam1 == intGLOB_43)) {
																									talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
																									if (((sub72() && sub73()) && GetIsTalentValid(talRandom))) {
																										return 1;
																									}
																								}
																								else {
																									if ((intParam1 == intGLOB_44)) {
																										talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
																										if ((sub74() && GetIsTalentValid(talRandom))) {
																											return 1;
																										}
																									}
																									else {
																										if (((intParam1 == intGLOB_45) || (intParam1 == intGLOB_46))) {
																											...
																											sub6(((("GENERIC DEBUG *************** Droid Items = " + sub5(oLArmItem)) + " / ") + sub5(oRArmItem)));
																											if (sub75()) {
...
talent sub37(int intParam1) {
	...
	object oRWeapItem = GetItemInSlot(4, OBJECT_SELF);
	if (((((GetLevelByClass(6, OBJECT_SELF) > 0) || (GetLevelByClass(7, OBJECT_SELF) > 0)) && (!sub38(OBJECT_SELF))) && (!GetIsObjectValid(oRWeapItem)))) {
		object oLArmItem = GetItemInSlot(7, OBJECT_SELF);
		object oRArmItem = GetItemInSlot(8, OBJECT_SELF);
		int int9 = 1;
...
int sub35(object objectParam1) {
	...
	oNPC = sub36();
	if (GetIsObjectValid(oNPC)) {
		if (sub17(intGLOB_125, oNPC)) {
			return 1;
		}
	}
	oNPC = sub16();
	if (GetIsObjectValid(oNPC)) {
		if (sub17(intGLOB_126, oNPC)) {
			return 1;
		}
	}
	talent1 = sub37(0);
...
int sub32() {
	...
	sub6((("GENERIC DEBUG *************** Boss AI: Get the #" + sub11(nRandom)) + " target"));
	object oNearest = GetNearestCreature(3, 1, OBJECT_SELF, int4, 7, 7, 0xFFFFFFFF, 0xFFFFFFFF);
	sub6(("GENERIC DEBUG *************** Boss AI: Initial oFind Search = " + sub5(oNearest)));
	while ((GetIsObjectValid(oNearest) && (int4 <= nRandom))) {
		sub6(((("GENERIC DEBUG *************** Boss AI: Valid oFind = " + sub5(oNearest)) + " nCnt = ") + sub11(int4)));
		if (GetIsObjectValid(oNearest)) {
			sub6(("GENERIC DEBUG *************** Boss AI: Valid oTarget Set As = " + sub5(oNearest)));
			object1 = oNearest;
		}
		(int4++);
	...
	if ((int7 == 1)) {
		if (GetIsTalentValid(talent1)) {
			if ((GetTypeFromTalent(talent1) == 1)) {
				sub6(("GENERIC DEBUG *************** Boss AI: Talent Feat = " + sub11(GetIdFromTalent(talent1))));
			}
			else {
				if ((GetTypeFromTalent(talent1) == 0)) {
					sub6(("GENERIC DEBUG *************** Boss AI: Talent Power = " + sub11(GetIdFromTalent(talent1))));
				}
			}
		}
	}
	if (GetIsObjectValid(object1)) {
		...
		talent1 = sub26(intGLOB_3, int1);
		talent1 = sub33(object1, talent1);
		talent1 = sub34(object1, talent1);
		sub6(("GENERIC DEBUG *************** Boss AI: Target = " + sub11(GetIsObjectValid(object1))));
		sub6(("GENERIC DEBUG *************** Boss AI: Talent = " + sub11(GetIsTalentValid(talent1))));
...
int sub30() {
	...
	sub6(("GENERIC DEBUG *************** Boss AI: AOE Target = " + sub11(GetIsObjectValid(object1))));
	int int2;
	if (GetIsObjectValid(object1)) {
		if ((GetRacialType(object1) == 5)) {
			(int2 == 1);
		}
		talent1 = sub26(intGLOB_2, int2);
		if (GetIsTalentValid(talent1)) {
			ClearAllActions();
			ActionUseTalentOnObject(talent1, object1);
...
talent sub28(int intParam1) {
	...
	sub6(("GENERIC DEBUG *************** Last Force Power Used = " + sub11(nLastForce)));
	...
	sub6(("GENERIC DEBUG *************** Force Power Returned = " + sub11(GetIdFromTalent(talent1))));
	return talent1;
}
...
int sub22() {
	...
	talent talent1;
	object object1 = sub23();
	sub6(("GENERIC DEBUG *************** Boss AI: Grenade Target = " + sub11(GetIsObjectValid(object1))));
	int int2;
	if (GetIsObjectValid(object1)) {
		if ((GetRacialType(object1) == 5)) {
			(int2 == 1);
		}
		talent1 = sub26(intGLOB_1, int2);
		if (GetIsTalentValid(talent1)) {
...
object sub19(int intParam1) {
	...
	if (((!GetIsEnemy(oNearest, OBJECT_SELF)) && (intParam1 == 1))) {
		...
		sub6(("GENERIC DEBUG *************** Alternate Target = " + sub5(oNearest)));
	}
	sub6(("GENERIC DEBUG *************** Heal Drain Target = " + sub11(intParam1)));
	sub6(("GENERIC DEBUG *************** Get Active Party Member: " + sub5(oNearest)));
	return oNearest;
}
...
int sub17(int intParam1, object objectParam2) {
	if (GetIsObjectValid(objectParam2)) {
		...
		if ((intParam1 == intGLOB_124)) {
			...
			if ((intParam1 == intGLOB_125)) {
				...
				if ((intParam1 == intGLOB_126)) {
					int3 = 0;
					sub6(("GENERIC DEBUG *************** Starting Heal Talent Checks " + sub5(OBJECT_SELF)));
					talSpell = TalentSpell(28);
					talent2 = TalentSpell(10);
					...
					if (((GetCreatureHasTalent(talSpell, OBJECT_SELF) || GetCreatureHasTalent(talent2, OBJECT_SELF)) || GetCreatureHasTalent(talent3, OBJECT_SELF))) {
						sub6("GENERIC DEBUG *************** I have Heal, Improved Heal, or Master Heal");
						int3 = 1;
		...
		if (((int3 == 1) && (int4 == 0))) {
			...
			sub6(("GENERIC DEBUG *************** Spells.2DA ID = " + sub11(int56)));
			ClearAllActions();
			...
			if (((int3 == 1) && (int4 == 1))) {
				...
				if (GetIsObjectValid(objectParam2)) {
					sub6(("GENERIC DEBUG *************** Hostile Heal Targeted On: " + sub5(objectParam2)));
	...
	sub6(((((("GENERIC DEBUG *************** " + sub5(OBJECT_SELF)) + " VP = ") + sub11(GetCurrentHitPoints(OBJECT_SELF))) + "/") + sub11(GetMaxHitPoints(OBJECT_SELF))));
...
int sub13() {
	int int1 = 0;
	if (((sub1(intGLOB_119) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		if (((GetHitDice(GetFirstPC()) >= 15) || sub1(intGLOB_116))) {
...
int sub10() {
	...
	sub6(((("GENERIC DEBUG *************** Shield Boolean (" + sub11(intGLOB_117)) + ") = ") + sub11(sub1(intGLOB_117))));
	if (((sub1(intGLOB_117) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		int int4;
		int int5;
		int int6 = 0;
		talent talSpell;
		...
		if (int6) {
			...
			sub6("GENERIC DEBUG *************** Forcefield Search Fallthrough");
			sub12(intGLOB_117, 1);
			return 0;
		}
	}
...
void sub7(int intParam1) {
	sub6("");
	sub6(("GENERIC DEBUG *************** START DETERMINE COMBAT ROUND " + sub5(OBJECT_SELF)));
	sub8();
	{
		int nStyle = GetPartyAIStyle();
		int nNPCStyle = GetNPCAIStyle(OBJECT_SELF);
		sub6(("GENERIC DEBUG *************** AI STYLE = " + sub9(OBJECT_SELF)));
		if (((((!sub1(intGLOB_112)) && (!sub1(intGLOB_113))) && (!sub1(intGLOB_114))) && (!GetUserActionsPending()))) {
		if (((GetPartyMemberByIndex(0) != OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF)))) {
			if (((IsObjectPartyMember(OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF))) || (!IsObjectPartyMember(OBJECT_SELF)))) {
				...
				if ((sub10() == 1)) {
					sub6("GENERIC DEBUG *************** Terminating AI from Shields");
					return;
				}
				if ((sub13() == 1)) {
					return;
				}
				if ((sub1(intGLOB_121) == 1)) {
					if ((sub14() == 1)) {
						return;
					}
				}
				if ((sub1(intGLOB_116) == 1)) {
					if ((sub15(intParam1) == 1)) {
						return;
					}
				}
				if ((nNPCStyle == 6)) {
				...
				if (((nNPCStyle == 0) || (nNPCStyle == 7))) {
					...
					if ((nNPCStyle == 4)) {
						...
						if ((nNPCStyle == 5)) {
							...
							if ((sub86(intParam1) == 1)) {
								return;
							}
						}
						else {
							if ((nNPCStyle == 8)) {
								if ((sub90(intParam1) == 1)) {
									return;
								}
							}
							else {
...
void sub2() {
	...
	if ((GetGlobalNumber("000_Psychotic") == 1)) {
		BeginConversation("000react", OBJECT_INVALID);
		return;
	}
	else {
		if ((GetModuleName() == "006EBO")) {
			BeginConversation("AttonEnd", OBJECT_INVALID);
			return;
		}
		else {
			if ((GetModuleName() == "262TEL")) {
				BeginConversation("262Atton", OBJECT_INVALID);
				return;
			}
			else {
				if (((GetModuleName() == "003EBO") && (GetGlobalNumber("262TEL_Escape_Telos") == 0))) {
					BeginConversation("003Atton", OBJECT_INVALID);
					return;
				}
				else {
					if (((GetGlobalNumber("101PER_Atton_Joined") == 0) && (GetModuleName() == "101PER"))) {
						BeginConversation("101Atton", OBJECT_INVALID);
					}
					else {
						if ((GetFirstPC() == OBJECT_SELF)) {
							BeginConversation("", OBJECT_INVALID);
							...
							if (0) {
								BeginConversation("YourDLGResRefHere2", OBJECT_INVALID);
							}
							else {
								BeginConversation("", OBJECT_INVALID);
							}
	...
	if ((!sub1(intGLOB_114))) {
		if (GetCommandable(OBJECT_SELF)) {
			...
			if ((int1 == (-1))) {
				...
				sub3(oSpeaker, int1, GetLastHostileActor(oSpeaker));
			}
		}
	}
	if ((int1 == (-1))) {
