									...
									case 1:
										...
										if ((nParam2 <= 8)) {
											if (((nParam2 % 2) == 1)) {
												...
												DelayCommand(1.5, AssignCommand(oZezkaiel, PlayAnimation(int5, 1.0, 0.0)));
												DelayCommand(4.0, ActionResumeConversation());
												DelayCommand(6.0, SetFakeCombatState(oZezkaiel, 0));
												DelayCommand(6.0, SetLightsaberPowered(oZezkaiel, 1, 0, 0));
											...
											if (((nParam2 % 2) == 1)) {
												...
												switch (nParam2) {
													case 10:
														...
														DelayCommand(0.33, ApplyEffectToObject(1, efBeam, oLightningPoint, 3.6699998));
