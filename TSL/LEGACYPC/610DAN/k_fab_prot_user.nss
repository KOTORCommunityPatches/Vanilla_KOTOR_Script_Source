...
int sub46();
int sub45();
talent sub44(int intParam1);
int sub43(object objectParam1);
...
int sub23();
int sub22(int intParam1, object objectParam2);
object sub21();
...
void sub10();
int sub9(int intParam1, int intParam2);
int sub8(object objectParam1, int intParam2);
...
int sub103() {
	...
	if (GetIsObjectValid(oNearest)) {
		...
		DelayCommand(0.2, ActionDoCommand(sub104()));
		return 1;
	}
	else {
	...
	if ((d100(1) < 20)) {
		if ((GetIsTalentValid(talRandom) && GetCreatureHasTalent(talRandom, OBJECT_SELF))) {
			if ((GetIsObjectValid(objectParam1) && GetIsEnemy(objectParam1, OBJECT_SELF))) {
				sub12("GENERIC DEBUG *************** Using Talent on Intruder Target");
				...
				object oNearest = GetNearestCreature(3, 1, OBJECT_SELF, 1, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF);
				if (GetIsObjectValid(oNearest)) {
					sub12("GENERIC DEBUG *************** Using Talent on Determined Target");
...
int sub97() {
	...
	if ((nLocal > 0)) {
		...
		if (GetIsObjectValid(object5)) {
			int11 = sub84(GetBaseItemType(object5));
		}
		if ((int11 != 2)) {
			object object7 = GetItemInSlot(18, OBJECT_SELF);
			int int15 = 0;
			if (GetIsObjectValid(object7)) {
				int15 = sub84(GetBaseItemType(object7));
			}
			if ((int15 == 2)) {
				ClearAllActions();
				ActionSwitchWeapons();
...
int sub91(object objectParam1) {
	...
	if ((sub92() != (-1))) {
		...
		if (int8) {
			...
			if (sub22(intGLOB_128, GetFirstPC())) {
				return 1;
			}
		}
	}
	if (GetIsObjectValid(object1)) {
		if (sub22(intGLOB_125, object1)) {
			return 1;
		}
	}
	object object9 = sub21();
	if (GetIsObjectValid(object9)) {
		if (sub22(intGLOB_126, object9)) {
			return 1;
		}
	}
	if (sub22(intGLOB_127, OBJECT_SELF)) {
		return 1;
	}
	object3 = sub36();
...
int sub89(object objectParam1) {
	...
	sub12("GENERIC DEBUG *************** Grenade AI Fall Through");
	return sub40(objectParam1);
}
	...
	if ((GetIsObjectValid(oTarget) && (!GetIsDead(oTarget)))) {
		...
		if ((fDistance < 3.5)) {
			...
			if (GetIsInCombat(OBJECT_SELF, 0)) {
				DelayCommand(3.0, sub11(objectParam1));
			}
		}
		else {
			int nAction = GetCurrentAction(OBJECT_SELF);
				...
				if ((intParam1 == intGLOB_23)) {
					...
					if ((intParam1 == intGLOB_24)) {
						...
						if ((intParam1 == intGLOB_25)) {
							...
							if ((intParam1 == intGLOB_26)) {
								talRandom = GetCreatureTalentRandom(63743, OBJECT_SELF, 0);
								if ((GetIsTalentValid(talRandom) && sub64())) {
									return 1;
								}
							}
							else {
								if ((intParam1 == intGLOB_27)) {
									talRandom = GetCreatureTalentRandom(63743, OBJECT_SELF, 0);
									talent2 = GetCreatureTalentRandom(62207, OBJECT_SELF, 0);
									if (((GetIsTalentValid(talRandom) && GetIsTalentValid(talent2)) && sub64())) {
										return 1;
									}
								}
								else {
											...
											if ((intParam1 == intGLOB_30)) {
												...
												if ((intParam1 == intGLOB_31)) {
													...
													if ((intParam1 == intGLOB_32)) {
														...
														if ((intParam1 == intGLOB_33)) {
															talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
															if (((sub66() && sub72()) && GetIsTalentValid(talRandom))) {
																return 1;
															}
														}
														else {
															if ((intParam1 == intGLOB_34)) {
																if (((sub72() && sub65()) && sub73())) {
																	return 1;
																}
															}
															else {
																if ((intParam1 == intGLOB_35)) {
																	if (((sub70() && sub65()) && sub67())) {
																		return 1;
																	}
																}
																else {
																	if ((intParam1 == intGLOB_36)) {
																		if (((sub71() && sub65()) && sub67())) {
																			return 1;
																		}
																	}
																	else {
																		if ((intParam1 == intGLOB_36)) {
																			if (((sub66() && sub74()) && sub65())) {
																				return 1;
																			}
																		}
																		else {
																			if ((intParam1 == intGLOB_38)) {
																				...
																				if ((intParam1 == intGLOB_39)) {
																					...
																					if ((intParam1 == intGLOB_40)) {
																						talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
																						if (((sub65() && GetIsTalentValid(talRandom)) && GetHasSpell(177, OBJECT_SELF))) {
																							return 1;
																						}
																					}
																					else {
																						if ((intParam1 == intGLOB_41)) {
																							talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
																							if (((sub65() && sub72()) && GetIsTalentValid(talRandom))) {
																								return 1;
																							}
																						}
																						else {
																							if ((intParam1 == intGLOB_42)) {
																								...
																								if ((intParam1 == intGLOB_43)) {
																									talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
																									if (((sub77() && sub78()) && GetIsTalentValid(talRandom))) {
																										return 1;
																									}
																								}
																								else {
																									if ((intParam1 == intGLOB_44)) {
																										talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
																										if ((sub79() && GetIsTalentValid(talRandom))) {
																											return 1;
																										}
																									}
																									else {
...
talent sub42(int intParam1) {
	...
	object oRWeapItem = GetItemInSlot(4, OBJECT_SELF);
	if (((((GetLevelByClass(6, OBJECT_SELF) > 0) || (GetLevelByClass(7, OBJECT_SELF) > 0)) && (!sub43(OBJECT_SELF))) && (!GetIsObjectValid(oRWeapItem)))) {
		object oLArmItem = GetItemInSlot(7, OBJECT_SELF);
		object oRArmItem = GetItemInSlot(8, OBJECT_SELF);
		int int9 = 1;
...
int sub40(object objectParam1) {
	...
	oNPC = sub41();
	if (GetIsObjectValid(oNPC)) {
		if (sub22(intGLOB_125, oNPC)) {
			return 1;
		}
	}
	oNPC = sub21();
	if (GetIsObjectValid(oNPC)) {
		if (sub22(intGLOB_126, oNPC)) {
			return 1;
		}
	}
	talent1 = sub42(0);
...
int sub22(int intParam1, object objectParam2) {
	if (GetIsObjectValid(objectParam2)) {
			...
			if ((intParam1 == intGLOB_125)) {
				...
				if ((intParam1 == intGLOB_126)) {
					...
					if (((GetCreatureHasTalent(talSpell, OBJECT_SELF) || GetCreatureHasTalent(talent2, OBJECT_SELF)) || GetCreatureHasTalent(talent3, OBJECT_SELF))) {
						sub12("GENERIC DEBUG *************** I have Heal, Improved Heal, or Master Heal");
						int3 = 1;
		...
		if (((int3 == 1) && (int4 == 0))) {
			...
			sub12(("GENERIC DEBUG *************** Spells.2DA ID = " + sub17(int56)));
			ClearAllActions();
...
int sub16() {
	...
	sub12(((("GENERIC DEBUG *************** Shield Boolean (" + sub17(intGLOB_117)) + ") = ") + sub17(sub7(intGLOB_117))));
	if (((sub7(intGLOB_117) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		...
		if (int6) {
			...
			sub12("GENERIC DEBUG *************** Forcefield Search Fallthrough");
			sub5(intGLOB_117, 1);
			return 0;
		}
	}
	...
	sub14();
	{
		...
		if (((GetPartyMemberByIndex(0) != OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF)))) {
			if (((IsObjectPartyMember(OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF))) || (!IsObjectPartyMember(OBJECT_SELF)))) {
				...
				if ((sub16() == 1)) {
					sub12("GENERIC DEBUG *************** Terminating AI from Shields");
					return;
				}
				if ((sub18() == 1)) {
					return;
		...
		if (((nLocal < 10) && (nLocal > 0))) {
			...
			if ((nLocal == 0)) {
				if (sub7(intGLOB_58)) {
					...
					if (sub7(intGLOB_54)) {
						int int11 = sub8(OBJECT_SELF, int6);
						if (((int11 > 0) && (int11 < 10))) {
	...
	if ((int1 == 1001)) {
		...
		if ((int1 == 1002)) {
			...
			if ((int1 == 1003)) {
				...
				if ((int1 == 1004)) {
					AurPostString("ON DIALOGUE", 5, 6, 1.0);
				}
				else {
					if ((int1 == 1005)) {
					}
						...
						if ((int1 == 1006)) {
							AurPostString("bma - user damaged", 8, 7, 2.0);
							sub1();
						}
						else {
							if ((int1 == 1007)) {
								AurPostString("bma - user death", 8, 8, 2.0);
								sub1();
								ActionDoCommand(sub3(GetTag(OBJECT_SELF), 5.0, 1));
								...
								if ((int1 == 1008)) {
									...
									if ((int1 == 1009)) {
										...
										if ((int1 == 1010)) {
											...
											if ((int1 == 1011)) {
												AurPostString("DIALOGUE END", 5, 7, 1.0);
												if ((GetLocalNumber(OBJECT_SELF, 27) == 0)) {
													sub4(OBJECT_SELF);
												}
												else {
													if ((GetLocalNumber(OBJECT_SELF, 27) == 2)) {
														ClearAllActions();
														ChangeToStandardFaction(OBJECT_SELF, 2);
														sub5(intGLOB_61, 0);
														sub6();
														sub11(OBJECT_INVALID);
													}
												}
											}
											else {
