...
void main() {
	...
	if ((nParam1 == 1)) {
		...
		if ((nParam1 == 2)) {
			...
			DelayCommand(1.0, AssignCommand(oDrdTank, sub1()));
			...
			if ((nParam1 == 3)) {
				...
				while (GetIsObjectValid(oG_drd_inact)) {
					...
					DelayCommand(0.1, AssignCommand(oG_drd_inact, ActionForceMoveToLocation(GetLocation(GetObjectByTag("WP_inactive_droid", 0)), 0, 30.0)));
					DelayCommand(0.1, ChangeToStandardFaction(oG_drd_inact, 1));
					(int5++);
				...
				if ((nParam1 == 4)) {
					object object13 = GetObjectByTag("DrdTank", 0);
					object oWP_DrdTank_01 = GetObjectByTag("WP_DrdTank_01", 0);
					AssignCommand(object13, ClearAllActions());
					AssignCommand(object13, ActionJumpToLocation(GetLocation(oWP_DrdTank_01)));
					AssignCommand(object13, sub5(intGLOB_61, 0));
					AssignCommand(object13, sub1());
					DelayCommand(1.0, ChangeToStandardFaction(object13, 1));
				}
			}
		}
	}
