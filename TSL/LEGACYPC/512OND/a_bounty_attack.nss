...
void main() {
	...
	switch (nParam1) {
		case 0:
			...
			int3 = 0;
			while ((int3 <= 5)) {
				oThug_grenade = GetObjectByTag("thug_gun", int3);
				DelayCommand(0.2, ChangeToStandardFaction(oThug_grenade, 1));
				DelayCommand(0.3, AssignCommand(oThug_grenade, sub1(OBJECT_INVALID)));
				(int3++);
			}
			int3 = 0;
			while ((int3 <= 5)) {
				oThug_grenade = GetObjectByTag("thug_melee", int3);
				DelayCommand(0.2, ChangeToStandardFaction(oThug_grenade, 1));
				DelayCommand(0.3, AssignCommand(oThug_grenade, sub1(OBJECT_INVALID)));
				(int3++);
			}
			int3 = 0;
			while ((int3 <= 5)) {
				oThug_grenade = GetObjectByTag("thug_grenade", int3);
				DelayCommand(0.2, ChangeToStandardFaction(oThug_grenade, 1));
				DelayCommand(0.3, AssignCommand(oThug_grenade, sub1(OBJECT_INVALID)));
				(int3++);
			}
