...
// Prototypes
void sub20();
void sub19(int intParam1, int intParam2);
int sub18(int intParam1, int intParam2);
int sub17(object objectParam1, int intParam2);
void sub16();
void sub15(object objectParam1, int intParam2, int intParam3);
			...
			if ((nRandom == 3)) {
				...
				if ((((nRandom == 4) || (nRandom == 5)) && (GetRacialType(OBJECT_SELF) != 5))) {
					if ((GetGender(OBJECT_SELF) == 0)) {
						...
						ActionDoCommand(sub19(intGLOB_52, 1));
					}
					else {
...
string sub7(int intParam1, int intParam2) {
	string string1 = sub8((intParam1 + 5), intParam2);
	return string1;
}
		...
		while ((int2 <= intParam2)) {
			{
				...
				if (sub10(int3, 0, 85)) {
					...
					if (sub10(int3, 86, 100)) {
						string1 = sub14(int6, intParam3);
					}
				}
				}
...
void sub5(object objectParam1, int intParam2, int intParam3) {
	...
	if ((int1 > 90)) {
		...
		if ((int1 > 80)) {
			...
			IncrementGlobalNumber("000_RareItemChance", 3);
			sub15(objectParam1, intParam2, 900);
		}
	}
}
