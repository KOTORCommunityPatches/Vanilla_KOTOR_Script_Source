...
int sub5(int intParam1, int intParam2, int intParam3);
...
void sub14() {
	if ((!sub13(intGLOB_61))) {
		...
		if (GetIsObjectValid(GetWaypointByTag(string11))) {
			...
			ActionForceMoveToObject(object3, sub13(intGLOB_59), fPersonalSpace, float4);
			if (sub13(intGLOB_52)) {
...
void sub11() {
	...
	sub12();
	if ((sub13(intGLOB_122) || GetIsEncounterCreature(OBJECT_SELF))) {
		string string1;
		int int5 = 1;
		object object1;
		object object2;
...
string sub6(int intParam1, int intParam2) {
	...
	if ((intParam2 == 0)) {
		int2 = (Random(0) + 9);
		string1 = sub6(intParam1, (int2 * 100));
	}
	else {
		if (((intParam2 % 100) == 0)) {
			...
			int2 = (Random(int1) + 1);
			string1 = sub6(intParam1, (intParam2 + (10 * int2)));
		}
		else {
			if (((intParam2 % 10) == 0)) {
				switch ((intParam2 / 10)) {
				...
				int2 = (Random(int1) + 1);
				string1 = sub7(intParam1, (intParam2 + int2));
			}
			else {
				string1 = sub7(intParam1, intParam2);
			}
		}
	}
	return string1;
	...
	if ((intParam2 == 0)) {
		...
		if (((intParam2 % 100) == 0)) {
			...
			if (((intParam2 % 10) == 0)) {
				...
				string3 = (sub4(intParam2) + string1);
			}
		}
	}
	return string3;
...
string sub2(int intParam1, int intParam2) {
	string string1 = sub3((intParam1 + 5), intParam2);
	return string1;
}
