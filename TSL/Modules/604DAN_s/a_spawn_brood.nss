...
void main() {
	...
	int int1;
	if (((!GetLocalBoolean(oTr_kreia_crystal, 50)) && (GetJournalEntry("cavecrawl") <= 10))) {
		SetLocalBoolean(oTr_kreia_crystal, 50, 1);
		int1 = 0;
		while ((int1 <= 8)) {
		...
		if (((GetJournalEntry("cavecrawl") == 10) && (!GetLocalBoolean(oTr_kreia_crystal, 51)))) {
			SetLocalBoolean(oTr_kreia_crystal, 51, 1);
			...
			if (((!GetLocalBoolean(oTr_kreia_crystal, 52)) && (GetJournalEntry("cavecrawl") != 10))) {
				SetLocalBoolean(oTr_kreia_crystal, 52, 1);
				DelayCommand(0.5, AssignCommand(oTr_kreia_crystal, ActionStartConversation(GetFirstPC(), "brood", 0, 0, 1, "", "", "", "", "", "", 0, 0xFFFFFFFF, 0xFFFFFFFF, 0)));
			}
			else {
				int1 = 0;
