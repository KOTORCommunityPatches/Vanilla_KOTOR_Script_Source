...
void main() {
	if ((GetLocalBoolean(OBJECT_SELF, 59) == 0)) {
		SetLocalBoolean(OBJECT_SELF, 59, 1);
		int int2 = 15;
		int int3;
		int int4 = 1;
		string string1;
		sub1((Random(15) + 1), 240);
		CreateItemOnObject("a_medium_05", GetObjectByTag("m_202_002", 0), 1, 0);
		CreateItemOnObject("a_belt_10", GetObjectByTag("m_202_002", 0), 1, 0);
		CreateItemOnObject("a_glove_07", GetObjectByTag("m_202_002", 0), 1, 0);
		CreateItemOnObject("u_m_edge_05", GetObjectByTag("m_202_002", 0), 1, 0);
		CreateItemOnObject("u_r_targ_04", GetObjectByTag("m_202_002", 0), 1, 0);
		CreateItemOnObject("w_brifle_13", GetObjectByTag("m_202_002", 0), 1, 0);
		int2;
		while ((int2 < 22)) {
			{
				string string3 = sub1(int2, 0);
				if ((int3 = FindSubString(string3, "[") >= 0)) {
				int4 = StringToInt(GetSubString(string3, (int3 + 1), 4));
				string1 = GetSubString(string3, 0, int3);
				}
				else {
				string1 = string3;
				}
				CreateItemOnObject(string1, GetObjectByTag("m_202_002", 0), int4, 0);
			}
			int2 = (int2 + 1);
		}
	}
