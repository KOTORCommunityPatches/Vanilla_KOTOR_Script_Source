...
void main() {
	...
	if ((GetGlobalNumber("411DXN_Complete") == 1)) {
		if ((((!GetLocalBoolean(GetObjectByTag("From_402DXN", 0), 55)) && GetIsObjectValid(oKreia)) && GetIsObjectValid(GetFirstPC()))) {
			...
			int43 = 0;
			while ((int43 < 12)) {
				if ((((int43 != GetGlobalNumber("403DXN_PARTY2_NPC1")) && (int43 != GetGlobalNumber("403DXN_PARTY2_NPC2"))) && (int43 != GetGlobalNumber("403DXN_PARTY2_NPC3")))) {
					SetNPCSelectability(int43, 1);
				}
				else {
					SetNPCSelectability(int43, 0);
				}
				(int43++);
			}
		}
