void main() {
	...
	CreateObject(1, "n_Zhug008", GetLocation(GetObjectByTag("WP_VOSSK_ZHUG1_0", 0)), 0);
	...
	CreateObject(1, "n_Zhug014", GetLocation(GetObjectByTag("WP_VOSSK_ZHUG7_0", 0)), 0);
	CreateObject(1, "n_Zhug015", GetLocation(GetObjectByTag("WP_VOSSK_ZHUG8_0", 0)), 0);
	CreateObject(1, "n_Zhug016", GetLocation(GetObjectByTag("WP_VOSSK_ZHUG9_0", 0)), 0);
