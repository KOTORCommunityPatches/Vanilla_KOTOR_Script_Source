void main() {
	...
	if (((nGlobal == 1) && (int7 == 1))) {
		AddJournalQuestEntry("NewTradeRoutes", 33, 1);
		return;
	}
	if ((nGlobal == 1)) {
		if ((int3 == 0)) {
		...
		if ((int3 == 1)) {
			AddJournalQuestEntry("NewTradeRoutes", 21, 1);
			return;
		}
	}
	if ((int7 == 1)) {
		if ((int1 == 0)) {
			AddJournalQuestEntry("NewTradeRoutes", 31, 1);
			return;
		}
		if ((int1 == 1)) {
			AddJournalQuestEntry("NewTradeRoutes", 12, 1);
			return;
		}
	}
	if (((int3 == 1) && (int1 == 1))) {
		AddJournalQuestEntry("NewTradeRoutes", 22, 1);
		return;
	}
	if ((int3 == 1)) {
		AddJournalQuestEntry("NewTradeRoutes", 21, 1);
