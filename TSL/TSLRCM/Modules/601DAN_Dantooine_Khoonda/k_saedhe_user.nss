...
void main() {
	...
	if ((int1 == 1001)) {
		if (((!GetLocalBoolean(OBJECT_SELF, 29)) && (GetGlobalNumber("602DAN_End") == 0))) {
			SetFacing(180.0);
			PlayAnimation(10471, 1.0, 0.0);
		}
	}
	else {
		if ((int1 == 1002)) {
			...
			if ((int1 == 1003)) {
				...
				if ((int1 == 1004)) {
					AurPostString("Stopping search animation", 5, 5, 5.0);
								...
								if ((int1 == 1008)) {
									...
									if ((int1 == 1009)) {
										...
										if ((int1 == 1010)) {
											...
											if ((int1 == 1011)) {
												AurPostString("Restarting search animation", 5, 6, 5.0);
												SetLocalBoolean(OBJECT_SELF, 29, 0);
											}
											else {
												if ((int1 == intGLOB_149)) {
													sub1("wp_homebase");
