...
void main() {
	...
	DelayCommand(0.1, AssignCommand(oMand, ActionJumpToObject(GetObjectByTag("wp_npc_mand_start", 0), 1)));
	object oVisasMarr = GetObjectByTag("VisasMarr", 0);
	AssignCommand(oVisasMarr, ClearAllActions());
	DelayCommand(0.1, AssignCommand(oVisasMarr, ActionJumpToObject(GetObjectByTag("wp_npc_visas_start", 0), 1)));
	DelayCommand(0.1, AssignCommand(GetFirstPC(), ActionJumpToObject(GetObjectByTag("wp_pc_start", 0), 1)));
	AddPartyMember(9, oVisasMarr);
	AddPartyMember(2, oMand);
