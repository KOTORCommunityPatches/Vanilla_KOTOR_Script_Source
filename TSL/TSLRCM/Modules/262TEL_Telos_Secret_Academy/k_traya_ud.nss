					...
					if ((int1 == 1005)) {
						...
						if ((int1 == 1006)) {
							...
							if ((nCurHP < 10)) {
								...
								CancelCombat(GetNextPC());
								CancelCombat(GetNextPC());
								AssignCommand(GetFirstPC(), ClearAllActions());
								AssignCommand(GetFirstPC(), ActionWait(1.0));
								if ((!GetLocalBoolean(OBJECT_SELF, 50))) {
									...
									DelayCommand(1.0, ActionStartConversation(GetFirstPC(), "atrend3", 0, 0, 0, "", "", "", "", "", "", 0, 0xFFFFFFFF, 0xFFFFFFFF, 0));
