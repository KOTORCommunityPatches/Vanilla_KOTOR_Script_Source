...
void main() {
	if (((!GetLocalBoolean(OBJECT_SELF, 31)) && (GetLastPerceived() == GetPartyLeader()))) {
		ClearAllActions();
		SetLocalBoolean(OBJECT_SELF, 31, 1);
		object oZhugThug2 = GetObjectByTag("ZhugThug2", 0);
		object oZhugThug3 = GetObjectByTag("ZhugThug3", 0);
		object oZhugThug4 = GetObjectByTag("ZhugThug4", 0);
		object oZhugThug6 = GetObjectByTag("ZhugThug6", 0);
		object oZhugThug7 = GetObjectByTag("ZhugThug7", 0);
		object oGandFind2 = GetObjectByTag("GandFind2", 0);
		object oGand1 = GetObjectByTag("Gand1", 0);
		object oGand2 = GetObjectByTag("Gand2", 0);
		AssignCommand(oZhugThug2, ActionMoveToLocation(Location(Vector((-3.0), 21.0, 0.0), 90.0), 1));
		AssignCommand(oZhugThug3, ActionMoveToLocation(Location(Vector((-6.0), 29.0, 0.0), 45.0), 1));
		AssignCommand(oZhugThug4, ActionMoveToLocation(Location(Vector(0.0, 21.0, 0.0), 90.0), 1));
		AssignCommand(OBJECT_SELF, ActionMoveToLocation(Location(Vector(3.0, 29.0, 0.0), 135.0), 1));
		AssignCommand(oZhugThug6, ActionMoveToLocation(Location(Vector((-4.0), 25.0, 0.0), 90.0), 1));
		AssignCommand(oZhugThug7, ActionMoveToLocation(Location(Vector(1.0, 25.0, 0.0), 90.0), 1));
		DelayCommand(2.0, AssignCommand(oZhugThug2, ActionDoCommand(SetFacingPoint(GetPosition(GetPartyLeader())))));
		DelayCommand(2.0, AssignCommand(oZhugThug3, ActionDoCommand(SetFacingPoint(GetPosition(GetPartyLeader())))));
		DelayCommand(2.0, AssignCommand(oZhugThug4, ActionDoCommand(SetFacingPoint(GetPosition(GetPartyLeader())))));
		DelayCommand(2.0, AssignCommand(OBJECT_SELF, ActionDoCommand(SetFacingPoint(GetPosition(GetPartyLeader())))));
		DelayCommand(2.0, AssignCommand(oZhugThug6, ActionDoCommand(SetFacingPoint(GetPosition(GetPartyLeader())))));
		DelayCommand(2.0, AssignCommand(oZhugThug7, ActionDoCommand(SetFacingPoint(GetPosition(GetPartyLeader())))));
		DelayCommand(3.0, ChangeToStandardFaction(oZhugThug2, 1));
		DelayCommand(3.0, ChangeToStandardFaction(oZhugThug3, 1));
		DelayCommand(3.0, ChangeToStandardFaction(oZhugThug4, 1));
		DelayCommand(3.0, ChangeToStandardFaction(OBJECT_SELF, 1));
		DelayCommand(3.0, ChangeToStandardFaction(oZhugThug6, 1));
		DelayCommand(3.0, ChangeToStandardFaction(oZhugThug7, 1));
		DelayCommand(3.0, ChangeToStandardFaction(oGandFind2, 1));
		DelayCommand(3.0, ChangeToStandardFaction(oGand1, 1));
		DelayCommand(3.0, ChangeToStandardFaction(oGand2, 1));
		DelayCommand(3.0, AssignCommand(oZhugThug2, sub1(GetPartyLeader())));
		DelayCommand(3.0, AssignCommand(oZhugThug3, sub1(GetPartyLeader())));
		DelayCommand(3.0, AssignCommand(oZhugThug4, sub1(GetPartyLeader())));
		DelayCommand(3.0, AssignCommand(OBJECT_SELF, sub1(GetPartyLeader())));
		DelayCommand(3.0, AssignCommand(oZhugThug6, sub1(GetPartyLeader())));
		DelayCommand(3.0, AssignCommand(oZhugThug7, sub1(GetPartyLeader())));
	}
	else {
