								...
								if ((int1 == 1008)) {
									...
									if ((int1 == 1009)) {
										...
										if ((int1 == 1010)) {
											...
											if ((int1 == 1011)) {
												object oPartpile = GetObjectByTag("partpile", 0);
												if (GetIsObjectValid(oPartpile)) {
													location location1 = GetLocation(oPartpile);
													vector struct2 = GetPositionFromLocation(location1);
													object oGuron = GetObjectByTag("guron", 0);
													if (GetIsObjectValid(oGuron)) {
														AssignCommand(oGuron, SetFacingPoint(struct2));
														AssignCommand(oGuron, ActionPlayAnimation(29, 1.0, (-1.0)));
													}
												}
											}
											else {
