void main() {
	...
	AssignCommand(oN_twilekf004, ActionForceMoveToObject(oWP_TWIN1_0, 0, 1.0, 30.0));
	AssignCommand(oN_twilekf005, ActionForceMoveToObject(oWP_TWIN2_0, 0, 1.0, 30.0));
	effect effect1 = EffectMovementSpeedDecrease(35);
