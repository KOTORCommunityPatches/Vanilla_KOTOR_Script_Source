void main() {
	...
	if ((((GetLocalBoolean(GetObjectByTag("attontwilek1", 0), 25) && (!GetLocalBoolean(OBJECT_SELF, 26))) && (GetGlobalNumber("302NAR_AttonTwilek") == 0)) && (GetEnteringObject() == GetFirstPC()))) {
		SetLocalBoolean(OBJECT_SELF, 26, 1);
		CreateObject(1, "n_twilekf001", GetLocation(GetObjectByTag("wp_attontwilek1b", 0)), 0);
		CreateObject(1, "n_twilekf002", GetLocation(GetObjectByTag("wp_attontwilek2b", 0)), 0);
		object object13 = GetObjectByTag("TwilekAtton01", 0);
		object oTwilekAtton02 = GetObjectByTag("TwilekAtton02", 0);
		AssignCommand(object13, ActionStartConversation(OBJECT_SELF, "attontwi2", 0, 0, 0, "", "", "", "", "", "", 0, 0xFFFFFFFF, 0xFFFFFFFF, 0));
	}
}