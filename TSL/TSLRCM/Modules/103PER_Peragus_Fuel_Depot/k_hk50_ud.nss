...
void sub7();
int sub6(int intParam1, int intParam2);
		...
		if (((nLocal < 10) && (nLocal > 0))) {
			...
			if ((nLocal == 0)) {
				if (sub4(intGLOB_58)) {
					...
					if (sub4(intGLOB_54)) {
						int int11 = sub5(OBJECT_SELF, int6);
						if (((int11 > 0) && (int11 < 10))) {
...
void main() {
	...
	if ((int1 == 1001)) {
		...
		if ((int1 == 1002)) {
			...
			if (((GetIsPC(oPerceived) && GetLastPerceptionSeen()) && GetLocalBoolean(OBJECT_SELF, 57))) {
				ClearAllActions();
				ActionWait(2.0);
				ActionBarkString(50675);
			}
		}
		else {
			if ((int1 == 1003)) {
								...
								if ((int1 == 1008)) {
									...
									if ((int1 == 1009)) {
										...
										if ((int1 == 1010)) {
											...
											if ((int1 == 1011)) {
												AurPostString("k_hk50_ud: let's walk around", 5, 5, 5.0);
												sub1(intGLOB_58, 1);
												sub1(intGLOB_54, 1);
												sub2(1);
												sub3();
