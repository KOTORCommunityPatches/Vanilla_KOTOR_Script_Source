...
void main() {
	...
	switch (nParam1) {
		...
		case 6:
			...
			DelayCommand(0.6, SetLightsaberPowered(oDarthSion, 1, 1, 1));
		...
		case 9:
			...
			SetFadeUntilScript();
			AssignCommand(oDarthSion, ClearAllActions());
			AssignCommand(oDarthSion, ActionJumpToObject(GetObjectByTag("sp_kreia", 0), 1));
			DelayCommand(0.5, AssignCommand(oKreiaEvil, ClearAllActions()));
			DelayCommand(0.5, AssignCommand(oKreiaEvil, ActionJumpToObject(GetObjectByTag("wp_kreia_start", 0), 1)));
			DelayCommand(1.0, AssignCommand(oDarthSion, ClearAllActions()));
			DelayCommand(1.0, AssignCommand(oDarthSion, ActionStartConversation(GetFirstPC(), "904sion", 0, 0, 0, "", "", "", "", "", "", 0, 0xFFFFFFFF, 0xFFFFFFFF, 0)));
			break;
		case 10:
			AssignCommand(oKreiaEvil, ClearAllActions());
			AssignCommand(oKreiaEvil, ActionPlayAnimation(10063, 1.0, (-1.0)));
			DelayCommand(0.5, AssignCommand(oDarthSion, ClearAllActions()));
			DelayCommand(0.5, AssignCommand(oDarthSion, ActionPlayAnimation(45, 1.0, (-1.0))));
			break;
		case 11:
			AssignCommand(oKreiaEvil, ClearAllActions());
			AssignCommand(oKreiaEvil, ActionPlayAnimation(10063, 1.0, 3.5));
			AssignCommand(oDarthSion, ClearAllActions());
			AssignCommand(oDarthSion, ActionPlayAnimation(45, 1.0, 3.5));
			break;
	}
}