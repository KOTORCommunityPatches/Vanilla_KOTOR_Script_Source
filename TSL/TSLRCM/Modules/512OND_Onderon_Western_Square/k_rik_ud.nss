			...
			if ((nRandom == 3)) {
				...
				if ((((nRandom == 4) || (nRandom == 5)) && (GetRacialType(OBJECT_SELF) != 5))) {
					if ((GetGender(OBJECT_SELF) == 0)) {
						...
						ActionDoCommand(sub5(intGLOB_207, 1));
					}
					else {
...
int sub3(object objectParam1, int intParam2) {
	...
	float float1 = 0.0;
	int nLocal = GetLocalNumber(OBJECT_SELF, intGLOB_206);
	if ((nLocal > 0)) {
		string string3;
		if ((nLocal < 10)) {
...
void sub1() {
	if ((!sub2(intGLOB_216))) {
		...
		string string2 = "WP_";
		string string3;
		int nLocal = GetLocalNumber(OBJECT_SELF, intGLOB_204);
		int int4 = GetLocalNumber(OBJECT_SELF, intGLOB_205);
		int int6 = GetLocalNumber(OBJECT_SELF, intGLOB_206);
		...
		if (GetIsObjectValid(GetWaypointByTag(string11))) {
			...
			ActionForceMoveToObject(object3, sub2(intGLOB_214), fPersonalSpace, float4);
			if (sub2(intGLOB_207)) {
				ActionDoCommand(sub6());
			}
			SetLocalNumber(OBJECT_SELF, intGLOB_204, nLocal);
			if ((string2 != "UNKNOWN")) {
				if ((nRandom > 0)) {
				...
				if ((int1 == 1004)) {
					...
					if ((int1 == 1005)) {
						...
						if ((int1 == 1006)) {
							...
							if ((int1 == 1007)) {
								if ((GetJournalEntry("matter_leader") >= 10)) {
									AddJournalQuestEntry("matter_leader", (GetJournalEntry("matter_leader") + 10), 0);
								}
								SetGlobalNumber("502OND_Captain_Killer", (GetGlobalNumber("502OND_Captain_Killer") + 1));
								if (GetLocalBoolean(OBJECT_SELF, 40)) {
									SetGlobalNumber("512OND_Riiken_Patrol", 2);
								}
								else {
									object oNearestThug_beast = GetNearestObjectByTag("thug_beast", OBJECT_SELF, 1);
									AssignCommand(oNearestThug_beast, ActionForceMoveToObject(GetFirstPC(), 1, 5.0, 30.0));
									DelayCommand(1.0, AssignCommand(oNearestThug_beast, ActionStartConversation(GetFirstPC(), "ri_end", 0, 0, 0, "", "", "", "", "", "", 0, 0xFFFFFFFF, 0xFFFFFFFF, 0)));
								}
							}
							else {
								if ((int1 == 1008)) {
									...
									if ((int1 == 1009)) {
										...
										if ((int1 == 1010)) {
											...
											if ((int1 == 1011)) {
												DelayCommand(1.2, ActionDoCommand(sub1()));
											}
											else {
												if ((int1 == intGLOB_149)) {
													sub7("wp_homebase");
