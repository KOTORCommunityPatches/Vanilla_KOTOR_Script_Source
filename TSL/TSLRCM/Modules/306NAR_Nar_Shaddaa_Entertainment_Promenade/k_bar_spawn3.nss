...
// Prototypes
void sub18();
void sub17(int intParam1, int intParam2);
int sub16(int intParam1, int intParam2);
...
int sub9(int intParam1, int intParam2, int intParam3);
			...
			if ((nRandom == 3)) {
				...
				if ((((nRandom == 4) || (nRandom == 5)) && (GetRacialType(OBJECT_SELF) != 5))) {
					if ((GetGender(OBJECT_SELF) == 0)) {
						...
						ActionDoCommand(sub17(intGLOB_52, 1));
					}
					else {
		...
		if (((nLocal < 10) && (nLocal > 0))) {
			...
			if ((nLocal == 0)) {
				if (sub4(intGLOB_58)) {
					...
					if (sub4(intGLOB_54)) {
						int int11 = sub15(OBJECT_SELF, int6);
						if (((int11 > 0) && (int11 < 10))) {
...
string sub10(int intParam1, int intParam2) {
	...
	if ((intParam2 == 0)) {
		int2 = (Random(0) + 9);
		string1 = sub10(intParam1, (int2 * 100));
	}
	else {
		if (((intParam2 % 100) == 0)) {
			...
			int2 = (Random(int1) + 1);
			string1 = sub10(intParam1, (intParam2 + (10 * int2)));
		}
		else {
			if (((intParam2 % 10) == 0)) {
				switch ((intParam2 / 10)) {
				...
				int2 = (Random(int1) + 1);
				string1 = sub11(intParam1, (intParam2 + int2));
			}
			else {
				string1 = sub11(intParam1, intParam2);
			}
		}
	}
	return string1;
	...
	if ((intParam2 == 0)) {
		...
		if (((intParam2 % 100) == 0)) {
			...
			if (((intParam2 % 10) == 0)) {
				...
				string3 = (sub8(intParam2) + string1);
			}
		}
	}
	return string3;
...
string sub6(int intParam1, int intParam2) {
	string string1 = sub7((intParam1 + 5), intParam2);
	return string1;
}
...
void main() {
	...
	sub14();
	DelayCommand(1.2, AssignCommand(OBJECT_SELF, ActionPlayAnimation(37, 1.0, (-1.0))));
