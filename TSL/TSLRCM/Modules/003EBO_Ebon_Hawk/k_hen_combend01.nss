...
void main() {
	if (((((GetModuleName() == "003EBO") && (GetObjectByTag("VisasMarr", 0) == OBJECT_SELF)) && (GetGlobalNumber("003_Visas_Training") == 2)) && (GetItemInSlot(5, GetFirstPC()) == OBJECT_INVALID))) {
		...
		ExecuteScript("k_ai_master", OBJECT_SELF, intGLOB_15);
	}
}