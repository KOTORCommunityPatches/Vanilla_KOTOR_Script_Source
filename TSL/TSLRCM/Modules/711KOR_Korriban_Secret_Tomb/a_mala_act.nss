			...
			if ((nRandom == 3)) {
				...
				if ((((nRandom == 4) || (nRandom == 5)) && (GetRacialType(OBJECT_SELF) != 5))) {
					if ((GetGender(OBJECT_SELF) == 0)) {
						...
						ActionDoCommand(sub11(intGLOB_79, 1));
					}
					else {
...
void sub99() {
	if ((!sub8(intGLOB_88))) {
		...
		if (GetIsObjectValid(GetWaypointByTag(string11))) {
			...
			ActionForceMoveToObject(object3, sub8(intGLOB_86), fPersonalSpace, float4);
			if (sub8(intGLOB_79)) {
...
int sub96() {
	...
	if ((sub8(intGLOB_139) && (!sub8(intGLOB_140)))) {
		if (sub97()) {
			return 1;
		}
	}
	...
	if (((!IsObjectPartyMember(OBJECT_SELF)) && (sub8(intGLOB_88) == 1))) {
	...
	if ((d100(1) < 20)) {
		if ((GetIsTalentValid(talRandom) && GetCreatureHasTalent(talRandom, OBJECT_SELF))) {
			if ((GetIsObjectValid(objectParam1) && GetIsEnemy(objectParam1, OBJECT_SELF))) {
				sub4("GENERIC DEBUG *************** Using Talent on Intruder Target");
				...
				object oNearest = GetNearestCreature(3, 1, OBJECT_SELF, 1, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF);
				if (GetIsObjectValid(oNearest)) {
					sub4("GENERIC DEBUG *************** Using Talent on Determined Target");
...
int sub85(object objectParam1) {
	...
	if ((sub86() != (-1))) {
		...
		if (int8) {
			...
			if (sub16(intGLOB_155, GetFirstPC())) {
				return 1;
			}
		}
	}
	if (GetIsObjectValid(object1)) {
		if (sub16(intGLOB_152, object1)) {
			return 1;
		}
	}
	object object9 = sub15();
	if (GetIsObjectValid(object9)) {
		if (sub16(intGLOB_153, object9)) {
			return 1;
		}
	}
	if (sub16(intGLOB_154, OBJECT_SELF)) {
		return 1;
	}
	object3 = sub30();
	...
	if ((GetIsObjectValid(oTarget) && (!GetIsDead(oTarget)))) {
		...
		if ((fDistance < 3.5)) {
			...
			if (GetIsInCombat(OBJECT_SELF, 0)) {
				DelayCommand(3.0, sub3(objectParam1));
			}
		}
		else {
			int nAction = GetCurrentAction(OBJECT_SELF);
	...
	if (((structGLOB_1.int13 == 4) || (structGLOB_1.int13 == 0))) {
		...
		if ((nRandom > 0)) {
			if ((((((((((GetLevelByClass(4, OBJECT_SELF) > 0) || (GetLevelByClass(3, OBJECT_SELF) > 0)) || (GetLevelByClass(5, OBJECT_SELF) > 0)) || (GetLevelByClass(11, OBJECT_SELF) > 0)) || (GetLevelByClass(12, OBJECT_SELF) > 0)) || (GetLevelByClass(13, OBJECT_SELF) > 0)) || (GetLevelByClass(14, OBJECT_SELF) > 0)) || (GetLevelByClass(15, OBJECT_SELF) > 0)) || (GetLevelByClass(16, OBJECT_SELF) > 0))) {
				...
				sub4(("GENERIC DEBUG *************** Starting Jedi Combo " + sub75(int2)));
				...
				if (((GetLevelByClass(6, OBJECT_SELF) > 0) || (GetLevelByClass(7, OBJECT_SELF) > 0))) {
					...
					sub4(("GENERIC DEBUG *************** Starting Droid Combo " + sub75(int2)));
					SetLocalNumber(OBJECT_SELF, intGLOB_35, 1);
					SetLocalNumber(OBJECT_SELF, intGLOB_34, int2);
					return sub38(int2);
				}
					...
					sub4(("GENERIC DEBUG *************** Starting NPC Combo " + sub75(int2)));
					SetLocalNumber(OBJECT_SELF, intGLOB_35, 1);
					SetLocalNumber(OBJECT_SELF, intGLOB_34, int2);
					return sub38(int2);
				}
		...
		sub4(("GENERIC DEBUG *************** Continuing Combo " + sub75(structGLOB_1.int15)));
...
int sub34(object objectParam1) {
	...
	oNPC = sub35();
	if (GetIsObjectValid(oNPC)) {
		if (sub16(intGLOB_152, oNPC)) {
			return 1;
		}
	}
	oNPC = sub15();
	if (GetIsObjectValid(oNPC)) {
		if (sub16(intGLOB_153, oNPC)) {
			return 1;
		}
	}
	talent1 = sub36(0);
...
int sub16(int intParam1, object objectParam2) {
	if (GetIsObjectValid(objectParam2)) {
			...
			if ((intParam1 == intGLOB_152)) {
				...
				if ((intParam1 == intGLOB_153)) {
					...
					if (((GetCreatureHasTalent(talSpell, OBJECT_SELF) || GetCreatureHasTalent(talent2, OBJECT_SELF)) || GetCreatureHasTalent(talent3, OBJECT_SELF))) {
						sub4("GENERIC DEBUG *************** I have Heal, Improved Heal, or Master Heal");
						int3 = 1;
		...
		if (((int3 == 1) && (int4 == 0))) {
			...
			sub4(("GENERIC DEBUG *************** Spells.2DA ID = " + sub10(int56)));
			ClearAllActions();
...
int sub12() {
	int int1 = 0;
	if (((sub8(intGLOB_146) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		if (((GetHitDice(GetFirstPC()) >= 15) || sub8(intGLOB_143))) {
...
int sub9() {
	...
	sub4(((("GENERIC DEBUG *************** Shield Boolean (" + sub10(intGLOB_144)) + ") = ") + sub10(sub8(intGLOB_144))));
	if (((sub8(intGLOB_144) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		int int4;
		int int5;
		int int6 = 0;
		talent talSpell;
...
void sub3(object objectParam1) {
	...
	sub6();
	{
		...
		if (((((!sub8(intGLOB_139)) && (!sub8(intGLOB_140))) && (!sub8(intGLOB_141))) && (!GetUserActionsPending()))) {
		if (((GetPartyMemberByIndex(0) != OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF)))) {
			if (((IsObjectPartyMember(OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF))) || (!IsObjectPartyMember(OBJECT_SELF)))) {
				...
				if ((sub8(intGLOB_148) == 1)) {
					if ((sub13() == 1)) {
						return;
					}
				}
				if ((sub8(intGLOB_143) == 1)) {
	...
	switch (nParam1) {
		...
		case 3:
			...
			while ((int3 <= 5)) {
				...
				object1 = GetObjectByTag(("g_jedi" + IntToString(int3)), 0);
				if (GetIsObjectValid(object1)) {
					DelayCommand(0.2, ChangeToStandardFaction(object1, 1));
					DelayCommand(0.2, AssignCommand(object1, ActionAttack(GetFirstPC(), 0)));
				}
				(int3++);
			}
			DelayCommand(0.3, sub3(OBJECT_INVALID));
			break;
	}
}