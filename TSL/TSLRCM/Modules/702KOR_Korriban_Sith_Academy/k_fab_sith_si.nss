...
void sub103() {
	...
	sub104();
	if ((sub7(intGLOB_122) || GetIsEncounterCreature(OBJECT_SELF))) {
		string string1;
		int int5 = 1;
		object object1;
		object object2;
...
void main() {
	...
	DelayCommand(2.0, EnableRendering(OBJECT_SELF, 1));
	DelayCommand(2.0, ChangeToStandardFaction(OBJECT_SELF, 1));
	DelayCommand(2.0, sub2(OBJECT_INVALID));
	sub102(intGLOB_84);
	sub103();
	sub97();
}