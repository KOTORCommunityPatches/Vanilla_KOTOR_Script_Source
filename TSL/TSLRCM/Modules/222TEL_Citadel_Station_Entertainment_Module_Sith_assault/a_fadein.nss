void main() {
	...
	ActionDoCommand(ActionForceMoveToLocation(GetLocation(GetObjectByTag("wp_carth_walk", 0)), 0, 30.0));
	ActionDoCommand(ActionForceMoveToLocation(GetLocation(GetObjectByTag("wp_carth_jump", 0)), 0, 30.0));
}