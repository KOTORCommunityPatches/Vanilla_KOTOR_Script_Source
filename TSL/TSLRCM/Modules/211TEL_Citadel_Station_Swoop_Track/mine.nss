	...
	if (((nGlobal > 0) && (!SWMG_GetIsInvulnerable(object1)))) {
		...
		switch (int7) {
			...
			case 4:
				...
				SoundObjectPlay(oDamage);
				SWMG_PlayAnimation(object1, ("cDistL" + IntToString(int7)), 0, 0, 0);
				SWMG_PlayAnimation(object1, "damage", 0, 0, 1);
				SWMG_PlayAnimation(object1, (("gear" + IntToString(int7)) + "l"), 1, 0, 1);
				int int12 = SWMG_GetHitPoints(object1);
				int int14 = (int12 - int4);
				if ((int14 < 0)) {
					int14 = 0;
				}
				SetLocalNumber(GetObjectByTag("racedialog", 0), intGLOB_12, FloatToInt(((100.0 * int14) / SWMG_GetMaxHitPoints(object1))));
				SWMG_SetFollowerHitPoints(object1, int14);
