	...
	if (((structGLOB_1.int13 == 4) || (structGLOB_1.int13 == 0))) {
		...
		if ((nRandom > 0)) {
			if ((((((((((GetLevelByClass(4, OBJECT_SELF) > 0) || (GetLevelByClass(3, OBJECT_SELF) > 0)) || (GetLevelByClass(5, OBJECT_SELF) > 0)) || (GetLevelByClass(11, OBJECT_SELF) > 0)) || (GetLevelByClass(12, OBJECT_SELF) > 0)) || (GetLevelByClass(13, OBJECT_SELF) > 0)) || (GetLevelByClass(14, OBJECT_SELF) > 0)) || (GetLevelByClass(15, OBJECT_SELF) > 0)) || (GetLevelByClass(16, OBJECT_SELF) > 0))) {
				...
				sub3(("GENERIC DEBUG *************** Starting Jedi Combo " + sub73(int2)));
				...
				if (((GetLevelByClass(6, OBJECT_SELF) > 0) || (GetLevelByClass(7, OBJECT_SELF) > 0))) {
					...
					sub3(("GENERIC DEBUG *************** Starting Droid Combo " + sub73(int2)));
					SetLocalNumber(OBJECT_SELF, intGLOB_8, 1);
					SetLocalNumber(OBJECT_SELF, intGLOB_7, int2);
					return sub36(int2);
				}
					...
					sub3(("GENERIC DEBUG *************** Starting NPC Combo " + sub73(int2)));
					SetLocalNumber(OBJECT_SELF, intGLOB_8, 1);
					SetLocalNumber(OBJECT_SELF, intGLOB_7, int2);
					return sub36(int2);
				}
		...
		sub3(("GENERIC DEBUG *************** Continuing Combo " + sub73(structGLOB_1.int15)));
...
void main() {
	...
	AssignCommand(oKavar, sub1(intGLOB_114, 0));
	DelayCommand(0.2, SetMinOneHP(oKavar, 1));
	DelayCommand(0.2, ChangeToStandardFaction(oKavar, 1));
	DelayCommand(0.3, sub2(OBJECT_INVALID));
	DelayCommand(0.5, AssignCommand(oKavar, ActionAttack(GetFirstPC(), 0)));
}