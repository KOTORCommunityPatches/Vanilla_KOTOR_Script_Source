					...
					if ((nParam1 == 5)) {
						...
						if ((nParam1 == 6)) {
							...
							if ((nParam1 == 7)) {
								...
								DelayCommand(2.0, AssignCommand(OBJECT_SELF, SetFacingPoint(GetPosition(GetObjectByTag("202_TSFDroid", 0)))));
								...
								if ((nParam1 == 8)) {
									...
									if ((nParam1 == 9)) {
										object object55 = GetObjectByTag("202_rem", 0);
										if (GetIsObjectValid(object55)) {
											oWP_batu_panel = GetObjectByTag("WP_batu_panel", 0);
											if (GetIsObjectValid(oWP_batu_panel)) {
												AssignCommand(object55, ActionForceMoveToObject(oWP_batu_panel, 0, 1.0, 30.0));
												AssignCommand(object55, ActionForceMoveToObject(GetObjectByTag("computerpanel", 0), 0, 1.0, 30.0));
												vector struct5 = GetPositionFromLocation(GetLocation(GetObjectByTag("computerpanel", 0)));
												AssignCommand(object55, ActionDoCommand(SetFacingPoint(struct5)));
												AssignCommand(object55, ActionPlayAnimation(15, 1.0, 2.0));
												object object60 = GetObjectByTag("wp_batu_rem_1", 0);
												struct5 = GetPositionFromLocation(GetLocation(GetFirstPC()));
												AssignCommand(object55, ActionDoCommand(SetFacingPoint(struct5)));
												AssignCommand(object55, ActionForceMoveToObject(object60, 0, 1.0, 30.0));
											}
										}
									}
								}
