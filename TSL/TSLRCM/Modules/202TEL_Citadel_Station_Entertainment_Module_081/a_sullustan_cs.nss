...
void main() {
	...
	object object9 = GetObjectByTag("guard", 1);
	object object11 = GetObjectByTag("guard", 2);
	...
	switch (nParam1) {
		case 0:
			...
			DelayCommand(0.8, ActionDoCommand(ChangeToStandardFaction(object9, 2)));
			DelayCommand(0.8, ActionDoCommand(ChangeToStandardFaction(object11, 2)));
			break;
		case 1:
		...
		case 4:
			...
			break;
		case 5:
			DelayCommand(0.5, ActionDoCommand(ChangeToStandardFaction(oGuard, 5)));
			DelayCommand(0.5, ActionDoCommand(ChangeToStandardFaction(object9, 5)));
			DelayCommand(0.5, ActionDoCommand(ChangeToStandardFaction(object11, 5)));
	}
}