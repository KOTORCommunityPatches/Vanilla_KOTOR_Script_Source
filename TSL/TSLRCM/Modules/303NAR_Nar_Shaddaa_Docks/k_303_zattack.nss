...
void main() {
	object oZhugThug1 = GetObjectByTag("ZhugThug1", 0);
	object oZhugShooter = GetObjectByTag("ZhugShooter", 0);
	object oGandFind = GetObjectByTag("GandFind", 0);
	object oGand1 = GetObjectByTag("Gand1", 0);
	object oGand2 = GetObjectByTag("Gand2", 0);
	object oGand3 = GetObjectByTag("Gand3", 0);
	object oGand4 = GetObjectByTag("Gand4", 0);
	object oGandFind2 = GetObjectByTag("GandFind2", 0);
	object object17 = GetObjectByTag("GandFind2", 1);
	object oLeader = GetPartyLeader();
	ChangeToStandardFaction(oZhugThug1, 1);
	ChangeToStandardFaction(oZhugShooter, 1);
	ChangeToStandardFaction(oGandFind, 1);
	ChangeToStandardFaction(oGand1, 1);
	ChangeToStandardFaction(oGand2, 1);
	ChangeToStandardFaction(oGand3, 1);
	ChangeToStandardFaction(oGand4, 1);
	ChangeToStandardFaction(oGandFind2, 1);
	ChangeToStandardFaction(object17, 1);
	AssignCommand(oZhugThug1, sub1(oLeader));
	AssignCommand(oZhugShooter, sub1(oLeader));
	AssignCommand(oGandFind, sub1(oLeader));
	AssignCommand(oGand1, sub1(oLeader));
	object oAreaObject = GetFirstObjectInArea(GetArea(OBJECT_SELF), 8);
	while ((oAreaObject != OBJECT_INVALID)) {
		if (((GetIsOpen(oAreaObject) && (GetTag(oAreaObject) != "door_stayopen")) && (GetTag(oAreaObject) != "flophouse_secret"))) {
