						...
						if ((int1 == 1006)) {
							if (((GetCurrentHitPoints(OBJECT_SELF) < (GetMaxHitPoints(OBJECT_SELF) / 2)) && (!GetLocalBoolean(OBJECT_SELF, 41)))) {
								...
								if ((!GetIsObjectValid(oInvisoKreia))) {
									...
									SetLocalNumber(oInvisoKreia, 12, 3);
									sub1(intGLOB_114, 1);
								...
								if (((GetCurrentHitPoints(OBJECT_SELF) == 1) && GetLocalBoolean(OBJECT_SELF, 41))) {
									...
									if ((!GetIsObjectValid(object5))) {
										...
										NoClicksFor(1.2);
										AssignCommand(object5, ActionStartConversation(GetFirstPC(), "lrn_form", 0, 0, 1, "", "", "", "", "", "", 0, 0xFFFFFFFF, 0xFFFFFFFF, 0));
									}
								}
							}
						}
