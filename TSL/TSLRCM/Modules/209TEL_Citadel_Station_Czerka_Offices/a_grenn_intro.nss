					...
					if ((nParam1 == 5)) {
						...
						if ((nParam1 == 6)) {
							...
							if ((nParam1 == 7)) {
								...
								DelayCommand(0.2, AssignCommand(oPC, ActionPlayAnimation(35, 1.0, (-1.0))));
							}
							else {
								if ((nParam1 == 8)) {
									object object47 = GetObjectByTag("kreia", 0);
									SetCreatureAILevel(object47, 3);
									AssignCommand(object47, ClearAllActions());
									AssignCommand(object47, ActionJumpToObject(GetObjectByTag("wp_sleep_kreia", 0), 1));
									AssignCommand(object47, ActionDoCommand(ResetCreatureAILevel(o203_gren)));
									object object50 = GetFirstPC();
									SetLockOrientationInDialog(object50, 1);
									AssignCommand(object50, ClearAllActions());
									AssignCommand(object50, ActionJumpToObject(GetObjectByTag("wp_sleep_pc", 0), 1));
								}
							}
						}
					}
