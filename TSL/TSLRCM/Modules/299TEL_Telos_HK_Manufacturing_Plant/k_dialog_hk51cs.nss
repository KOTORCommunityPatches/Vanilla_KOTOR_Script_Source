...
void sub102();
int sub101(int intParam1, int intParam2);
int sub100(object objectParam1, int intParam2);
void sub99();
void sub98();
int sub97();
int sub96();
int sub95(int intParam1);
int sub94(int intParam1);
int sub93(float floatParam1);
int sub92(object objectParam1);
int sub91();
int sub90(int intParam1);
int sub89(int intParam1);
object sub88(object objectParam1);
int sub87();
int sub86();
int sub85(int intParam1);
int sub84(float floatParam1);
int sub83(int intParam1);
int sub82(int intParam1);
void sub81(object objectParam1);
int sub80(int intParam1);
talent sub79(object objectParam1, talent talentParam2);
int sub78(int intParam1);
int sub77(int intParam1);
int sub76(int intParam1);
string sub75(int intParam1);
int sub74();
int sub73();
int sub72();
int sub71();
			...
			if ((nRandom == 3)) {
				...
				if ((((nRandom == 4) || (nRandom == 5)) && (GetRacialType(OBJECT_SELF) != 5))) {
					if ((GetGender(OBJECT_SELF) == 0)) {
						...
						ActionDoCommand(sub11(intGLOB_82, 1));
					}
					else {
...
int sub100(object objectParam1, int intParam2) {
	...
	float float1 = 0.0;
	int nLocal = GetLocalNumber(OBJECT_SELF, intGLOB_81);
	if ((nLocal > 0)) {
		string string3;
		if ((nLocal < 10)) {
...
void sub99() {
	if ((!sub1(intGLOB_91))) {
		...
		string string2 = "WP_";
		string string3;
		int nLocal = GetLocalNumber(OBJECT_SELF, intGLOB_79);
		int int4 = GetLocalNumber(OBJECT_SELF, intGLOB_80);
		int int6 = GetLocalNumber(OBJECT_SELF, intGLOB_81);
		if (((nLocal < 10) && (nLocal > 0))) {
			...
			if ((nLocal == 0)) {
				if (sub1(intGLOB_88)) {
					...
					if (sub1(intGLOB_84)) {
						int int11 = sub100(OBJECT_SELF, int6);
						if (((int11 > 0) && (int11 < 10))) {
		...
		if (GetIsObjectValid(GetWaypointByTag(string11))) {
			...
			ActionForceMoveToObject(object3, sub1(intGLOB_89), fPersonalSpace, float4);
			if (sub1(intGLOB_82)) {
				ActionDoCommand(sub102());
			}
			SetLocalNumber(OBJECT_SELF, intGLOB_79, nLocal);
			if ((string2 != "UNKNOWN")) {
				if ((nRandom > 0)) {
...
int sub97() {
	...
	if (GetIsObjectValid(oNearest)) {
		...
		DelayCommand(0.2, ActionDoCommand(sub98()));
		return 1;
	}
	else {
...
int sub96() {
	...
	if ((sub1(intGLOB_142) && (!sub1(intGLOB_143)))) {
		if (sub97()) {
			return 1;
		}
	}
	...
	if (((!IsObjectPartyMember(OBJECT_SELF)) && (sub1(intGLOB_91) == 1))) {
		sub2("GENERIC DEBUG *************** Clear 1100");
		ClearAllActions();
		DelayCommand(1.0, sub99());
		return 1;
	}
	else {
...
int sub94(int intParam1) {
	...
	if (((nLocal > 0) && (int7 == 1))) {
		...
		if (GetIsObjectValid(object3)) {
			ClearAllActions();
			int int18 = GetLocalNumber(OBJECT_SELF, intGLOB_43);
			if ((int18 < 1)) {
				int18 = 10;
			}
...
int sub91() {
	...
	if ((nLocal > 0)) {
		...
		if (GetIsObjectValid(object5)) {
			int11 = sub78(GetBaseItemType(object5));
		}
		if ((int11 != 2)) {
			object object7 = GetItemInSlot(18, OBJECT_SELF);
			int int15 = 0;
			if (GetIsObjectValid(object7)) {
				int15 = sub78(GetBaseItemType(object7));
			}
			if ((int15 == 2)) {
				ClearAllActions();
				ActionSwitchWeapons();
...
int sub85(int intParam1) {
	...
	if ((sub86() != (-1))) {
		...
		if (int8) {
			...
			if (sub16(intGLOB_158, GetFirstPC())) {
				return 1;
			}
		}
	}
	if (GetIsObjectValid(object1)) {
		if (sub16(intGLOB_155, object1)) {
			return 1;
		}
	}
	object object9 = sub15();
	if (GetIsObjectValid(object9)) {
		if (sub16(intGLOB_156, object9)) {
			return 1;
		}
	}
	if (sub16(intGLOB_157, OBJECT_SELF)) {
		return 1;
	}
	object3 = sub30();
	...
	if (GetIsObjectValid(object3)) {
		if ((GetRacialType(object3) == 5)) {
			talent1 = sub25(intGLOB_32, 1);
		}
		else {
			talent1 = sub25(intGLOB_32, 0);
		}
	}
	else {
		sub2("GENERIC DEBUG *************** Jedi Support AI: Inside the Party AI Section");
		object3 = sub88(OBJECT_INVALID);
		...
		if (GetIsObjectValid(object3)) {
			...
			if ((GetRacialType(object3) == 5)) {
				talent1 = sub25(intGLOB_33, 1);
			}
			else {
				talent1 = sub25(intGLOB_33, 0);
			}
		}
	}
	...
	if ((GetIsObjectValid(oTarget) && (!GetIsDead(oTarget)))) {
		...
		if ((fDistance < 3.5)) {
			...
			if (GetIsInCombat(OBJECT_SELF, 0)) {
				DelayCommand(3.0, sub6(intParam1));
			}
		}
		else {
			int nAction = GetCurrentAction(OBJECT_SELF);
...
int sub57(int intParam1) {
	if ((intParam1 == intGLOB_77)) {
		return 0;
	}
	talent talRandom;
	talent talent2;
	if ((((intParam1 == intGLOB_50) || (intParam1 == intGLOB_51)) || (intParam1 == intGLOB_52))) {
		...
		if ((intParam1 == intGLOB_49)) {
			...
			if ((((intParam1 == intGLOB_46) || (intParam1 == intGLOB_47)) || (intParam1 == intGLOB_48))) {
				...
				if ((intParam1 == intGLOB_53)) {
					...
					if ((intParam1 == intGLOB_54)) {
						...
						if ((intParam1 == intGLOB_55)) {
							...
							if ((intParam1 == intGLOB_56)) {
								talRandom = GetCreatureTalentRandom(63743, OBJECT_SELF, 0);
								if ((GetIsTalentValid(talRandom) && sub58())) {
									return 1;
								}
							}
							else {
								if ((intParam1 == intGLOB_57)) {
									talRandom = GetCreatureTalentRandom(63743, OBJECT_SELF, 0);
									talent2 = GetCreatureTalentRandom(62207, OBJECT_SELF, 0);
									if (((GetIsTalentValid(talRandom) && GetIsTalentValid(talent2)) && sub58())) {
										return 1;
									}
								}
								else {
									if ((intParam1 == intGLOB_58)) {
										...
										if ((intParam1 == intGLOB_59)) {
											...
											if ((intParam1 == intGLOB_60)) {
												talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
												if (((sub62() && sub63()) && GetIsTalentValid(talRandom))) {
													return 1;
												}
											}
											else {
												if ((intParam1 == intGLOB_61)) {
													...
													if ((intParam1 == intGLOB_62)) {
														talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
														if ((sub65() && GetIsTalentValid(talRandom))) {
															return 1;
														}
													}
													else {
														if ((intParam1 == intGLOB_63)) {
															talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
															if (((sub60() && sub66()) && GetIsTalentValid(talRandom))) {
																return 1;
															}
														}
														else {
															if ((intParam1 == intGLOB_64)) {
																if (((sub66() && sub59()) && sub67())) {
																	return 1;
																}
															}
															else {
																if ((intParam1 == intGLOB_65)) {
																	if (((sub64() && sub59()) && sub61())) {
																		return 1;
																	}
																}
																else {
																	if ((intParam1 == intGLOB_66)) {
																		if (((sub65() && sub59()) && sub61())) {
																			return 1;
																		}
																	}
																	else {
																		if ((intParam1 == intGLOB_66)) {
																			if (((sub60() && sub68()) && sub59())) {
																				return 1;
																			}
																		}
																		else {
																			if ((intParam1 == intGLOB_68)) {
																				...
																				if ((intParam1 == intGLOB_69)) {
																					...
																					if ((intParam1 == intGLOB_70)) {
																						talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
																						if (((sub59() && GetIsTalentValid(talRandom)) && GetHasSpell(177, OBJECT_SELF))) {
																							return 1;
																						}
																					}
																					else {
																						if ((intParam1 == intGLOB_71)) {
																							talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
																							if (((sub59() && sub66()) && GetIsTalentValid(talRandom))) {
																								return 1;
																							}
																						}
																						else {
																							if ((intParam1 == intGLOB_72)) {
																								...
																								if ((intParam1 == intGLOB_73)) {
																									talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
																									if (((sub71() && sub72()) && GetIsTalentValid(talRandom))) {
																										return 1;
																									}
																								}
																								else {
																									if ((intParam1 == intGLOB_74)) {
																										talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
																										if ((sub73() && GetIsTalentValid(talRandom))) {
																											return 1;
																										}
																									}
																									else {
																										if (((intParam1 == intGLOB_75) || (intParam1 == intGLOB_76))) {
...
talent sub38(int intParam1) {
	SetLocalBoolean(OBJECT_SELF, intGLOB_78, 0);
	int nLocal = GetLocalNumber(OBJECT_SELF, intGLOB_38);
	talent talFeat;
	talent talent2;
	int nTalent = (-1);
	int int4 = 0;
																	...
																	if ((intParam1 == intGLOB_50)) {
																		...
																		if ((intParam1 == intGLOB_51)) {
																			...
																			if ((intParam1 == intGLOB_52)) {
																				...
																				if (((intParam1 == intGLOB_53) || (intParam1 == intGLOB_49))) {
	...
	(nLocal++);
	SetLocalNumber(OBJECT_SELF, intGLOB_38, nLocal);
...
talent sub36(int intParam1) {
	...
	object oRWeapItem = GetItemInSlot(4, OBJECT_SELF);
	if (((((GetLevelByClass(6, OBJECT_SELF) > 0) || (GetLevelByClass(7, OBJECT_SELF) > 0)) && (!sub37(OBJECT_SELF))) && (!GetIsObjectValid(oRWeapItem)))) {
		object oLArmItem = GetItemInSlot(7, OBJECT_SELF);
		object oRArmItem = GetItemInSlot(8, OBJECT_SELF);
		int int9 = 1;
		int nLocal = GetLocalNumber(OBJECT_SELF, intGLOB_44);
		int int12 = GetLocalNumber(OBJECT_SELF, intGLOB_45);
		if (((int12 <= 0) || (int12 >= 10))) {
			int12 = 6;
		}
		...
		nLocal = (nLocal + 1);
		SetLocalNumber(OBJECT_SELF, intGLOB_44, nLocal);
		int9;
		if ((int9 && (nLocal >= int12))) {
			SetLocalNumber(OBJECT_SELF, intGLOB_38, 3);
			SetLocalNumber(OBJECT_SELF, intGLOB_37, int2);
			SetLocalNumber(OBJECT_SELF, intGLOB_44, 0);
			return sub38(int2);
		}
		else {
			SetLocalNumber(OBJECT_SELF, intGLOB_38, 0);
			SetLocalNumber(OBJECT_SELF, intGLOB_37, intGLOB_77);
		}
	}
	if (((structGLOB_1.int13 == 4) || (structGLOB_1.int13 == 0))) {
		...
		if ((nRandom > 0)) {
			if ((((((((((GetLevelByClass(4, OBJECT_SELF) > 0) || (GetLevelByClass(3, OBJECT_SELF) > 0)) || (GetLevelByClass(5, OBJECT_SELF) > 0)) || (GetLevelByClass(11, OBJECT_SELF) > 0)) || (GetLevelByClass(12, OBJECT_SELF) > 0)) || (GetLevelByClass(13, OBJECT_SELF) > 0)) || (GetLevelByClass(14, OBJECT_SELF) > 0)) || (GetLevelByClass(15, OBJECT_SELF) > 0)) || (GetLevelByClass(16, OBJECT_SELF) > 0))) {
				int2 = sub56(intParam1);
				sub2(("GENERIC DEBUG *************** Starting Jedi Combo " + sub75(int2)));
				SetLocalNumber(OBJECT_SELF, intGLOB_38, 1);
				SetLocalNumber(OBJECT_SELF, intGLOB_37, int2);
				return sub38(int2);
			}
			else {
				if (((GetLevelByClass(6, OBJECT_SELF) > 0) || (GetLevelByClass(7, OBJECT_SELF) > 0))) {
					...
					sub2(("GENERIC DEBUG *************** Starting Droid Combo " + sub75(int2)));
					SetLocalNumber(OBJECT_SELF, intGLOB_38, 1);
					SetLocalNumber(OBJECT_SELF, intGLOB_37, int2);
					return sub38(int2);
				}
				else {
					int2 = sub77(intParam1);
					sub2(("GENERIC DEBUG *************** Starting NPC Combo " + sub75(int2)));
					SetLocalNumber(OBJECT_SELF, intGLOB_38, 1);
					SetLocalNumber(OBJECT_SELF, intGLOB_37, int2);
					return sub38(int2);
				}
		...
		sub2(("GENERIC DEBUG *************** Continuing Combo " + sub75(structGLOB_1.int15)));
		return sub38(structGLOB_1.int15);
	}
	return talent1;
}
...
int sub34(object objectParam1) {
	...
	oNPC = sub35();
	if (GetIsObjectValid(oNPC)) {
		if (sub16(intGLOB_155, oNPC)) {
			return 1;
		}
	}
	oNPC = sub15();
	if (GetIsObjectValid(oNPC)) {
		if (sub16(intGLOB_156, oNPC)) {
			return 1;
		}
	}
	talent1 = sub36(0);
	int nLocalBool = GetLocalBoolean(OBJECT_SELF, intGLOB_78);
	if ((nLocalBool == 1)) {
		...
		if ((GetNPCAIStyle(OBJECT_SELF) == 10)) {
			...
			object oRWeapItem = GetItemInSlot(4, OBJECT_SELF);
			if (GetIsObjectValid(oRWeapItem)) {
				int11 = sub78(GetBaseItemType(oRWeapItem));
			}
			if ((int11 == 2)) {
			...
			if ((GetNPCAIStyle(OBJECT_SELF) != intGLOB_146)) {
					...
					if (((GetRacialType(OBJECT_SELF) == 5) && (!IsObjectPartyMember(OBJECT_SELF)))) {
						...
						if (GetIsObjectValid(oNearest)) {
							...
							if ((GetLocalNumber(OBJECT_SELF, 9) > 2)) {
								...
								if ((int42 < 20)) {
									string string8 = IntToString(int42);
									int int44 = GetCurrentAction(OBJECT_SELF);
									if ((int44 != 0)) {
	...
	float float12 = GetDistanceToObject(oNPC);
	if (((float12 > 30.0) && (GetNPCAIStyle(OBJECT_SELF) != intGLOB_146))) {
		oNPC = OBJECT_INVALID;
		CancelCombat(OBJECT_SELF);
	}
	if (GetIsObjectValid(oNPC)) {
...
talent sub25(int intParam1, int intParam2) {
	...
	talent talRandom;
	int int1 = 0;
	if (((intParam1 == intGLOB_31) || (intParam1 == intGLOB_35))) {
	...
	if (((intParam1 == intGLOB_32) || (intParam1 == intGLOB_35))) {
	...
	if (((intParam1 == intGLOB_33) || (intParam1 == intGLOB_35))) {
		if ((d100(1) > 50)) {
		...
		if (((intParam1 == intGLOB_34) || (intParam1 == intGLOB_35))) {
			if ((d100(1) > 70)) {
				talRandom = sub28(intParam2);
				if (GetIsTalentValid(talRandom)) {
					return talRandom;
...
int sub16(int intParam1, object objectParam2) {
	if (GetIsObjectValid(objectParam2)) {
		...
		if (((int3 == 1) && (int4 == 0))) {
			...
			sub2(("GENERIC DEBUG *************** Spells.2DA ID = " + sub10(int56)));
			ClearAllActions();
...
int sub12() {
	int int1 = 0;
	if (((sub1(intGLOB_149) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		if (((GetHitDice(GetFirstPC()) >= 15) || sub1(intGLOB_146))) {
...
int sub9() {
	...
	sub2(((("GENERIC DEBUG *************** Shield Boolean (" + sub10(intGLOB_147)) + ") = ") + sub10(sub1(intGLOB_147))));
	if (((sub1(intGLOB_147) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		int int4;
		int int5;
		int int6 = 0;
		talent talSpell;
...
void sub7() {
	...
	structGLOB_1.int13 = GetLocalNumber(OBJECT_SELF, intGLOB_38);
	structGLOB_1.int15 = GetLocalNumber(OBJECT_SELF, intGLOB_37);
}
...
void sub6(int intParam1) {
	...
	sub7();
	{
		...
		if (((((!sub1(intGLOB_142)) && (!sub1(intGLOB_143))) && (!sub1(intGLOB_144))) && (!GetUserActionsPending()))) {
		if (((GetPartyMemberByIndex(0) != OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF)))) {
			if (((IsObjectPartyMember(OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF))) || (!IsObjectPartyMember(OBJECT_SELF)))) {
				...
				if ((sub1(intGLOB_151) == 1)) {
					if ((sub13() == 1)) {
						return;
					}
				}
				if ((sub1(intGLOB_146) == 1)) {
					if ((sub14(intParam1) == 1)) {
						return;
					}
				}
				if ((nNPCStyle == 6)) {
				...
				if (((nNPCStyle == 0) || (nNPCStyle == 7))) {
					if ((sub34(intParam1) == 1)) {
						return;
					}
				}
				else {
					if ((nNPCStyle == 4)) {
						if ((sub83(intParam1) == 1)) {
							return;
						}
					}
					else {
						if ((nNPCStyle == 5)) {
							...
							if ((sub85(intParam1) == 1)) {
								return;
							}
						}
						else {
							if ((nNPCStyle == 8)) {
								if ((sub89(intParam1) == 1)) {
									return;
								}
							}
							else {
...
void sub3(object objectParam1, int intParam2, object oTarget) {
	...
	int int2;
	{
		int nStyle = GetPartyAIStyle();
		int nNPCStyle = GetNPCAIStyle(OBJECT_SELF);
		if (((((GetLocalNumber(objectParam1, intGLOB_41) == GetLocalNumber(OBJECT_SELF, intGLOB_39)) || (GetLocalNumber(objectParam1, intGLOB_41) == 0)) || (GetLocalNumber(OBJECT_SELF, intGLOB_41) == 0)) || IsObjectPartyMember(OBJECT_SELF))) {
		if (((((!sub1(intGLOB_142)) && (!sub1(intGLOB_143))) && (!sub1(intGLOB_144))) && (!GetUserActionsPending()))) {
...
void main() {
	if ((!sub1(intGLOB_144))) {
		int int2 = GetListenPatternNumber();
		...
		if ((((!GetIsObjectValid(oLastActor)) || GetIsDead(oLastActor)) || (!GetObjectSeen(oLastActor, oSpeaker)))) {
			if (GetCommandable(OBJECT_SELF)) {
				if ((int2 == (-1))) {
					...
					if (((((int2 != (-1)) && GetIsObjectValid(oSpeaker)) && (!GetIsPC(oSpeaker))) && GetIsFriend(oSpeaker, OBJECT_SELF))) {
						if ((int2 >= 1)) {
