...
// Globals
	...
	int intGLOB_154 = (-1);
	int intGLOB_155 = 0;
	int intGLOB_156 = 1001;
	int intGLOB_157 = 1002;
	int intGLOB_158 = 1003;
	int intGLOB_159 = 1004;
	int intGLOB_160 = 1005;
	int intGLOB_161 = 1006;
	int intGLOB_162 = 1007;
	int intGLOB_163 = 1008;
	int intGLOB_164 = 1009;
	int intGLOB_165 = 1010;
	int intGLOB_166 = 1011;
	int intGLOB_167 = 1012;
	int intGLOB_168 = 2001;
	int intGLOB_169 = 2002;
	int intGLOB_170 = 2003;
	int intGLOB_171 = 2004;
	int intGLOB_172 = 2005;
	int intGLOB_173 = 2006;
	int intGLOB_174 = 2007;
	int intGLOB_175 = 2008;
	int intGLOB_176 = 2009;
	int intGLOB_177 = 2010;
	int intGLOB_178 = 2011;
	int intGLOB_179 = 2012;
	int intGLOB_180 = 2013;
	int intGLOB_181 = 2014;
	int intGLOB_182 = 3001;
	int intGLOB_183 = 3002;
	int intGLOB_184 = 3003;
	int intGLOB_185 = 4001;
...
void sub98() {
	if ((!sub3(intGLOB_61))) {
		...
		if (GetIsObjectValid(GetWaypointByTag(string11))) {
			...
			ActionForceMoveToObject(object3, sub3(intGLOB_59), fPersonalSpace, float4);
			if (sub3(intGLOB_52)) {
...
int sub96() {
	...
	if (GetIsObjectValid(oNearest)) {
		...
		if (GetIsObjectValid(object3)) {
			sub4(("GENERIC DEBUG *************** Object Flee = " + sub6(object3)));
...
int sub95() {
	sub4(("GENERIC DEBUG *************** Post DCR Checks for " + sub6(OBJECT_SELF)));
	if ((sub3(intGLOB_112) && (!sub3(intGLOB_113)))) {
		if (sub96()) {
			return 1;
		}
	}
	...
	if (((!IsObjectPartyMember(OBJECT_SELF)) && (sub3(intGLOB_61) == 1))) {
...
object sub87(object objectParam1) {
	...
	if (GetIsObjectValid(object1)) {
		sub4(("GENERIC DEBUG *************** Attack Target From Determine Attack Target = " + sub6(object1)));
		return object1;
	}
...
int sub84(object objectParam1) {
	...
	if (GetIsObjectValid(object3)) {
		...
		sub4(("GENERIC DEBUG *************** Boss AI: Initial oFind Search = " + sub6(object3)));
		if (GetIsObjectValid(object3)) {
			sub4(("GENERIC DEBUG *************** Jedi Support AI: Valid oTarget Set As = " + sub6(object3)));
			if ((GetRacialType(object3) == 5)) {
	...
	if ((GetIsObjectValid(oTarget) && (!GetIsDead(oTarget)))) {
		...
		if ((fDistance < 3.5)) {
			...
			if (GetIsInCombat(OBJECT_SELF, 0)) {
				DelayCommand(3.0, sub5(objectParam1));
			}
		}
		else {
			int nAction = GetCurrentAction(OBJECT_SELF);
																								...
																								if ((intParam1 == intGLOB_43)) {
																									...
																									if ((intParam1 == intGLOB_44)) {
																										...
																										if (((intParam1 == intGLOB_45) || (intParam1 == intGLOB_46))) {
																											...
																											sub4(((("GENERIC DEBUG *************** Droid Items = " + sub6(oLArmItem)) + " / ") + sub6(oRArmItem)));
																											if (sub73()) {
	...
	if (((structGLOB_1.int13 == 4) || (structGLOB_1.int13 == 0))) {
		...
		if ((nRandom > 0)) {
			if ((((((((((GetLevelByClass(4, OBJECT_SELF) > 0) || (GetLevelByClass(3, OBJECT_SELF) > 0)) || (GetLevelByClass(5, OBJECT_SELF) > 0)) || (GetLevelByClass(11, OBJECT_SELF) > 0)) || (GetLevelByClass(12, OBJECT_SELF) > 0)) || (GetLevelByClass(13, OBJECT_SELF) > 0)) || (GetLevelByClass(14, OBJECT_SELF) > 0)) || (GetLevelByClass(15, OBJECT_SELF) > 0)) || (GetLevelByClass(16, OBJECT_SELF) > 0))) {
				...
				sub4(("GENERIC DEBUG *************** Starting Jedi Combo " + sub74(int2)));
				...
				if (((GetLevelByClass(6, OBJECT_SELF) > 0) || (GetLevelByClass(7, OBJECT_SELF) > 0))) {
					...
					sub4(("GENERIC DEBUG *************** Starting Droid Combo " + sub74(int2)));
					SetLocalNumber(OBJECT_SELF, intGLOB_8, 1);
					SetLocalNumber(OBJECT_SELF, intGLOB_7, int2);
					return sub37(int2);
				}
					...
					sub4(("GENERIC DEBUG *************** Starting NPC Combo " + sub74(int2)));
					SetLocalNumber(OBJECT_SELF, intGLOB_8, 1);
					SetLocalNumber(OBJECT_SELF, intGLOB_7, int2);
					return sub37(int2);
				}
		...
		sub4(("GENERIC DEBUG *************** Continuing Combo " + sub74(structGLOB_1.int15)));
...
int sub33(object objectParam1) {
	...
	if ((nLocalBool == 1)) {
		...
		sub4(("GENERIC DEBUG *************** Intruder    = " + sub6(objectParam1)));
		sub4(("GENERIC DEBUG *************** Last Target = " + sub6(oNPC)));
		sub4(("GENERIC DEBUG *************** Closest     = " + sub6(oNearest)));
	...
	sub4(((("GENERIC DEBUG *************** Target = " + sub6(oNPC)) + " is Enemy: ") + IntToString(GetIsEnemy(oNPC, OBJECT_SELF))));
	if (GetIsObjectValid(oNPC)) {
...
int sub30() {
	...
	sub4(("GENERIC DEBUG *************** Boss AI: Initial oFind Search = " + sub6(oNearest)));
	while ((GetIsObjectValid(oNearest) && (int4 <= nRandom))) {
		sub4(((("GENERIC DEBUG *************** Boss AI: Valid oFind = " + sub6(oNearest)) + " nCnt = ") + sub10(int4)));
		if (GetIsObjectValid(oNearest)) {
			sub4(("GENERIC DEBUG *************** Boss AI: Valid oTarget Set As = " + sub6(oNearest)));
			object1 = oNearest;
		}
		(int4++);
...
object sub17(int intParam1) {
	...
	if (((!GetIsEnemy(oNearest, OBJECT_SELF)) && (intParam1 == 1))) {
		...
		sub4(("GENERIC DEBUG *************** Alternate Target = " + sub6(oNearest)));
	}
	sub4(("GENERIC DEBUG *************** Heal Drain Target = " + sub10(intParam1)));
	sub4(("GENERIC DEBUG *************** Get Active Party Member: " + sub6(oNearest)));
	return oNearest;
}
...
int sub15(int intParam1, object objectParam2) {
	if (GetIsObjectValid(objectParam2)) {
		...
		if ((intParam1 == intGLOB_124)) {
			...
			if ((intParam1 == intGLOB_125)) {
				...
				if ((intParam1 == intGLOB_126)) {
					int3 = 0;
					sub4(("GENERIC DEBUG *************** Starting Heal Talent Checks " + sub6(OBJECT_SELF)));
					talSpell = TalentSpell(28);
					talent2 = TalentSpell(10);
		...
		if (((int3 == 1) && (int4 == 0))) {
			...
			if (((int3 == 1) && (int4 == 1))) {
				...
				if (GetIsObjectValid(objectParam2)) {
					sub4(("GENERIC DEBUG *************** Hostile Heal Targeted On: " + sub6(objectParam2)));
	...
	sub4(((((("GENERIC DEBUG *************** " + sub6(OBJECT_SELF)) + " VP = ") + sub10(GetCurrentHitPoints(OBJECT_SELF))) + "/") + sub10(GetMaxHitPoints(OBJECT_SELF))));
...
int sub11() {
	int int1 = 0;
	if (((sub3(intGLOB_119) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		if (((GetHitDice(GetFirstPC()) >= 15) || sub3(intGLOB_116))) {
...
int sub9() {
	...
	sub4(((("GENERIC DEBUG *************** Shield Boolean (" + sub10(intGLOB_117)) + ") = ") + sub10(sub3(intGLOB_117))));
	if (((sub3(intGLOB_117) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		int int4;
		int int5;
		int int6 = 0;
		talent talSpell;
...
void sub5(object objectParam1) {
	sub4("");
	sub4(("GENERIC DEBUG *************** START DETERMINE COMBAT ROUND " + sub6(OBJECT_SELF)));
	sub7();
	{
		int nStyle = GetPartyAIStyle();
		int nNPCStyle = GetNPCAIStyle(OBJECT_SELF);
		sub4(("GENERIC DEBUG *************** AI STYLE = " + sub8(OBJECT_SELF)));
		if (((((!sub3(intGLOB_112)) && (!sub3(intGLOB_113))) && (!sub3(intGLOB_114))) && (!GetUserActionsPending()))) {
		if (((GetPartyMemberByIndex(0) != OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF)))) {
			if (((IsObjectPartyMember(OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF))) || (!IsObjectPartyMember(OBJECT_SELF)))) {
				...
				if ((sub3(intGLOB_121) == 1)) {
					if ((sub12() == 1)) {
						return;
					}
				}
				if ((sub3(intGLOB_116) == 1)) {
...
void main() {
	...
	if ((int1 == 500)) {
		...
		ApplyEffectToObject(0, EffectDeath(0, 0, 1), OBJECT_SELF, 0.0);
	}
	if (((GetGlobalNumber("299TEL_HK51_Active") != 3) || (GetTag(OBJECT_SELF) == "hk50_1"))) {
		sub1(OBJECT_SELF);
	}
	else {
		if (((GetGlobalNumber("299TEL_HK51_Active") == 3) && (GetTag(OBJECT_SELF) == "hk51_1"))) {
			object oPerceived = GetLastPerceived();
			if ((GetCommandable(OBJECT_SELF) && (!sub3(intGLOB_114)))) {
				if ((((!GetIsObjectValid(GetAttemptedAttackTarget())) && (!GetIsObjectValid(GetAttemptedSpellTarget()))) && (!GetIsObjectValid(GetAttackTarget(OBJECT_SELF))))) {
					if (GetLastPerceptionSeen()) {
						if (GetIsEnemy(oPerceived, OBJECT_SELF)) {
							...
							if ((sub3(intGLOB_120) == 1)) {
								fDistance = 0.0;
							}
							SpeakString("GEN_I_WAS_ATTACKED", 3);
							sub4("GENERIC DEBUG *************** Determine Combat Round from On Perception 2");
							DelayCommand(fDistance, sub5(OBJECT_INVALID));
							if ((fDistance > 0.0)) {
								sub2(intGLOB_120, 1);
							}
						}
						...
						if ((GetCurrentAction(OBJECT_SELF) != 65534)) {
							if (GetLastPerceptionSeen()) {
								if (GetIsEnemy(GetLastPerceived(), OBJECT_SELF)) {
									...
									SpeakString("GEN_I_WAS_ATTACKED", 3);
									sub4("GENERIC DEBUG *************** Determine Combat Round from On Perception 2");
									DelayCommand(float3, sub5(OBJECT_INVALID));
								}
							}
						}
					}
			...
			if ((sub3(intGLOB_85) && GetLastPerceptionSeen())) {
